...
Private Sub Form_Load()
    ...
    SqlListaCargos = "select a.codcolaborador as REGISTRO,a.nomecolaborador,b.data,d.nomecargo,e.logo from tbcolaboradores as a inner join tbcolaboradoreshist as b on a.codcoligada = '" & vCodcoligada & "' and  a.tipo = 'colaborador' and a.cpf = b.cpf and " & _
