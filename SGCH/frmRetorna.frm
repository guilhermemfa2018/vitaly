...
Private Sub cmdRetorno_Click(Index As Integer)
    ...
    Case 1
        If MsgBox("Deseja EXCLUIR curso/treinamento das sugestões de retorno?", vbQuestion + vbYesNo, "SGC") = vbYes Then
...
Private Sub CarregaCurso()
    ...
    If rsCursos.EOF Then
        ...
        If Val(Pesquisa) <> 0 Then
            MsgBox "Curso/Treinamento não cadastrado", vbInformation, "SGC"
            txtRetorno(6) = ""
        End If
    Else
...
Private Function ValidaTreinamento()
    ...
    If txtRetorno(6).Text = "" Then
        MsgBox "Favor informar o campo " & Me.txtRetorno(6).Tag, vbInformation, "Atenção"
