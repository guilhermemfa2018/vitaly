...
Private Sub listview_cabecalho()
    ...
    ListView1.ColumnHeaders.Add , , "Data Requisição", ListView1.Width / 12
...
Private Sub Compoe_Listview()
    ...
    If FiltroGeral = "Não ativos" Then sql = "select codrequisicao,datarequisicao,origem,nomerequisitante,ativo from  tbrequisicoes where ativo='N'"
...
On Error GoTo TrataErro
    ...
    cnBanco.BeginTrans
    If MsgBox("Confirma exclusão do Requisição selecionado?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
...
Private Sub AlteraListview()
    ...
    Exit Sub
Err:
    MsgBox "Nenhuma Requisição cadastrado ou selecionado", vbInformation, "SGCH"
    Exit Sub
End Sub
