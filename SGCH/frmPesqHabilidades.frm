...
Begin VB.Form frmPesqHabilidades 
   BorderStyle     =   0  'None
   ...
   ClientTop       =   1365
   ClientWidth     =   14895
   Icon            =   "frmPesqHabilidades.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   9180
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPesqHabilidades.frx":0CCA
               Key             =   "OK"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPesqHabilidades.frx":16DC
               Key             =   "EXC"
            EndProperty
         EndProperty
      End
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox Combo1 
            Height          =   315
            ItemData        =   "frmPesqHabilidades.frx":20EE
            Left            =   2040
            List            =   "frmPesqHabilidades.frx":20F8
            TabIndex        =   2
            Top             =   240
            Width           =   1695
         End
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmPesqHabilidades.frx":2110
         PICN            =   "frmPesqHabilidades.frx":212C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmPesqHabilidades.frx":2E06
         PICN            =   "frmPesqHabilidades.frx":2E22
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmPesqHabilidades.frx":3AFC
         PICN            =   "frmPesqHabilidades.frx":3B18
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmPesqHabilidades.frx":47F2
         PICN            =   "frmPesqHabilidades.frx":480E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmPesqHabilidades.frx":54E8
         PICN            =   "frmPesqHabilidades.frx":5504
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmPesqHabilidades.frx":61DE
         PICN            =   "frmPesqHabilidades.frx":61FA
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmPesqHabilidades.frx":6ED4
         PICN            =   "frmPesqHabilidades.frx":6EF0
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmPesqHabilidades.frx":7BCA
         PICN            =   "frmPesqHabilidades.frx":7BE6
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmPesqHabilidades.frx":88C0
         PICN            =   "frmPesqHabilidades.frx":88DC
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmPesqHabilidades"
...
On Error GoTo Err
    ...
    Case 3
        ...
        End If
    Case 4
        DesabBotoesN1 frmPesqHabilidades
        Pesquisa = "novo"
        frmHabilidades.Show 1
        HabBotoesN1 frmPesqHabilidades
   Case 5
        DesabBotoesN1 frmPesqHabilidades
        Pesquisa = "editar"
        AlteraListview
        If varGlobal <> "" Then frmHabilidades.Show 1
        HabBotoesN1 frmPesqHabilidades
    Case 6
        On Error GoTo Err
        Y = ListView1.ListItems.Count
...
Private Sub Form_Load()
    'frmMenu2
    Frame1.Caption = "Habilidades funcionais"
    frmMenu2.StatusBar1.Panels(3) = Legenda
    frmPesqHabilidades.Top = frmMenu2.ACPRibbon1.Height + 290
    frmPesqHabilidades.Left = frmMenu2.Left + 130
    frmPesqHabilidades.Width = frmMenu2.Width - 300
    
    frmPesqHabilidades.Frame1.Width = frmPesqHabilidades.Width - (frmPesqHabilidades.Width * 1.5 / 100)
    frmPesqHabilidades.ListView1.Width = frmPesqHabilidades.Frame1.Width - (frmPesqHabilidades.Frame1.Width * 1.5 / 100)
    
    frmPesqHabilidades.Height = frmMenu2.Height - 2700
    frmPesqHabilidades.Frame1.Height = frmPesqHabilidades.Height - 250
    frmPesqHabilidades.ListView1.Height = frmPesqHabilidades.Frame1.Height - (frmPesqHabilidades.Frame1.Height * 15 / 90)
    
    ''MDIPrincipal
    'Frame1.Caption = "Habilidades funcionais"
    'MDIPrincipal.StatusBar1.Panels(3) = Legenda
    'frmPesqHabilidades.Top = MDIPrincipal.pctGer.Height + (MDIPrincipal.pctGer.Height * 50 / 50)
    'frmPesqHabilidades.Left = MDIPrincipal.Left + 110
    'frmPesqHabilidades.Width = MDIPrincipal.Width - (MDIPrincipal.Width * 1.5 / 100)
    'frmPesqHabilidades.Frame1.Width = frmPesqHabilidades.Width - (frmPesqHabilidades.Width * 1.5 / 100)
    'frmPesqHabilidades.ListView1.Width = frmPesqHabilidades.Frame1.Width - (frmPesqHabilidades.Frame1.Width * 1.5 / 100)
    
    'frmPesqHabilidades.Height = MDIPrincipal.Height - (MDIPrincipal.Height * 18 / 100)
    'frmPesqHabilidades.Frame1.Height = frmPesqHabilidades.Height - (frmPesqHabilidades.Height * 1.2 / 100)
    'frmPesqHabilidades.ListView1.Height = frmPesqHabilidades.Frame1.Height - (frmPesqHabilidades.Frame1.Height * 15 / 90)
    
    AbrirTabelas
    listview_cabecalho 'Chama a Sub que monta o cabeçalho das colunas do Listview
    Combo1.Text = "Código" 'Inicializa o combo com a palavra "Codigo"
...
Private Sub listview_cabecalho()
    ...
    ListView1.ColumnHeaders.Add , , "Habilidade", ListView1.Width / 3
    ListView1.ColumnHeaders.Add , , "Peso", ListView1.Width / 12
    ListView1.ColumnHeaders.Add , , "Ativo", ListView1.Width / 12
...
Private Sub Compoe_Listview()
    ...
    Dim X As Integer
    If FiltroGeral = "Todos" Then sql = "select * from tbHabilidades"
    If FiltroGeral = "Ativos" Then sql = "select * from tbHabilidades where ativo = 'S'"
    If FiltroGeral = "Não ativos" Then sql = "select * from tbHabilidades where ativo is null or ativo ='N'"
    'If FiltroGeral = "Departamento" Then Sql = "select * from tbHabilidades where ativo is null or ativo ='N'"
        ...
        For X = 1 To Y
            ...
            If Combo1.Text = "Código" Then
                ...
                If UCase(ListView1.ListItems.Item(X)) Like UCase(Me.Text1.Text & "*") Then
                    ...
                    Exit Sub
                End If
            ElseIf Combo1.Text = "Habilidade" Then
...
Private Sub AbrirTabelas()
    SqlPesquisar = "Select * from tbHabilidades order by codHabilidade"
...
On Error GoTo TrataErro
    ...
    Dim SqlExcHabilidade As String
    Dim rsExcHabilidade As New ADODB.Recordset
    cnBanco.BeginTrans
    If MsgBox("Confirma exclusão do Habilidade selecionado?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
        SqlExcHabilidade = "Delete from tbHabilidades where codHabilidade= " & Val(varGlobal)
        rsExcHabilidade.Open SqlExcHabilidade, cnBanco
...
Private Sub AlteraListview()
    ...
    Exit Sub
Err:
    MsgBox "Nenhum Habilidade cadastrado ou selecionado", vbInformation, "SGCH"
    Exit Sub
End Sub
