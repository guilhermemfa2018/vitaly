...
Private Function ValidaCampo()
    ...
    If txtCadEscolaridade(0).Text = "" Then
        MsgBox "Favor informar o campo " & Me.txtCadEscolaridade(0).Tag, vbInformation, "Atenção"
        Me.txtCadEscolaridade(0).SetFocus
        Exit Function
    End If
    If txtCadEscolaridade(1).Text = "" Then
        MsgBox "Favor informar o campo " & Me.txtCadEscolaridade(1).Tag, vbInformation, "Atenção"
        Me.txtCadEscolaridade(1).SetFocus
        Exit Function
    End If
    If txtCadEscolaridade(2).Text = "" Then
        MsgBox "Favor informar o campo " & Me.txtCadEscolaridade(2).Tag, vbInformation, "Atenção"
...
Private Sub ResultPesq()
    ...
    If rsEscolaridade.RecordCount > 0 Then
        CompoeControles
    Else
        MsgBox "Escolaridade não encontrado"
    End If
    rsEscolaridade.Close
    Set rsEscolaridade = Nothing
End Sub
