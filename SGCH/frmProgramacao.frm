...
Begin VB.Form frmProgramacao 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmProgramacao.frx":26D2
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Label19"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "Label20"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "cmdCadastro(3)"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "cmdCadastro(2)"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).Control(4)=   "cmdCadastro(1)"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "ListView1"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "cmdCadastro(10)"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "txtProgTrei(10)"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "txtProgTrei(9)"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).ControlCount=   9
      TabCaption(1)   =   "Instrutores"
      TabPicture(1)   =   "frmProgramacao.frx":26EE
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Label14"
      Tab(1).Control(1)=   "Label15"
      Tab(1).Control(2)=   "Label16"
      Tab(1).Control(3)=   "Label18"
      Tab(1).Control(4)=   "cmdCadastro(6)"
      Tab(1).Control(5)=   "cmdCadastro(7)"
      Tab(1).Control(6)=   "cmdCadastro(8)"
      Tab(1).Control(7)=   "cmdCadastro(9)"
      Tab(1).Control(8)=   "cmdCadastro(5)"
      Tab(1).Control(9)=   "ListView2"
      Tab(1).Control(10)=   "Frame9"
      Tab(1).Control(11)=   "txtProgTrei(7)"
      Tab(1).Control(12)=   "txtProgTrei(6)"
      Tab(1).Control(13)=   "cboProgTrei(0)"
      Tab(1).Control(14)=   "cboProgTrei(1)"
      Tab(1).ControlCount=   15
      TabCaption(2)   =   "Avaliador"
      TabPicture(2)   =   "frmProgramacao.frx":270A
      ...
      Begin VB.Frame Frame11 
         ...
         Begin VB.ComboBox cboProgTrei 
            Height          =   315
            Index           =   2
            ItemData        =   "frmProgramacao.frx":2726
            Left            =   120
            List            =   "frmProgramacao.frx":2733
            TabIndex        =   72
            Text            =   "Instrutor"
            Top             =   480
            Width           =   1455
      ...
      Begin VB.ComboBox cboProgTrei 
         Height          =   315
         Index           =   1
         ItemData        =   "frmProgramacao.frx":2757
         Left            =   -66360
         List            =   "frmProgramacao.frx":2764
         TabIndex        =   18
      ...
      Begin VB.ComboBox cboProgTrei 
         Height          =   315
         Index           =   0
         ItemData        =   "frmProgramacao.frx":278E
         Left            =   -74880
         List            =   "frmProgramacao.frx":2798
         TabIndex        =   57
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmProgramacao.frx":27AE
         PICN            =   "frmProgramacao.frx":27CA
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   -1  'True
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmProgramacao.frx":34C0
         PICN            =   "frmProgramacao.frx":34DC
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmProgramacao.frx":41B6
         PICN            =   "frmProgramacao.frx":41D2
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmProgramacao.frx":4EAC
         PICN            =   "frmProgramacao.frx":4EC8
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmProgramacao.frx":5BA2
         PICN            =   "frmProgramacao.frx":5BBE
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmProgramacao.frx":68B4
         PICN            =   "frmProgramacao.frx":68D0
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmProgramacao.frx":75AA
         PICN            =   "frmProgramacao.frx":75C6
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.Frame Frame2 
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         Left            =   8160
         TabIndex        =   80
         Tag             =   "Definir tópicos da avaliação de eficácia"
         ToolTipText     =   "Definir tópicos da avaliação de eficácia"
         Top             =   240
         Width           =   615
         _ExtentX        =   1085
         _ExtentY        =   1085
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmProgramacao.frx":82A0
         PICN            =   "frmProgramacao.frx":82BC
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin VB.Label Label10 
         Caption         =   "Métodos de avaliação de eficácia:"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin SGCH.chameleonButton cmdCadastro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmProgramacao.frx":8FCE
      PICN            =   "frmProgramacao.frx":8FEA
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
Private Sub cmdCadastro_Click(Index As Integer)
    ...
    Case 2
        If MsgBox("Deseja EXCLUIR esse colaborador da Programação?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
    ...
    Case 8
        AlteraInstrutorProg
    Case 9
        If MsgBox("Deseja EXCLUIR esse instrutor da Programação?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
            ExcluirItemLV ListView2
            LimpaControlesInstrutorProg
        End If
    Case 10
        If ListView1.ListItems.Count = 0 Then
            MsgBox "Não existem colaboradores a serem avaliados", vbCritical, "SGCH"
            Exit Sub
        End If
        ...
        Else
            MsgBox "O colaborador/candidato apenas poderá ser avaliado após o treinamento ser agendado"
        End If
        If Pesquisa = 1 Then AtualizaLV
    Case 11
        If MsgBox("Deseja salvar os dados da Programação?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
            GravarDados
        ...
        End If
    Case 12
        If MsgBox("Deseja sair da tela de cadastro de Programação?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
            Pesquisa = "0"
            Unload Me
            Set frmProgramacao = Nothing
        End If
    Case 13
        varGlobal = txtProgTrei(0)
...
On Error Resume Next
    ...
    For Y = 1 To ListView1.ListItems.Count
        ...
        ListView1.SelectedItem.ListSubItems.Item(3) = "100,00%"
    Next
    cnBanco.CommitTrans
    rsAvAT.Close
    Set rsAvAT = Nothing
...
Private Sub Form_Activate()
    ...
    If validaCurso = 1 Then
        MsgBox "A programação não pode ser realizada para cursos/treinamentos diferentes", vbCritical, "SGCH"
        Unload Me
    End If
...
Private Sub CompoeControles()
    ...
    If Status = "editar" Then
        ...
        mskProgTrei(0) = Mid$(rsProgramacao.Fields(8), 1, 5)
        mskProgTrei(1) = Mid$(rsProgramacao.Fields(9), 1, 5)
...
'    sqlCursoProg = "Select a.codtreinamento,a.nometreinamento,b.revisao,a.tipo,a.cargahoraria from tbtreinamentos as a left join  tbtreinamentosrev as b on b.codtreinamento = a.codtreinamento Where a.codtreinamento = '" & Val(MeuLV.ListView1.SelectedItem.ListSubItems.Item(4)) & "' order by b.revisao desc"
    ...
    If MeuLV.ListView1.ListItems.Count > 0 Then
        ...
        Text5.Text = Format(rsCursoProg.Fields(0), "000000")
        Text6.Text = rsCursoProg.Fields(1)
        If Not IsNull(rsCursoProg.Fields(2)) Then Text7.Text = rsCursoProg.Fields(2) Else Text7.Text = "-"
        Text8.Text = rsCursoProg.Fields(3)
        Text9.Text = Format(rsCursoProg.Fields(4), "000:00")
        rsCursoProg.Close
...
Private Sub CarregaColaborador(indice As Integer)
    ...
    If indice = 0 Then
        If rsInstrutores.RecordCount <= 0 Then
            If txtProgTrei(3).Text <> "000000" And txtProgTrei(3).Text <> "" Then MsgBox "Colaborador não cadastrado", vbInformation, "SGCH"
            txtProgTrei(4) = ""
        Else
    ...
    If indice = 2 Then
        If rsInstrutores.RecordCount <= 0 Then
            If txtProgTrei(6).Text <> "000000" And txtProgTrei(6).Text <> "" Then MsgBox "Colaborador não cadastrado", vbInformation, "SGCH"
            txtProgTrei(7) = ""
        Else
    ...
    If indice = 3 Then
        If rsInstrutores.RecordCount <= 0 Then
            If txtProgTrei(9).Text <> "000000" And txtProgTrei(9).Text <> "" Then MsgBox "Colaborador não cadastrado", vbInformation, "SGCH"
            txtProgTrei(10) = ""
        Else
    ...
    If indice = 4 Then
        If rsInstrutores.RecordCount <= 0 Then
            If Text5.Text <> "000000" And Text5.Text <> "" Then MsgBox "Treinamento não cadastrado", vbInformation, "SGCH"
            Text6.Text = ""
            Text7.Text = ""
            Text8.Text = ""
            Text9.Text = ""
...
Private Function ValidaCampoCol()
    ...
    For X = 9 To 10
        If txtProgTrei(X).Text = "" Then
            MsgBox "Favor informar o campo " & Me.txtProgTrei(X).Tag, vbInformation, "Atenção"
...
Private Function ValidaCampo()
    ...
    If ListView2.ListItems.Count = 0 Then
        MsgBox "Não foi informado nenhum instrutor para esse treinamento", vbInformation, "Atenção"
        Exit Function
    End If
    ...
    If Check1.Value = 1 Then
        If Label25 = "" Then
            MsgBox "Não foram definidos tópicos da Avaliação de Eficácia", vbCritical, "Atenção"
...
'On Error GoTo TrataErro
    ...
    End If
    If Check2.Value = 1 Then rsSalvarProgramacao.Fields(15) = "S" Else rsSalvarProgramacao.Fields(15) = "N" 'ativo
    ...
    For X = 1 To ListView1.ListItems.Count
        ...
        SqlSalvar = "select a.*, c.nomecargo from tbPendentesCur as a inner join tbMatriz as b on a.codmatriz = b.codmatriz inner join tbCargos as c on b.codcargo = c.codcargo where a.codcoligada = '" & vCodcoligada & "' and a.codtreinamento = '" & Val(Text5) & "' and a.cpf = '" & ListView1.ListItems.Item(X) & "' and a.codprogramacao is null and a.ativo <> 'N'"
        rsSalvar.Open SqlSalvar, cnBanco, adOpenKeyset, adLockOptimistic
        ...
        Else
            ...
            rsSalvar.Fields(15) = rsSalvar.Fields(16) 'Grava o nome do cargo em treinamento
        End If
        If Not rsSalvar.EOF Then rsSalvar.Update
        rsSalvar.Close
        Set rsSalvar = Nothing
    ...
    If VerificaConcluido = True Then 'And RemoveMask(Label13) <> 0 Then
        If MsgBox("Todos os participantes da programação foram avaliados. Deseja concluir a Programação?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
            ConcluiTreinamento
            AchaColabor 'ROTINA QUE GERA TREINAMENTOS PERIODICOS
        End If
    End If
    ...
    MsgBox "Os dados da Programação foram salvos com sucesso", vbInformation, "SGCH"
    'AtualizaListview
    Exit Sub
TrataErro:
    MsgBox "Ocorreu um erro, as alterções nos registros serão desfeitas!", vbInformation, "Atenção"
...
Private Sub ConcluiTreinamento()
    ...
    For X = 1 To ListView1.ListItems.Count
        ...
        rsConcluir.Fields(2) = Text5.Text 'codtreinamento
...
Private Sub AchaColabor()
    'ROTINA QUE GERA TREINAMENTOS PERIODICOS
