...
Begin VB.Form frmColaboradores 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         Tab(1).Control(4)=   "Label45"
         Tab(1).Control(5)=   "Label46"
         Tab(1).Control(6)=   "Label47"
         Tab(1).Control(7)=   "cmdCadastro(0)"
         Tab(1).Control(8)=   "cmdCadastro(1)"
         Tab(1).Control(9)=   "cmdCadastro(2)"
         Tab(1).Control(10)=   "cmdCadastro(3)"
         Tab(1).Control(11)=   "cmdCadastro(18)"
         Tab(1).Control(12)=   "ListView1"
         Tab(1).Control(13)=   "txtCadMatriz(1)"
         Tab(1).Control(14)=   "txtCadMatriz(9)"
         Tab(1).Control(15)=   "txtCadMatriz(8)"
         Tab(1).Control(16)=   "cboCadMatriz(2)"
         Tab(1).Control(17)=   "cboCadMatriz(3)"
         Tab(1).Control(18)=   "cmdCadastro(24)"
         Tab(1).Control(19)=   "DTPicker6"
         Tab(1).Control(20)=   "DTPicker7"
         Tab(1).Control(21)=   "txtCadMatriz(27)"
         ...
         Tab(3).Control(5)=   "cmdCadastro(8)"
         Tab(3).Control(6)=   "cmdCadastro(7)"
         Tab(3).Control(7)=   "cmdCadastro(4)"
         Tab(3).Control(8)=   "txtCadMatriz(10)"
         Tab(3).Control(9)=   "txtCadMatriz(11)"
         Tab(3).Control(10)=   "cboCadMatriz(5)"
         Tab(3).Control(11)=   "cmdCadastro(25)"
         Tab(3).Control(12)=   "DTPicker5"
         Tab(3).Control(13)=   "cmdCadastro(27)"
         Tab(3).Control(14)=   "cmdCadastro(5)"
         ...
         Tab(4).Control(2)=   "cmdCadastro(17)"
         Tab(4).Control(2).Enabled=   0   'False
         Tab(4).Control(3)=   "cmdCadastro(16)"
         Tab(4).Control(3).Enabled=   0   'False
         Tab(4).Control(4)=   "cmdCadastro(10)"
         Tab(4).Control(4).Enabled=   0   'False
         Tab(4).Control(5)=   "cmdCadastro(9)"
         Tab(4).Control(5).Enabled=   0   'False
         Tab(4).Control(6)=   "cmdCadastro(6)"
         Tab(4).Control(6).Enabled=   0   'False
         Tab(4).Control(7)=   "ListView4"
         ...
         Begin TabDlg.SSTab SSTab2 
            ...
            Tab(0).ControlEnabled=   0   'False
            Tab(0).Control(0)=   "Combo(1)"
            Tab(0).Control(1)=   "txtCons(0)"
            Tab(0).Control(2)=   "Combo(2)"
            Tab(0).Control(3)=   "txtCons(1)"
            Tab(0).Control(4)=   "Combo(3)"
            Tab(0).Control(5)=   "txtCons(2)"
            Tab(0).Control(6)=   "Combo(4)"
            Tab(0).Control(7)=   "txtCons(3)"
            Tab(0).Control(8)=   "Combo(5)"
            Tab(0).Control(9)=   "txtCons(4)"
            Tab(0).Control(10)=   "Combo(6)"
            Tab(0).Control(11)=   "txtCons(5)"
            Tab(0).Control(12)=   "Combo(7)"
            Tab(0).Control(13)=   "txtCons(6)"
            Tab(0).Control(14)=   "Combo(8)"
            Tab(0).Control(15)=   "txtCons(7)"
            Tab(0).Control(16)=   "Combo(9)"
            Tab(0).Control(17)=   "txtCons(8)"
            Tab(0).Control(18)=   "Combo(10)"
            Tab(0).Control(19)=   "txtCons(9)"
            Tab(0).Control(20)=   "Combo(11)"
            Tab(0).Control(21)=   "txtCons(10)"
            Tab(0).Control(22)=   "Combo(12)"
            Tab(0).Control(23)=   "txtCons(11)"
            Tab(0).Control(24)=   "Combo(13)"
            Tab(0).Control(25)=   "txtCons(12)"
            Tab(0).Control(26)=   "lblCons(0)"
            Tab(0).Control(27)=   "lblCons(1)"
            Tab(0).Control(28)=   "lblCons(2)"
            Tab(0).Control(29)=   "lblCons(3)"
            Tab(0).Control(30)=   "lblCons(4)"
            Tab(0).Control(31)=   "lblCons(5)"
            Tab(0).Control(32)=   "lblCons(6)"
            Tab(0).Control(33)=   "lblCons(7)"
            Tab(0).Control(34)=   "lblCons(8)"
            Tab(0).Control(35)=   "lblCons(9)"
            Tab(0).Control(36)=   "lblCons(10)"
            Tab(0).Control(37)=   "lblCons(11)"
            Tab(0).Control(38)=   "lblCons(12)"
            ...
            Tab(1).Control(1)=   "Label49"
            Tab(1).Control(1).Enabled=   0   'False
            Tab(1).Control(2)=   "Label50"
            Tab(1).Control(2).Enabled=   0   'False
            Tab(1).Control(3)=   "cmdCadastro(29)"
            Tab(1).Control(3).Enabled=   0   'False
            Tab(1).Control(4)=   "DTPicker8"
            Tab(1).Control(4).Enabled=   0   'False
            Tab(1).Control(5)=   "cmdCadastro(32)"
            Tab(1).Control(5).Enabled=   0   'False
            Tab(1).Control(6)=   "cmdCadastro(31)"
            Tab(1).Control(6).Enabled=   0   'False
            Tab(1).Control(7)=   "cmdCadastro(30)"
            Tab(1).Control(7).Enabled=   0   'False
            Tab(1).Control(8)=   "cmdCadastro(28)"
            Tab(1).Control(8).Enabled=   0   'False
            Tab(1).Control(9)=   "ListView6"
            Tab(1).Control(9).Enabled=   0   'False
            Tab(1).Control(10)=   "txtCadMatriz(28)"
            Tab(1).Control(10).Enabled=   0   'False
            Tab(1).Control(11)=   "txtCadMatriz(29)"
            ...
            Begin VB.ComboBox Combo 
               Height          =   315
               Index           =   10
               ItemData        =   "frmColaboradores.frx":1133E
               Left            =   -74040
               List            =   "frmColaboradores.frx":11340
               TabIndex        =   149
               Tag             =   "Seção"
               ToolTipText     =   "Seção"
               Top             =   2580
            ...
            Begin SGCH.chameleonButton cmdCadastro 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "frmColaboradores.frx":11342
               PICN            =   "frmColaboradores.frx":1135E
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
            ...
            Begin SGCH.chameleonButton cmdCadastro 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "frmColaboradores.frx":12038
               PICN            =   "frmColaboradores.frx":12054
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
            ...
            Begin SGCH.chameleonButton cmdCadastro 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "frmColaboradores.frx":12D2E
               PICN            =   "frmColaboradores.frx":12D4A
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
            ...
            Begin SGCH.chameleonButton cmdCadastro 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "frmColaboradores.frx":13A24
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
            ...
            Begin MSComCtl2.DTPicker DTPicker8 
               ...
               Left            =   9000
               TabIndex        =   204
               Tag             =   "Data de entrega do EPI ao colaborador"
               ToolTipText     =   "Data de entrega do EPI ao colaborador"
               Top             =   600
               Width           =   1455
               _ExtentX        =   2566
               _ExtentY        =   503
            ...
            Begin SGCH.chameleonButton cmdCadastro 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "frmColaboradores.frx":13A40
               PICN            =   "frmColaboradores.frx":13A5C
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
   ...
   Begin VB.Frame Frame11 
      ...
      Begin VB.Frame Frame8 
         ...
         Begin SGCH.chameleonButton chameleonButton1 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":14736
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin AlphaImageControl.aicAlphaImage aicAlphaImage2 
            ...
            _ExtentX        =   4366
            _ExtentY        =   2778
            Image           =   "frmColaboradores.frx":14752
            Opacity         =   30
            Props           =   5
         End
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmColaboradores.frx":38775
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin SGCH.chameleonButton cmdCadastro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmColaboradores.frx":38791
      PICN            =   "frmColaboradores.frx":387AD
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin AlphaImageControl.aicAlphaImage aicAlphaImage1 
            ...
            _ExtentX        =   4048
            _ExtentY        =   4895
            Image           =   "frmColaboradores.frx":38D9E
         End
      End
      Begin SGCH.chameleonButton cmdCadastro 
         Height          =   615
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmColaboradores.frx":38DB6
         PICN            =   "frmColaboradores.frx":38DD2
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmColaboradores.frx":39AAC
         PICN            =   "frmColaboradores.frx":39AC8
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
...
Private rsEPI As New ADODB.Recordset
Private sqlEPI As String
...
Private Sub cmdCadastro_Click(Index As Integer)
    ...
    Case 27
        AlteraCursos
    Case 28
        If MsgBox("Deseja EXCLUIR esse EPI?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
...
Private Sub Form_Load()
    ...
    ElseIf Status = "editar" Then
        ...
        CompoeLVEPI 'Compoe dados do grid de EPIs do colaborador
...
Private Sub listview_cabecalho()
    ...
    ListView1.ColumnHeaders.Add , , "Nome do cargo", ListView1.Width / 5
    ListView1.ColumnHeaders.Add , , "Tempo de experiência", ListView1.Width / 7
    ListView1.ColumnHeaders.Add , , "Nome Empresa", ListView1.Width / 5
    ListView1.ColumnHeaders.Add , , "Data Ent.", ListView1.Width / 10
    ListView1.ColumnHeaders.Add , , "Data Sai.", ListView1.Width / 10
    ListView1.ColumnHeaders.Add , , "Salário", ListView1.Width / 12
    ...
    ListView6.ColumnHeaders.Add , , "Código", ListView6.Width / 10
    ListView6.ColumnHeaders.Add , , "Descrição", ListView6.Width / 1.5
    ListView6.ColumnHeaders.Add , , "D. Entrega", ListView6.Width / 10
...
' (INICIO) >>>>>>>> LIMPA CRONTROLES DA GUIA DE EPI <<<<<<<<<<
Private Sub LimpaControlesEPI()
    Dim X As Integer
    txtCadMatriz(29).Enabled = True
    cmdCadastro(32).Enabled = True
    For X = 28 To 29
        txtCadMatriz(X) = ""
    Next
    txtCadMatriz(29).SetFocus
End Sub
...
Private Sub CompoeLVExp()
    ...
    sqlExp = "Select tbColaboradoresExp.cpf,tbColaboradoresExp.tipo,tbColaboradoresExp.nomeempresa,tbColaboradoresExp.codcargo,tbColaboradoresExp.tempoexp,tbColaboradoresExp.codcoligada,tbcargos.nomecargo,tbColaboradoresExp.dataent,tbColaboradoresExp.datasai,tbColaboradoresExp.salario  " & _
             "from tbColaboradoresExp,tbcargos where tbColaboradoresExp.codcoligada = '" & vCodcoligada & "' and tbColaboradoresExp.codcargo=tbcargos.codcargo and tbColaboradoresExp.CPF = '" & mskCadMatriz.Text & "'"
    ...
    While Not rsExp.EOF
        ...
        If IsNull(rsExp.Fields(7)) Then
            ItemLst.SubItems(4) = "-"
        Else
            ItemLst.SubItems(4) = "" & rsExp.Fields(7)
        End If
        If IsNull(rsExp.Fields(8)) Then
            ItemLst.SubItems(5) = "-"
        Else
            ItemLst.SubItems(5) = "" & rsExp.Fields(8)
        End If
        If IsNull(rsExp.Fields(9)) Then
            ItemLst.SubItems(6) = "-"
        Else
            ItemLst.SubItems(6) = "" & Format(rsExp.Fields(9), "#,##0.00;(#,##0.00)")
        End If
...
Private Sub CompoePontosLVHab()
    ...
    '
    sqlSomaHabilidades = "select sum(pontuacao) from tbColaboradoresHab where tbColaboradoresHab.codcoligada = '" & vCodcoligada & "' and tbColaboradoresHab.cpf = '" & mskCadMatriz & "' and tbColaboradoresHab.codmatriz = '" & Val(Mid$(txtCadMatriz(4), 1, 6)) & "'"
...
' (INICIO) >>>>>>>> COMPOE LISTVIEW6 DA GUIA DE EPIs <<<<<<<<<<
Private Sub CompoeLVEPI()
    Dim rsEPI As New ADODB.Recordset
    Dim sqlEPI As String
    sqlEPI = "select a.codigoprd,a.nomefantasia,a.dataentrega from tbColaboradoresEPI as a where a.codcoligada ='" & vCodcoligada & "' and a.codcolaborador = '" & txtCadMatriz(2).Text & "'"
    rsEPI.Open sqlEPI, cnBanco, adOpenKeyset, adLockReadOnly
    ...
    X = 0
    While Not rsEPI.EOF
        Set ItemLst = ListView6.ListItems.Add(, , rsEPI.Fields(0))
        ItemLst.SubItems(1) = "" & rsEPI.Fields(1)
        ItemLst.SubItems(2) = "" & rsEPI.Fields(2)
        rsEPI.MoveNext
        X = X + 1
    Wend
    rsEPI.Close
...
Private Sub IncluirExperiencia()
    ...
    If Y > 0 Then
        For X = 1 To Y
            If ListView1.ListItems.Item(X) & ListView1.SelectedItem.ListSubItems.Item(3) = Me.txtCadMatriz(8) & Me.txtCadMatriz(1) Then
                ...
                If DTPicker6.Value = "" Then
                    ListView1.SelectedItem.ListSubItems.Item(4) = "-"
                Else
                    ListView1.SelectedItem.ListSubItems.Item(4) = DTPicker6.Value
                End If
                If DTPicker7.Value = "" Then
                    ListView1.SelectedItem.ListSubItems.Item(5) = "-"
                Else
                    ListView1.SelectedItem.ListSubItems.Item(5) = DTPicker7.Value
                End If
                If txtCadMatriz(27).Text = "" Then
                    ListView1.SelectedItem.ListSubItems.Item(6) = "-"
                Else
                    ListView1.SelectedItem.ListSubItems.Item(6) = Format(txtCadMatriz(27).Text, "#,##0.00;(#,##0.00)")
                End If
    ...
    If IsNull(DTPicker6.Value) Then
        ItemLst.SubItems(4) = "-"
    Else
        ItemLst.SubItems(4) = DTPicker6.Value
    End If
    If IsNull(DTPicker7.Value) Then
        ItemLst.SubItems(5) = "-"
    Else
        ItemLst.SubItems(5) = DTPicker7.Value
    End If
    If txtCadMatriz(27).Text = "" Then
        ItemLst.SubItems(6) = "-"
    Else
        ItemLst.SubItems(6) = Format(txtCadMatriz(27).Text, "#,##0.00;(#,##0.00)")
    End If
'    txtCadMatriz(8).SetFocus
End Sub
...
Private Sub AlteraExperiencia()
    ...
    If ListView1.SelectedItem.ListSubItems.Item(4) <> "-" Then
        DTPicker6.Value = ListView1.SelectedItem.ListSubItems.Item(4)
    Else
        DTPicker6.Value = ""
    End If
    If ListView1.SelectedItem.ListSubItems.Item(5) <> "-" Then
        DTPicker7.Value = ListView1.SelectedItem.ListSubItems.Item(5)
    Else
        DTPicker7.Value = ""
    End If
    If txtCadMatriz(27) <> "-" Then
        txtCadMatriz(27) = ListView1.SelectedItem.ListSubItems.Item(6)
    Else
        txtCadMatriz(27) = ""
    End If
...
'(INICIO) >>>>>>>> CONTROLES DOS BOTOES DA GUIA DE IPI <<<<<<<<<<
Private Sub IncluirEPI()
    Dim ItemLst As ListItem
    Dim X As Integer, Y As Integer
    If ValidaEPI = False Then Exit Sub
    Y = ListView6.ListItems.Count
    If Y > 0 Then
        For X = 1 To Y
            If ListView6.ListItems.Item(X) = Me.txtCadMatriz(29) Then
                Me.txtCadMatriz(29) = ListView6.ListItems.Item(X)
                ListView6.SelectedItem.ListSubItems.Item(1) = txtCadMatriz(28)
                If Not IsNull(DTPicker8.Value) Then
                    ListView6.SelectedItem.ListSubItems.Item(2) = DTPicker8
                Else
                    ListView6.SelectedItem.ListSubItems.Item(2) = "-"
                End If
                Y = ListView6.ListItems.Count
                Exit Sub
            End If
        Next
        Set ItemLst = ListView6.ListItems.Add(, , txtCadMatriz(29))
        Y = ListView6.ListItems.Count
    Else
        Set ItemLst = ListView6.ListItems.Add(, , txtCadMatriz(29))
        Y = ListView6.ListItems.Count
    End If
    ItemLst.SubItems(1) = txtCadMatriz(28)
    ItemLst.SubItems(2) = DTPicker8
    txtCadMatriz(29).SetFocus
End Sub

Private Function ValidaEPI()
    ValidaEPI = False
    If txtCadMatriz(29).Text = "" Then
        MsgBox "Favor informar o campo " & Me.txtCadMatriz(29).Tag, vbInformation, "Atenção"
        Me.txtCadMatriz(29).SetFocus
        Exit Function
    End If
    If IsNull(DTPicker8.Value) Then
        MsgBox "Favor informar o campo " & Me.DTPicker8.Tag, vbInformation, "Atenção"
...
Private Sub AlteraEPI()
    If ListView6.ListItems.Count = 0 Then Exit Sub
    Dim Y As Integer, X As Integer
    Y = ListView6.ListItems.Count
    For X = 1 To Y
        If ListView6.ListItems.Item(X).Selected = True Then
            Exit For
        End If
    Next
    Me.txtCadMatriz(29).Text = ListView6.ListItems.Item(X)
    Me.txtCadMatriz(28).Text = ListView6.SelectedItem.ListSubItems.Item(1)
    If Not IsNull(ListView6.SelectedItem.ListSubItems.Item(2)) And ListView6.SelectedItem.ListSubItems.Item(2) <> "-" Then
        Me.DTPicker8.Value = ListView6.SelectedItem.ListSubItems.Item(2)
    Else
        Me.DTPicker8.Value = ""
    End If
    txtCadMatriz(28).Enabled = False
End Sub



'(FIM) >>>>>>>> CONTROLES DOS BOTOES DA GUIA IPI <<<<<<<<<<
...
Private Sub CarregaEPI()
    Dim X As Integer
'    sqlEscolaridade = "Select * from tbEscolaridade where codcoligada = '" & vCodcoligada & "' and ativo = 'S' order by tbEscolaridade.codescolaridade"
'    rsEscolaridade.Open sqlEscolaridade, cnBanco, adOpenKeyset, adLockOptimistic
    
    sqlEPI = "select a.CODIGOPRD,a.NOMEFANTASIA from corporerm.dbo.TPRD as a where a.inativo = 0 and a.CODIGOPRD like '50.%' and a.CODCOLIGADA = '" & vCodcoligada & "' order by a.NOMEFANTASIA"
    rsEPI.Open sqlEPI, cnBanco, adOpenKeyset, adLockReadOnly
    
    If Not rsEPI.EOF Then rsEPI.MoveFirst
    rsEPI.Find "CODIGOPRD=" & "'" & Me.txtCadMatriz(29) & "'"
    If rsEPI.EOF Then
        'txtCadMatriz(12).Text = Format(txtCadMatriz(12), "000000") & ""
        If Val(Pesquisa) <> 0 Then
            MsgBox "EPI não cadastrado", vbInformation, "SGCH"
            txtCadMatriz(28) = ""
        End If
    Else
        'txtCadMatriz(12).Text = Format(rsEscolaridade.Fields(0), "000000") & ""
        txtCadMatriz(28).Text = rsEPI.Fields(1)
    End If
    rsEPI.Close
    Set rsEPI = Nothing
End Sub

Private Sub ChamaGridEPI()
    Dim F As New frmpesqger
    Dim Iposicao As Variant
    Sqlp = "select a.CODIGOPRD,a.NOMEFANTASIA from corporerm.dbo.TPRD as a where a.inativo = 0 and a.CODIGOPRD like '50.%' and a.CODCOLIGADA = '" & vCodcoligada & "' order by a.NOMEFANTASIA"
    procnom = "NOMEFANTASIA"
    campo = 1
    Campo1 = 0
    Load F
    F.Caption = "Pesquisa de EPI"
    Pesquisa = frmColaboradores.Tag
    F.Show 1
    If Pesquisa <> "" Then
        rsLocal.Open Sqlp, cnBanco, adOpenKeyset, adLockOptimistic
        ...
        Iposicao = rsLocal.Bookmark
        rsLocal.MoveFirst
        rsLocal.Find "NOMEFANTASIA=" & "'" & Pesquisa & "'"
        If Not rsLocal.EOF Then
            txtCadMatriz(29).Text = rsLocal.Fields(0)
        End If
        rsLocal.Close
        Set rsLocal = Nothing
    End If
...
'---------------------------------------------------
    ...
    If ListView1.ListItems.Count > 0 Then
        ...
        For X = 1 To ListView1.ListItems.Count
            ...
            If ListView1.SelectedItem.ListSubItems.Item(4) <> "-" Then
                rsSalvar.Fields(6) = ListView1.SelectedItem.ListSubItems.Item(4)
            End If
            If ListView1.SelectedItem.ListSubItems.Item(5) <> "-" Then
                rsSalvar.Fields(7) = ListView1.SelectedItem.ListSubItems.Item(5)
            End If
            If ListView1.SelectedItem.ListSubItems.Item(6) <> "-" Then
                rsSalvar.Fields(8) = ListView1.SelectedItem.ListSubItems.Item(6)
            End If
        Next
    ...
    '>>>>>> GRAVAR HABILIDADE <<<<<<<<<
    If ListView2.ListItems.Count > 0 Then
        SqlSalvar = "Select * from tbColaboradoresHab where tbColaboradoresHab.codcoligada = '" & vCodcoligada & "' and tbColaboradoresHab.cpf = '" & mskCadMatriz.Text & "' and tbColaboradoresHab.codmatriz = '" & Mid$(txtCadMatriz(4), 1, 6) & "' and tipo = 'colaborador' order by codhabilidade "
        rsSalvar.Open SqlSalvar, cnBanco, adOpenKeyset, adLockOptimistic
...
'        End If
    ...
    '>>>>>> GRAVAR EPI <<<<<<<<<
    sqlDeletar = "Delete from tbColaboradoresEPI where tbColaboradoresEPI.codcoligada = '" & vCodcoligada & "' and tbColaboradoresEPI.codcolaborador = '" & txtCadMatriz(2).Text & "'"
    rsDeletar.Open sqlDeletar, cnBanco
    If ListView6.ListItems.Count > 0 Then
        SqlSalvar = "Select * from tbColaboradoresEPI"
        rsSalvar.Open SqlSalvar, cnBanco, adOpenKeyset, adLockOptimistic
    
        For X = 1 To ListView6.ListItems.Count
            ListView6.ListItems.Item(X).Selected = True
            rsSalvar.AddNew
            rsSalvar.Fields(1) = txtCadMatriz(2).Text
            rsSalvar.Fields(2) = ListView6.ListItems.Item(X)
            rsSalvar.Fields(3) = ListView6.SelectedItem.ListSubItems.Item(1)
            rsSalvar.Fields(4) = ListView6.SelectedItem.ListSubItems.Item(2) 'data entrega
            rsSalvar.Fields(5) = vCodcoligada 'Codigo da coligada
        Next
        If Not rsSalvar.EOF Then rsSalvar.Update
        rsSalvar.Close
...
Private Sub txtCadMatriz_KeyPress(Index As Integer, KeyAscii As Integer)
    Select Case Index
    Case 27
        If Not IsNumeric(Chr(KeyAscii)) And KeyAscii <> 8 And KeyAscii <> 13 And KeyAscii <> 44 And KeyAscii <> 46 Then
            KeyAscii = 0
        End If
    End Select
End Sub
...
Private Sub txtCadMatriz_LostFocus(Index As Integer)
    ...
    Case 27
        txtCadMatriz(27).Text = Format(txtCadMatriz(27).Text, "#,##0.00;(#,##0.00)")
    End Select
End Sub
