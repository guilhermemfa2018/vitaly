...
Begin VB.Form frmSetores 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmSetores.frx":0D1E
         PICN            =   "frmSetores.frx":0D3A
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmSetores.frx":1A14
         PICN            =   "frmSetores.frx":1A30
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmSetores.frx":270A
         PICN            =   "frmSetores.frx":2726
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmSetores.frx":3400
         PICN            =   "frmSetores.frx":341C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin SGCH.chameleonButton cmdCadastro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmSetores.frx":40F6
      PICN            =   "frmSetores.frx":4112
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin SGCH.chameleonButton cmdCadastro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmSetores.frx":4DEC
      PICN            =   "frmSetores.frx":4E08
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
Private rsSecaoRM As New ADODB.Recordset
Private sqlSecaoRM As String
...
Private Sub Form_Load()
    ...
    If vIntegra = "S" Then
        ...
        label11Enabled = True
        txtCadSetor(8).Enabled = True
        txtCadSetor(7).Enabled = True
...
'On Error GoTo TrataErro
    ...
    rsSalvarSetor.Fields(6) = txtCadSetor(8) 'Codigo da Seção RM
...
Private Sub CompoeControles()
    ...
    If Not IsNull(rsSetores.Fields(7)) Then txtCadSetor(8).Text = rsSetores.Fields(7)
    If Not IsNull(rsSetores.Fields(7)) Then txtCadSetor(7).Text = rsSetores.Fields(8)
...
Private Sub ResultPesq()
    SqlSetores = "Select a.codsetor,a.nomesetor,a.coddepartamento,a.descricao,a.ativo,a.codcoligada,b.nomedepartamento,a.codsecaorm,c.descricao from tbSetores as a inner join tbdepartamentos as b on a.coddepartamento = b.coddepartamento left join corporerm.dbo.PSECAO as c on a.codsecaorm = c.CODIGO and a.codcoligada = c.CODCOLIGADA Where a.codcoligada = '" & vCodcoligada & "' and a.codSetor= '" & Val(varGlobal) & "' order by a.codSetor"
...
Private Sub CarregaSecaoRM()
    Dim X As Integer
    sqlSecaoRM = "Select CODIGO,DESCRICAO from corporerm.dbo.PSECAO where codcoligada = '" & vCodcoligada & "' and SECAODESATIVADA = 0 order by descricao"
    rsSecaoRM.Open sqlSecaoRM, cnBanco, adOpenKeyset, adLockOptimistic
    If Not rsSecaoRM.EOF Then rsSecaoRM.MoveFirst
    rsSecaoRM.Find "codigo=" & "'" & Me.txtCadSetor(8) & "'"
    If rsSecaoRM.EOF Then
        If Val(Pesquisa) <> 0 Then
            MsgBox "Seção RM não cadastrada", vbInformation, "SGCH"
            txtCadSetor(7) = ""
        End If
    Else
        txtCadSetor(8).Text = rsSecaoRM.Fields(0)
        txtCadSetor(7).Text = rsSecaoRM.Fields(1)
    End If
    rsSecaoRM.Close
    Set rsSecaoRM = Nothing
End Sub

Private Sub ChamaGridSecaoRM()
    Dim F As New frmpesqger
    Dim Iposicao As Variant
    Sqlp = "Select CODIGO,DESCRICAO from corporerm.dbo.PSECAO where codcoligada = '" & vCodcoligada & "' and SECAODESATIVADA = 0 order by descricao"
    procnom = "descricao"
    campo = 1
    Campo1 = 0
    Load F
    F.Caption = "Pesquisa de Seção RM"
    ...
    If Pesquisa <> "" Then
        ...
        If Not rsLocal.EOF Then
            txtCadSetor(8).Text = rsLocal.Fields(0)
        End If
        rsLocal.Close
        Set rsLocal = Nothing
    End If
