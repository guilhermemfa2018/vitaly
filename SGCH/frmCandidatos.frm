...
Begin VB.Form frmCandidatos 
   ...
   Begin VB.Frame Frame6 
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmCandidatos.frx":0CE2
         PICN            =   "frmCandidatos.frx":0CFE
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmCandidatos.frx":19D8
         PICN            =   "frmCandidatos.frx":19F4
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmCandidatos.frx":2670D
         ...
         TabPicture(1)   =   "frmCandidatos.frx":26729
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "txtCadMatriz(1)"
         Tab(1).Control(0).Enabled=   0   'False
         Tab(1).Control(1)=   "txtCadMatriz(9)"
         Tab(1).Control(1).Enabled=   0   'False
         Tab(1).Control(2)=   "txtCadMatriz(8)"
         Tab(1).Control(2).Enabled=   0   'False
         Tab(1).Control(3)=   "cboCadMatriz(2)"
         Tab(1).Control(3).Enabled=   0   'False
         Tab(1).Control(4)=   "cboCadMatriz(3)"
         Tab(1).Control(4).Enabled=   0   'False
         Tab(1).Control(5)=   "ListView1"
         Tab(1).Control(5).Enabled=   0   'False
         Tab(1).Control(6)=   "cmdCadastro(18)"
         Tab(1).Control(6).Enabled=   0   'False
         Tab(1).Control(7)=   "cmdCadastro(3)"
         Tab(1).Control(7).Enabled=   0   'False
         Tab(1).Control(8)=   "cmdCadastro(2)"
         Tab(1).Control(8).Enabled=   0   'False
         Tab(1).Control(9)=   "cmdCadastro(1)"
         Tab(1).Control(9).Enabled=   0   'False
         Tab(1).Control(10)=   "cmdCadastro(0)"
         Tab(1).Control(10).Enabled=   0   'False
         Tab(1).Control(11)=   "cmdCadastro(24)"
         ...
         TabPicture(2)   =   "frmCandidatos.frx":26745
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "ListView2"
         Tab(2).Control(0).Enabled=   0   'False
         Tab(2).ControlCount=   1
         TabCaption(3)   =   "Cursos"
         TabPicture(3)   =   "frmCandidatos.frx":26761
         ...
         Tab(3).Control(7)=   "cmdCadastro(5)"
         Tab(3).Control(7).Enabled=   0   'False
         Tab(3).Control(8)=   "cmdCadastro(4)"
         Tab(3).Control(8).Enabled=   0   'False
         Tab(3).Control(9)=   "txtCadMatriz(11)"
         Tab(3).Control(9).Enabled=   0   'False
         Tab(3).Control(10)=   "txtCadMatriz(10)"
         Tab(3).Control(10).Enabled=   0   'False
         Tab(3).Control(11)=   "cboCadMatriz(5)"
         Tab(3).Control(11).Enabled=   0   'False
         Tab(3).ControlCount=   12
         TabCaption(4)   =   "Graduação"
         TabPicture(4)   =   "frmCandidatos.frx":2677D
         Tab(4).ControlEnabled=   0   'False
         Tab(4).Control(0)=   "txtCadMatriz(12)"
         Tab(4).Control(0).Enabled=   0   'False
         Tab(4).Control(1)=   "txtCadMatriz(13)"
         Tab(4).Control(1).Enabled=   0   'False
         Tab(4).Control(2)=   "ListView4"
         Tab(4).Control(2).Enabled=   0   'False
         Tab(4).Control(3)=   "cmdCadastro(6)"
         Tab(4).Control(3).Enabled=   0   'False
         Tab(4).Control(4)=   "cmdCadastro(9)"
         Tab(4).Control(4).Enabled=   0   'False
         Tab(4).Control(5)=   "cmdCadastro(10)"
         Tab(4).Control(5).Enabled=   0   'False
         Tab(4).Control(6)=   "cmdCadastro(16)"
         Tab(4).Control(6).Enabled=   0   'False
         Tab(4).Control(7)=   "cmdCadastro(17)"
         Tab(4).Control(7).Enabled=   0   'False
         Tab(4).Control(8)=   "cmdCadastro(26)"
         Tab(4).Control(8).Enabled=   0   'False
         Tab(4).Control(9)=   "Label13"
         Tab(4).Control(9).Enabled=   0   'False
         Tab(4).Control(10)=   "Label14"
         Tab(4).Control(10).Enabled=   0   'False
         Tab(4).ControlCount=   11
         TabCaption(5)   =   "Cargos Pret."
         TabPicture(5)   =   "frmCandidatos.frx":26799
         Tab(5).ControlEnabled=   0   'False
         Tab(5).Control(0)=   "txtCadMatriz(20)"
         Tab(5).Control(0).Enabled=   0   'False
         Tab(5).Control(1)=   "txtCadMatriz(0)"
         Tab(5).Control(1).Enabled=   0   'False
         Tab(5).Control(2)=   "txtCadMatriz(5)"
         Tab(5).Control(2).Enabled=   0   'False
         Tab(5).Control(3)=   "txtCadMatriz(6)"
         Tab(5).Control(3).Enabled=   0   'False
         Tab(5).Control(4)=   "ListView5"
         Tab(5).Control(4).Enabled=   0   'False
         Tab(5).Control(5)=   "cmdCadastro(11)"
         Tab(5).Control(5).Enabled=   0   'False
         Tab(5).Control(6)=   "cmdCadastro(19)"
         Tab(5).Control(6).Enabled=   0   'False
         Tab(5).Control(7)=   "cmdCadastro(20)"
         Tab(5).Control(7).Enabled=   0   'False
         Tab(5).Control(8)=   "cmdCadastro(21)"
         Tab(5).Control(8).Enabled=   0   'False
         Tab(5).Control(9)=   "cmdCadastro(22)"
         Tab(5).Control(9).Enabled=   0   'False
         Tab(5).Control(10)=   "Label31"
         Tab(5).Control(10).Enabled=   0   'False
         Tab(5).Control(11)=   "Label26"
         Tab(5).Control(11).Enabled=   0   'False
         Tab(5).Control(12)=   "Label25"
         Tab(5).Control(12).Enabled=   0   'False
         Tab(5).Control(13)=   "Label15"
         Tab(5).Control(13).Enabled=   0   'False
         Tab(5).ControlCount=   14
         TabCaption(6)   =   "Integração"
         TabPicture(6)   =   "frmCandidatos.frx":267B5
         ...
         Begin TabDlg.SSTab SSTab2 
            ...
            TabPicture(0)   =   "frmCandidatos.frx":267D1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "lblCons(0)"
            Tab(0).Control(0).Enabled=   0   'False
            Tab(0).Control(1)=   "lblCons(1)"
            Tab(0).Control(1).Enabled=   0   'False
            Tab(0).Control(2)=   "lblCons(2)"
            Tab(0).Control(2).Enabled=   0   'False
            Tab(0).Control(3)=   "lblCons(3)"
            Tab(0).Control(3).Enabled=   0   'False
            Tab(0).Control(4)=   "lblCons(4)"
            Tab(0).Control(4).Enabled=   0   'False
            Tab(0).Control(5)=   "lblCons(5)"
            Tab(0).Control(5).Enabled=   0   'False
            Tab(0).Control(6)=   "lblCons(6)"
            Tab(0).Control(6).Enabled=   0   'False
            Tab(0).Control(7)=   "lblCons(7)"
            Tab(0).Control(7).Enabled=   0   'False
            Tab(0).Control(8)=   "lblCons(8)"
            Tab(0).Control(8).Enabled=   0   'False
            Tab(0).Control(9)=   "lblCons(9)"
            Tab(0).Control(9).Enabled=   0   'False
            Tab(0).Control(10)=   "lblCons(10)"
            Tab(0).Control(10).Enabled=   0   'False
            Tab(0).Control(11)=   "lblCons(11)"
            Tab(0).Control(11).Enabled=   0   'False
            Tab(0).Control(12)=   "lblCons(12)"
            Tab(0).Control(12).Enabled=   0   'False
            Tab(0).Control(13)=   "Combo(1)"
            Tab(0).Control(13).Enabled=   0   'False
            Tab(0).Control(14)=   "txtCons(0)"
            ...
            TabPicture(1)   =   "frmCandidatos.frx":267ED
            Tab(1).ControlEnabled=   0   'False
            Tab(1).ControlCount=   0
            TabCaption(2)   =   "SAP"
            TabPicture(2)   =   "frmCandidatos.frx":26809
            Tab(2).ControlEnabled=   0   'False
            ...
            Begin VB.ComboBox Combo 
               Height          =   315
               Index           =   10
               ItemData        =   "frmCandidatos.frx":26825
               Left            =   960
               List            =   "frmCandidatos.frx":26827
               TabIndex        =   73
               Tag             =   "Seção"
               ToolTipText     =   "Seção"
               Top             =   2400
         ...
         Begin VB.ComboBox cboCadMatriz 
            Height          =   315
            Index           =   2
            ItemData        =   "frmCandidatos.frx":26829
            Left            =   -69720
            List            =   "frmCandidatos.frx":26851
            TabIndex        =   20
         ...
         Begin VB.ComboBox cboCadMatriz 
            Height          =   315
            Index           =   3
            ItemData        =   "frmCandidatos.frx":26891
            Left            =   -68880
            List            =   "frmCandidatos.frx":2689B
            TabIndex        =   21
            Tag             =   "Periodicidade do curso/treinamento"
            Text            =   "Meses"
            ToolTipText     =   "Periodicidade do curso/treinamento"
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VB.ComboBox cboCadMatriz 
               Height          =   315
               Index           =   4
               ItemData        =   "frmCandidatos.frx":268AC
               Left            =   2880
               List            =   "frmCandidatos.frx":26901
               TabIndex        =   8
            ...
            Begin VB.ComboBox cboCadMatriz 
               Height          =   315
               Index           =   1
               ItemData        =   "frmCandidatos.frx":26971
               Left            =   120
               List            =   "frmCandidatos.frx":26987
               TabIndex        =   5
               Tag             =   "Estado civil"
            ...
            Begin VB.ComboBox cboCadMatriz 
               Height          =   315
               Index           =   0
               ItemData        =   "frmCandidatos.frx":269D6
               Left            =   1560
               List            =   "frmCandidatos.frx":269E0
               TabIndex        =   4
               Tag             =   "Sexo"
               ToolTipText     =   "Sexo"
               Top             =   480
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":26A15
            PICN            =   "frmCandidatos.frx":26A31
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":2770B
            PICN            =   "frmCandidatos.frx":27727
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":28401
            PICN            =   "frmCandidatos.frx":2841D
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":290F7
            PICN            =   "frmCandidatos.frx":29113
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":29DED
            PICN            =   "frmCandidatos.frx":29E09
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":2AAE3
            PICN            =   "frmCandidatos.frx":2AAFF
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":2B7D9
            PICN            =   "frmCandidatos.frx":2B7F5
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":2C4CF
            PICN            =   "frmCandidatos.frx":2C4EB
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":2D1FD
            PICN            =   "frmCandidatos.frx":2D219
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":2DEF3
            PICN            =   "frmCandidatos.frx":2DF0F
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":2EBE9
            PICN            =   "frmCandidatos.frx":2EC05
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":2F8FB
            PICN            =   "frmCandidatos.frx":2F917
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":305F1
            PICN            =   "frmCandidatos.frx":3060D
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":312E7
            PICN            =   "frmCandidatos.frx":31303
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":31FDD
            PICN            =   "frmCandidatos.frx":31FF9
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":32CD3
            PICN            =   "frmCandidatos.frx":32CEF
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":339C9
            PICN            =   "frmCandidatos.frx":339E5
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmCandidatos.frx":346BF
            PICN            =   "frmCandidatos.frx":346DB
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
   ...
   Begin SGCH.chameleonButton cmdCadastro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmCandidatos.frx":353B5
      PICN            =   "frmCandidatos.frx":353D1
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin SGCH.chameleonButton cmdCadastro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmCandidatos.frx":360AB
      PICN            =   "frmCandidatos.frx":360C7
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
Private Sub cmdCadastro_Click(Index As Integer)
    ...
    Case 2
        AlteraExperiencia
    Case 3
        If MsgBox("Deseja EXCLUIR essa experiência do candidato?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
    ...
    Case 5
        If MsgBox("Deseja EXCLUIR esse curso/treinamento do candidato?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
            ExcluirItemLV ListView3
            LimpaControlesTreinamento
        End If
    Case 6
        If MsgBox("Deseja EXCLUIR essa formação escolar do candidato?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
    ...
    Case 13
        ...
        Label53 = ""
    Case 14
        If MsgBox("Deseja salvar os dados do candidato?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
            GravarDados
        ...
        End If
    Case 15
        If MsgBox("Deseja sair da tela de cadastro do candidato?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
            Unload Me
...
Private Sub listview_cabecalho()
    ...
    ListView2.ColumnHeaders.Add , , "Habilidade", ListView2.Width / 1.5
...
Private Sub CompoePontosLVHab()
    ...
    If rsSomaHabilidade.Fields(0) = 0 Then
        sqlDeletaHabilidades = "delete from tbColaboradoresHab where tbColaboradoresHab.codcoligada = '" & vCodcoligada & "' and tbColaboradoresHab.cpf = '" & mskCadMatriz & "' and tbColaboradoresHab.codmatriz = '" & Val(Mid$(txtCadMatriz(4), 1, 6)) & "'"
...
'On Error GoTo TrataErro
    ...
    Else
        ...
        Else
            MsgBox "Já existe cadastrado um CANDIDATO com o mesmo CPF", vbCritical, "SGCH"
    ...
    MsgBox "Os dados do Candidato foram salvos com sucesso", vbInformation, "SGCH"
    AtualizaListview
    Exit Sub
TrataErro:
...
Private Function ValidaCampo()
    ...
    If cboCadMatriz(0).Text = "" Then
        MsgBox "Favor informar o campo " & Me.cboCadMatriz(0).Tag, vbInformation, "Atenção"
    ...
    If cboCadMatriz(1).Text = "" Then
        MsgBox "Favor informar o campo " & Me.cboCadMatriz(1).Tag, vbInformation, "Atenção"
    ...
    If txtCadMatriz(7).Text = "" Then
        MsgBox "Favor informar o campo " & Me.txtCadMatriz(7).Tag, vbInformation, "Atenção"
    ...
    If txtCadMatriz(14).Text = "" Then
        MsgBox "Favor informar o campo " & Me.txtCadMatriz(14).Tag, vbInformation, "Atenção"
    ...
    If cboCadMatriz(4).Text = "" Then
        MsgBox "Favor informar o campo " & Me.cboCadMatriz(4).Tag, vbInformation, "Atenção"
...
Private Sub ResultPesq(Status As String)
    If Status = "editar" Then
        ...
        If rsColaboradores.RecordCount > 0 Then
            CompoeControles
        Else
            MsgBox "Candidato não encontrado"
        End If
    ElseIf Status = "novo" Then
        ...
        rsColaboradores.Open SqlColaboradores, cnBanco, adOpenKeyset, adLockReadOnly
        If rsColaboradores.RecordCount > 0 Then
            MsgBox "Já existe um colaborador cadastrado no sistema com esse CPF", vbCritical, "SGCH"
            mskCadMatriz.SetFocus
        End If
    End If
