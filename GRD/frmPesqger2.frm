...
Begin VB.Form frmPesqger2 
   ...
   Tag             =   "vbNormal"
   Begin GRD.chameleonButton chameleonButton2 
      Height          =   615
      Left            =   720
      TabIndex        =   6
      Top             =   5280
      ...
      VALUE           =   0   'False
   End
   Begin GRD.chameleonButton chameleonButton1 
      Height          =   615
      Left            =   120
      TabIndex        =   5
      Top             =   5280
      ...
      VALUE           =   0   'False
   End
   Begin GRD.chameleonButton chameleonButton3 
      Height          =   615
      Left            =   6120
      TabIndex        =   4
      Top             =   240
...
Private Sub listview_cabecalho()
    ...
    'Else
        ListView1.ColumnHeaders.Add , , "Código", ListView1.Width / 5
        ListView1.ColumnHeaders.Add , , "Título", ListView1.Width / 1.4
    'End If
