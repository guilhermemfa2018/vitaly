...
Me.Caption = "IMRM" & " - Versão: " & App.Major & "." & App.Minor & "." & App.Revision
...
Private Sub Ribbon_ButtonClick(ByVal ID As String, ByVal Caption As String)
    ...
    Tipo = True
    checaFiltro = True
    If ID = 1 Then  '(Empréstimo/Devolução)
        'apontaLV = 0
        'FiltroGeral = "Ativos"
        'MontaLV (apontaLV)
    End If
    If ID = 2 Then '(Grupo de critérios de recebimento)
        'apontaLV = 1
        'FiltroGeral = "Todos"
        'MontaLV (apontaLV)
    End If
    If ID = 3 Then '(Critérios de Avaliação de Fornecedores)
        apontaLV = 3
        'FiltroGeral = "Ativos"
        'MontaLV (apontaLV)
    End If
    If ID = 4 Then '(Grupo de critérios de Avaliação de Fornecedores)
        apontaLV = 2
        'FiltroGeral = "Ativos"
        'MontaLV (apontaLV)
    End If
...
'        MontaLV (apontaLV)
    ...
    If ID = 11 Then '(Medição de Terceiros)
        apontaLV = 0
        FiltroGeral = "Todos"
        MontaLV (apontaLV)
    End If
    
    If ID = 12 Then '(Medição de PJ)
        apontaLV = 1
        FiltroGeral = "Todos"
        MontaLV (apontaLV)
    End If
...
'        frmComunicacaoDesvio.Show 1
 ...
 '       MontaLV (apontaLV)
    ...
    If ID = 41 Then ' Relatórios de Expedição
 '       apontaLV = 17
 '       FiltroGeral = "Todos"
 '       MontaLV (apontaLV)
    End If
...
Private Sub montaTabMenu()
    ...
    Else
        ...
        SqlMenu = "Insert into tbMenu(idmenu,idsub,tipo,nome,codcoligada) Values(1,'01','TAB','Cadastros','" & vCodcoligada & "');" & _
                   "Insert into tbMenu(idmenu,idsub,tipo,nome,codcoligada) Values(1,'01','CAT','Primários','" & vCodcoligada & "');" & _
                   "Insert into tbMenu(idmenu,idsub,tipo,nome,codcoligada) Values(1,'02','CAT','Secundários','" & vCodcoligada & "');" & _
                   ...
                   "Insert into tbMenu(idmenu,idsub,tipo,nome,codcoligada) Values(2,'02','TAB','Movimentações','" & vCodcoligada & "');" & _
                   "Insert into tbMenu(idmenu,idsub,tipo,nome,codcoligada) Values(2,'11','CAT','Gestaõ de Movimentações','" & vCodcoligada & "');" & _
                   "Insert into tbMenu(idmenu,idsub,tipo,nome,codcoligada) Values(2,'1111','BUT','Emprestimos/Devoluções','" & vCodcoligada & "');" & _
                   "Insert into tbMenu(idmenu,idsub,tipo,nome,codcoligada) Values(6,'06','TAB','Configurações','" & vCodcoligada & "');" & _
                   "Insert into tbMenu(idmenu,idsub,tipo,nome,codcoligada) Values(6,'51','CAT','Parametrizações','" & vCodcoligada & "');" & _
                   "Insert into tbMenu(idmenu,idsub,tipo,nome,codcoligada) Values(6,'52','CAT','Aparência','" & vCodcoligada & "');" & _
                   ...
                   "Insert into tbMenu(idmenu,idsub,tipo,nome,codcoligada) Values(6,'5153','BUT','Usuários','" & vCodcoligada & "');" & _
        ...
        If rsMenu.RecordCount = 0 Then
            ...
            SqlMenu = "Insert into tbmenuconf(idmenu,idsub,tipo,nome,id,codcoligada,icon) Values(1,'01','TAB','Cadastros',1,'" & vCodcoligada & "',0);" & _
                       "Insert into tbmenuconf(idmenu,idsub,tipo,nome,id,codcoligada,icon) Values(1,'01001','CAT','Primários',2,'" & vCodcoligada & "',0);" & _
                       "Insert into tbmenuconf(idmenu,idsub,tipo,nome,id,codcoligada,icon) Values(1,'01002','CAT','Secundários',3,'" & vCodcoligada & "',0);" & _
                       ...
                       "Insert into tbmenuconf(idmenu,idsub,tipo,nome,id,codcoligada,icon) Values(2,'02','TAB','Movimentações',12,'" & vCodcoligada & "',0);" & _
                       "Insert into tbmenuconf(idmenu,idsub,tipo,nome,id,codcoligada,icon) Values(2,'02011','CAT','Gestaõ de Movimentações',13,'" & vCodcoligada & "',0);" & _
                       "Insert into tbmenuconf(idmenu,idsub,tipo,nome,id,codcoligada,icon) Values(2,'0201111','BUT','Emprestimos/Devoluções',14,'" & vCodcoligada & "',9);" & _
                       "Insert into tbmenuconf(idmenu,idsub,tipo,nome,id,codcoligada,icon) Values(6,'06','TAB','Configurações',15,'" & vCodcoligada & "',0);" & _
                       "Insert into tbmenuconf(idmenu,idsub,tipo,nome,id,codcoligada,icon) Values(6,'06051','CAT','Parametrizações',16,'" & vCodcoligada & "',0);" & _
                       "Insert into tbmenuconf(idmenu,idsub,tipo,nome,id,codcoligada,icon) Values(6,'06052','CAT','Aparência',17,'" & vCodcoligada & "',0);" & _
                       ...
                       "Insert into tbmenuconf(idmenu,idsub,tipo,nome,id,codcoligada,icon) Values(6,'0605153','BUT','Usuários',20,'" & vCodcoligada & "',19);" & _
