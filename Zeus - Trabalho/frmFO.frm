...
Begin VB.Form frmFO 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(6)=   "chamCad(3)"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).Control(7)=   "Frame14"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).Control(8)=   "chamCad(0)"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).Control(9)=   "chamCad(2)"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "chamCad(1)"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "SkinLabel19"
      ...
      Tab(2).Control(4)=   "SkinLabel38"
      Tab(2).Control(5)=   "SkinLabel39"
      Tab(2).Control(6)=   "lbltotl"
      Tab(2).Control(7)=   "lbltotpm"
...
Private Sub AtualizaListview()
    ...
    If Status = "novo" Then
        ...
        Else
            ItemLst.SubItems(13) = SkinLabel45.Caption ' FCE
        End If
