...
Public objText(19, 15) As TextBox
Public objFrame(19, 15) As Frame
Public objCombo(19, 15) As ComboBox
Public objLabel(19, 15) As Label
Public objListview(19, 15) As MSComctlLib.Listview
Public objPicture(19, 15) As PictureBox
