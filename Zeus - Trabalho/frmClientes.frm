...
Private Sub AtualizaListview()
    ...
    Next
    If Status = "novo" Then
        Set ItemLst = MeuLV.ListView1.ListItems.Add(, , Format(txtCadastro(0), "000000"))
        ...
        End If
    Else
        MeuLV.ListView1.SelectedItem.ListSubItems.Item(1) = txtCadastro(2).Text
        MeuLV.ListView1.SelectedItem.ListSubItems.Item(2) = txtCadastro(3).Text
        MeuLV.ListView1.SelectedItem.ListSubItems.Item(3) = txtCadastro(21).Text
        MeuLV.ListView1.SelectedItem.ListSubItems.Item(4) = txtCadastro(4).Text
        MeuLV.ListView1.SelectedItem.ListSubItems.Item(5) = txtCadastro(5).Text
        MeuLV.ListView1.SelectedItem.ListSubItems.Item(6) = cboCadastro(0).Text
        If Check1.Value = 0 Then
