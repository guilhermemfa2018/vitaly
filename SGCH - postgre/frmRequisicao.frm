...
Begin VB.Form frmRequisicao 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(13)=   "cmdCadastro(10)"
      Tab(0).Control(14)=   "ListView1"
      Tab(0).Control(15)=   "txtCadReq(8)"
      Tab(0).Control(16)=   "txtCadReq(7)"
      Tab(0).Control(17)=   "txtCadReq(6)"
      Tab(0).Control(18)=   "txtCadReq(11)"
      Tab(0).Control(19)=   "txtCadReq(12)"
      Tab(0).Control(20)=   "txtCadReq(9)"
      Tab(0).Control(21)=   "txtCadReq(10)"
      Tab(0).Control(22)=   "DTPicker2"
      Tab(0).Control(23)=   "txtCadReq(16)"
      ...
      Tab(1).Control(3)=   "cmdCadastro(6)"
      Tab(1).Control(3).Enabled=   0   'False
      Tab(1).Control(4)=   "cmdCadastro(7)"
      Tab(1).Control(4).Enabled=   0   'False
      Tab(1).Control(5)=   "cmdCadastro(8)"
      Tab(1).Control(5).Enabled=   0   'False
      Tab(1).Control(6)=   "cmdCadastro(9)"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).Control(7)=   "cmdCadastro(5)"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).Control(8)=   "txtCadReq(14)"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).Control(9)=   "txtCadReq(15)"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "ListView2"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "cboCadRequisicao(2)"
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmRequisicao.frx":0D68
         PICN            =   "frmRequisicao.frx":0D84
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmRequisicao.frx":1A5E
         PICN            =   "frmRequisicao.frx":1A7A
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmRequisicao.frx":2754
         PICN            =   "frmRequisicao.frx":2770
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmRequisicao.frx":344A
         PICN            =   "frmRequisicao.frx":3466
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmRequisicao.frx":415C
         PICN            =   "frmRequisicao.frx":4178
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmRequisicao.frx":4E52
         PICN            =   "frmRequisicao.frx":4E6E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmRequisicao.frx":5B48
         PICN            =   "frmRequisicao.frx":5B64
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmRequisicao.frx":683E
         PICN            =   "frmRequisicao.frx":685A
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.ComboBox cboCadRequisicao 
         Height          =   315
         Index           =   1
         ItemData        =   "frmRequisicao.frx":7534
         Left            =   120
         List            =   "frmRequisicao.frx":753E
         TabIndex        =   2
         Text            =   "Interno"
         Top             =   480
         Width           =   1095
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox cboCadRequisicao 
         Height          =   315
         Index           =   0
         ItemData        =   "frmRequisicao.frx":7554
         Left            =   120
         List            =   "frmRequisicao.frx":7564
         TabIndex        =   4
         Text            =   "Colaborador"
         Top             =   480
         Width           =   1455
   ...
   Begin SGCH.chameleonButton cmdCadastro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmRequisicao.frx":75BA
      PICN            =   "frmRequisicao.frx":75D6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin SGCH.chameleonButton cmdCadastro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmRequisicao.frx":82B0
      PICN            =   "frmRequisicao.frx":82CC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
Private Sub cmdCadastro_Click(Index As Integer)
    ...
    Case 2
        AlteraCargoReq
    Case 3
        If MsgBox("Deseja EXCLUIR esse cargo da Requisição?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
            ExcluirCargoReq
            LimpaControlesCargoReq
        End If
    Case 4
    ...
    Case 8
        AlteraAprovadorReq
    Case 9
        If MsgBox("Deseja EXCLUIR esse aprovador da Requisição?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
    ...
    Case 10
        ...
        CarregaCargoReq
    Case 11
        If MsgBox("Deseja salvar os dados de Requisição?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
            GravarDados
            gravaLog "Código req: " & txtCadReq(0), "Requisitante" & txtCadReq(1) & "-" & txtCadReq(2), ""
            Pesquisa = "0"
        End If
    Case 12
        If MsgBox("Deseja sair da tela de cadastro de Requisição?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
            Pesquisa = "0"
            Unload Me
...
Private Sub ExcluirCargoReq()
    ...
    Else
        MsgBox "Este cargo já está ocupado, não pode ser excluido"
    End If
End Sub
...
'On Error GoTo TrataErro
    ...
    MsgBox "Os dados da Requisição foram salvos com sucesso", vbInformation, "SGCH"
    AtualizaListview
    Exit Sub
TrataErro:
...
Private Function ValidaCampo()
    ...
    If txtCadReq(6).Text = "" Then
        MsgBox "Favor informar o campo " & Me.txtCadReq(6).Tag, vbInformation, "Atenção"
        Me.txtCadReq(6).SetFocus
        Exit Function
    End If
    If txtCadReq(10).Text = "" Or txtCadReq(10).Text = 0 Then
        MsgBox "Favor informar o campo " & Me.txtCadReq(10).Tag, vbInformation, "Atenção"
...
Private Function ValidaCampoSalvar()
    ...
    If txtCadReq(1).Text = "" Then
        MsgBox "Favor informar o campo " & Me.txtCadReq(1).Tag, vbInformation, "Atenção"
        Me.txtCadReq(1).SetFocus
        Exit Function
    End If
    If ListView1.ListItems.Count = 0 Then
        MsgBox "Favor informar Cargos requisitados", vbInformation, "Atenção"
        Exit Function
    End If
    If ListView2.ListItems.Count = 0 Then
        MsgBox "Favor informar aprovador da requisição", vbInformation, "Atenção"
        Exit Function
    End If
...
Private Sub ResultPesq()
    ...
    Else
        MsgBox "Requisição não encontrado"
    End If
    rsRequisicoes.Close
    Set rsRequisicoes = Nothing
    Label17.Caption = Format(GeraCodigo1, "000")
...
Private Sub CarregaColaborador(indice As Integer)
    ...
    If indice = 0 Then
        If rsColaborador.RecordCount <= 0 Then
            If txtCadReq(1).Text <> "000000" And txtCadReq(1).Text <> "" Then MsgBox "Colaborador não cadastrado", vbInformation, "SGCH"
            txtCadReq(2) = ""
            txtCadReq(3) = ""
            txtCadReq(4) = ""
        Else
    ...
    If indice = 2 Then
        If rsColaborador.RecordCount <= 0 Then
            If txtCadReq(14).Text <> "000000" And txtCadReq(14).Text <> "" Then MsgBox "Colaborador não cadastrado", vbInformation, "SGCH"
            txtCadReq(15) = ""
        Else
