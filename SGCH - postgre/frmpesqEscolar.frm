...
Begin VB.Form frmPesqEscolar 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox Combo1 
            Height          =   315
            ItemData        =   "frmpesqEscolar.frx":0CCA
            Left            =   2040
            List            =   "frmpesqEscolar.frx":0CD4
            TabIndex        =   3
            Top             =   240
            Width           =   1695
         End
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmpesqEscolar.frx":0CEE
               Key             =   "OK"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmpesqEscolar.frx":1700
               Key             =   "EXC"
            EndProperty
         EndProperty
      End
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqEscolar.frx":2112
         PICN            =   "frmpesqEscolar.frx":212E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqEscolar.frx":2E08
         PICN            =   "frmpesqEscolar.frx":2E24
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqEscolar.frx":3AFE
         PICN            =   "frmpesqEscolar.frx":3B1A
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqEscolar.frx":47F4
         PICN            =   "frmpesqEscolar.frx":4810
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqEscolar.frx":54EA
         PICN            =   "frmpesqEscolar.frx":5506
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqEscolar.frx":61E0
         PICN            =   "frmpesqEscolar.frx":61FC
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqEscolar.frx":6ED6
         PICN            =   "frmpesqEscolar.frx":6EF2
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqEscolar.frx":7BCC
         PICN            =   "frmpesqEscolar.frx":7BE8
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqEscolar.frx":88C2
         PICN            =   "frmpesqEscolar.frx":88DE
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmPesqEscolar"
...
On Error GoTo Err
    ...
    Case 3
        ...
        End If
    Case 4
        DesabBotoesN1 frmPesqEscolar
        Pesquisa = "novo"
        frmEscolaridade.Show 1
        HabBotoesN1 frmPesqEscolar
   Case 5
        DesabBotoesN1 frmPesqEscolar
        Pesquisa = "editar"
        AlteraListview
        If varGlobal <> "" Then frmEscolaridade.Show 1
        HabBotoesN1 frmPesqEscolar
    Case 6
        On Error GoTo Err
        Y = ListView1.ListItems.Count
...
Private Sub Form_Load()
    'frmMenu2
    Frame1.Caption = "Escolaridade"
    frmMenu2.StatusBar1.Panels(3) = Legenda
    frmPesqEscolar.Top = frmMenu2.ACPRibbon1.Height + 290
    frmPesqEscolar.Left = frmMenu2.Left + 130
    frmPesqEscolar.Width = frmMenu2.Width - 300
    
    frmPesqEscolar.Frame1.Width = frmPesqEscolar.Width - (frmPesqEscolar.Width * 1.5 / 100)
    frmPesqEscolar.ListView1.Width = frmPesqEscolar.Frame1.Width - (frmPesqEscolar.Frame1.Width * 1.5 / 100)
    
    frmPesqEscolar.Height = frmMenu2.Height - 2700
    frmPesqEscolar.Frame1.Height = frmPesqEscolar.Height - 250
    frmPesqEscolar.ListView1.Height = frmPesqEscolar.Frame1.Height - (frmPesqEscolar.Frame1.Height * 15 / 90)
    
    ''MDIPrincipal
    'Frame1.Caption = "Escolaridade"
    'MDIPrincipal.StatusBar1.Panels(3) = Legenda
    'frmPesqEscolar.Top = MDIPrincipal.pctGer.Height + (MDIPrincipal.pctGer.Height * 50 / 50)
    'frmPesqEscolar.Left = MDIPrincipal.Left + 110
    'frmPesqEscolar.Width = MDIPrincipal.Width - (MDIPrincipal.Width * 1.5 / 100)
    'frmPesqEscolar.Frame1.Width = frmPesqEscolar.Width - (frmPesqEscolar.Width * 1.5 / 100)
    'frmPesqEscolar.ListView1.Width = frmPesqEscolar.Frame1.Width - (frmPesqEscolar.Frame1.Width * 1.5 / 100)
    
    'frmPesqEscolar.Height = MDIPrincipal.Height - (MDIPrincipal.Height * 18 / 100)
    'frmPesqEscolar.Frame1.Height = frmPesqEscolar.Height - (frmPesqEscolar.Height * 1.2 / 100)
    'frmPesqEscolar.ListView1.Height = frmPesqEscolar.Frame1.Height - (frmPesqEscolar.Frame1.Height * 15 / 90)
...
Private Sub listview_cabecalho()
    ...
    ListView1.ColumnHeaders.Add , , "Escolaridade", ListView1.Width / 3
...
Private Sub Compoe_Listview()
    ...
    Dim X As Integer
    If FiltroGeral = "Todos" Then sql = "select * from tbEscolaridade"
    If FiltroGeral = "Ativos" Then sql = "select * from tbEscolaridade where ativo = 'S'"
    If FiltroGeral = "Não ativos" Then sql = "select * from tbEscolaridade where ativo is null or ativo ='N'"
        ...
        For X = 1 To Y
            ...
            If Combo1.Text = "Código" Then
                ...
                If UCase(ListView1.ListItems.Item(X)) Like UCase(Me.Text1.Text & "*") Then
                    ...
                    Exit Sub
                End If
            ElseIf Combo1.Text = "Escolaridade" Then
...
Private Sub AbrirTabelas()
    SqlPesquisar = "Select * from tbEscolaridade order by codescolaridade"
...
On Error GoTo TrataErro
    ...
    Dim SqlExcEscolaridade As String
    Dim rsExcEscolaridade As New ADODB.Recordset
    cnBanco.BeginTrans
    If MsgBox("Confirma exclusão da Escolaridade selecionada?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
        SqlExcEscolaridade = "Delete from tbEscolaridade where codescolaridade= " & Val(varGlobal)
        rsExcEscolaridade.Open SqlExcEscolaridade, cnBanco
...
Private Sub AlteraListview()
    ...
    Exit Sub
Err:
    MsgBox "Nenhuma Escolaridade cadastrada ou selecionada", vbInformation, "SGCH"
    Exit Sub
End Sub
