...
Begin VB.Form frmCandidatos 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         Tab(1).Control(3)=   "Label32"
         Tab(1).Control(3).Enabled=   0   'False
         Tab(1).Control(4)=   "cmdCadastro(24)"
         Tab(1).Control(4).Enabled=   0   'False
         Tab(1).Control(5)=   "cmdCadastro(0)"
         Tab(1).Control(5).Enabled=   0   'False
         Tab(1).Control(6)=   "cmdCadastro(1)"
         Tab(1).Control(6).Enabled=   0   'False
         Tab(1).Control(7)=   "cmdCadastro(2)"
         Tab(1).Control(7).Enabled=   0   'False
         Tab(1).Control(8)=   "cmdCadastro(3)"
         Tab(1).Control(8).Enabled=   0   'False
         Tab(1).Control(9)=   "cmdCadastro(18)"
         Tab(1).Control(9).Enabled=   0   'False
         Tab(1).Control(10)=   "ListView1"
         Tab(1).Control(10).Enabled=   0   'False
         Tab(1).Control(11)=   "cboCadMatriz(3)"
         Tab(1).Control(11).Enabled=   0   'False
         Tab(1).Control(12)=   "cboCadMatriz(2)"
         Tab(1).Control(12).Enabled=   0   'False
         Tab(1).Control(13)=   "txtCadMatriz(8)"
         Tab(1).Control(13).Enabled=   0   'False
         Tab(1).Control(14)=   "txtCadMatriz(9)"
         Tab(1).Control(14).Enabled=   0   'False
         Tab(1).Control(15)=   "txtCadMatriz(1)"
         ...
         Tab(4).Control(2)=   "cmdCadastro(26)"
         Tab(4).Control(2).Enabled=   0   'False
         Tab(4).Control(3)=   "cmdCadastro(17)"
         Tab(4).Control(3).Enabled=   0   'False
         Tab(4).Control(4)=   "cmdCadastro(16)"
         Tab(4).Control(4).Enabled=   0   'False
         Tab(4).Control(5)=   "cmdCadastro(10)"
         Tab(4).Control(5).Enabled=   0   'False
         Tab(4).Control(6)=   "cmdCadastro(9)"
         Tab(4).Control(6).Enabled=   0   'False
         Tab(4).Control(7)=   "cmdCadastro(6)"
         Tab(4).Control(7).Enabled=   0   'False
         Tab(4).Control(8)=   "ListView4"
         Tab(4).Control(8).Enabled=   0   'False
         Tab(4).Control(9)=   "txtCadMatriz(13)"
         Tab(4).Control(9).Enabled=   0   'False
         Tab(4).Control(10)=   "txtCadMatriz(12)"
         Tab(4).Control(10).Enabled=   0   'False
         Tab(4).ControlCount=   11
         TabCaption(5)   =   "Cargos Pret."
         TabPicture(5)   =   "frmCandidatos.frx":26799
         Tab(5).ControlEnabled=   0   'False
         Tab(5).Control(0)=   "Label15"
         ...
         Tab(5).Control(4)=   "cmdCadastro(22)"
         Tab(5).Control(4).Enabled=   0   'False
         Tab(5).Control(5)=   "cmdCadastro(21)"
         Tab(5).Control(5).Enabled=   0   'False
         Tab(5).Control(6)=   "cmdCadastro(20)"
         Tab(5).Control(6).Enabled=   0   'False
         Tab(5).Control(7)=   "cmdCadastro(19)"
         Tab(5).Control(7).Enabled=   0   'False
         Tab(5).Control(8)=   "cmdCadastro(11)"
         Tab(5).Control(8).Enabled=   0   'False
         Tab(5).Control(9)=   "ListView5"
         Tab(5).Control(9).Enabled=   0   'False
         Tab(5).Control(10)=   "txtCadMatriz(6)"
         Tab(5).Control(10).Enabled=   0   'False
         Tab(5).Control(11)=   "txtCadMatriz(5)"
         Tab(5).Control(11).Enabled=   0   'False
         Tab(5).Control(12)=   "txtCadMatriz(0)"
         Tab(5).Control(12).Enabled=   0   'False
         Tab(5).Control(13)=   "txtCadMatriz(20)"
