...
Begin VB.Form frmPesqDepartamentos 
   AutoRedraw      =   -1  'True
   BorderStyle     =   0  'None
   ...
   ClientTop       =   1365
   ClientWidth     =   14895
   Icon            =   "frmpesqDepartamentos.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   9180
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmpesqDepartamentos.frx":0CCA
               Key             =   "OK"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmpesqDepartamentos.frx":16DC
               Key             =   "EXC"
            EndProperty
         EndProperty
      End
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox Combo1 
            Height          =   315
            ItemData        =   "frmpesqDepartamentos.frx":20EE
            Left            =   2040
            List            =   "frmpesqDepartamentos.frx":20FB
            TabIndex        =   2
            Text            =   "Departamento"
            Top             =   240
            Width           =   1695
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqDepartamentos.frx":2122
         PICN            =   "frmpesqDepartamentos.frx":213E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqDepartamentos.frx":2E18
         PICN            =   "frmpesqDepartamentos.frx":2E34
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqDepartamentos.frx":3B0E
         PICN            =   "frmpesqDepartamentos.frx":3B2A
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqDepartamentos.frx":4804
         PICN            =   "frmpesqDepartamentos.frx":4820
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqDepartamentos.frx":54FA
         PICN            =   "frmpesqDepartamentos.frx":5516
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqDepartamentos.frx":61F0
         PICN            =   "frmpesqDepartamentos.frx":620C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqDepartamentos.frx":6EE6
         PICN            =   "frmpesqDepartamentos.frx":6F02
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqDepartamentos.frx":7BDC
         PICN            =   "frmpesqDepartamentos.frx":7BF8
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdconsulta 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmpesqDepartamentos.frx":88D2
         PICN            =   "frmpesqDepartamentos.frx":88EE
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmPesqDepartamentos"
...
On Error GoTo Err
    ...
    Case 3
        ...
        End If
    Case 4
        DesabBotoesN1 frmPesqDepartamentos
        Pesquisa = "novo"
        frmDepartamentos.Show 1
        HabBotoesN1 frmPesqDepartamentos
    Case 5
        DesabBotoesN1 frmPesqDepartamentos
        Pesquisa = "editar"
        AlteraListview
        If varGlobal <> "" Then frmDepartamentos.Show 1
        HabBotoesN1 frmPesqDepartamentos
    Case 6
        On Error GoTo Err
        Y = ListView1.ListItems.Count
...
Private Sub Form_Load()
    'frmMenu2
    Frame1.Caption = "Departamentos"
    frmMenu2.StatusBar1.Panels(3) = Legenda
    frmPesqDepartamentos.Top = frmMenu2.ACPRibbon1.Height + 290
    frmPesqDepartamentos.Left = frmMenu2.Left + 130
    frmPesqDepartamentos.Width = frmMenu2.Width - 300
    
    frmPesqDepartamentos.Frame1.Width = frmPesqDepartamentos.Width - (frmPesqDepartamentos.Width * 1.5 / 100)
    frmPesqDepartamentos.ListView1.Width = frmPesqDepartamentos.Frame1.Width - (frmPesqDepartamentos.Frame1.Width * 1.5 / 100)
    
    frmPesqDepartamentos.Height = frmMenu2.Height - 2700
    frmPesqDepartamentos.Frame1.Height = frmPesqDepartamentos.Height - 250
    frmPesqDepartamentos.ListView1.Height = frmPesqDepartamentos.Frame1.Height - (frmPesqDepartamentos.Frame1.Height * 15 / 90)
    
    ''MDIPrincipal
    'Frame1.Caption = "Departamentos"
    'MDIPrincipal.StatusBar1.Panels(3) = Legenda
    'frmPesqDepartamentos.Top = MDIPrincipal.pctGer.Height + (MDIPrincipal.pctGer.Height * 50 / 50)
    'frmPesqDepartamentos.Left = MDIPrincipal.Left + 110
    'frmPesqDepartamentos.Width = MDIPrincipal.Width - (MDIPrincipal.Width * 1.5 / 100)
    'frmPesqDepartamentos.Frame1.Width = frmPesqDepartamentos.Width - (frmPesqDepartamentos.Width * 1.5 / 100)
    'frmPesqDepartamentos.ListView1.Width = frmPesqDepartamentos.Frame1.Width - (frmPesqDepartamentos.Frame1.Width * 1.5 / 100)
    
    'frmPesqDepartamentos.Height = MDIPrincipal.Height - (MDIPrincipal.Height * 18 / 100)
    'frmPesqDepartamentos.Frame1.Height = frmPesqDepartamentos.Height - (frmPesqDepartamentos.Height * 1.2 / 100)
    'frmPesqDepartamentos.ListView1.Height = frmPesqDepartamentos.Frame1.Height - (frmPesqDepartamentos.Frame1.Height * 15 / 90)
    
    AbrirTabelas
    listview_cabecalho 'Chama a Sub que monta o cabeçalho das colunas do Listview
    Combo1.Text = "Departamento" 'Inicializa o combo com a palavra "Codigo"
...
Private Sub Compoe_Listview()
    ...
    Dim X As Integer
    If FiltroGeral = "Todos" Then sql = "select * from tbDepartamentos"
    If FiltroGeral = "Ativos" Then sql = "select * from tbDepartamentos where ativo = 'S'"
    If FiltroGeral = "Não ativos" Then sql = "select * from tbDepartamentos where ativo is null or ativo ='N'"
        ...
        For X = 1 To Y
            ...
            If Combo1.Text = "Código" Then
                ...
                If UCase(ListView1.ListItems.Item(X)) Like UCase(Me.Text1.Text & "*") Then
                    ...
                    Exit Sub
                End If
            ElseIf Combo1.Text = "Departamento" Then
...
Private Sub AbrirTabelas()
    SqlPesquisar = "Select * from tbDepartamentos order by codDepartamento"
...
On Error GoTo TrataErro
    ...
    Dim SqlExcDepartamento As String
    Dim rsExcDepartamento As New ADODB.Recordset
    cnBanco.BeginTrans
    If MsgBox("Confirma exclusão do Departamento selecionado?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
        SqlExcDepartamento = "Delete from tbDepartamentos where codDepartamento= " & Val(varGlobal)
        rsExcDepartamento.Open SqlExcDepartamento, cnBanco
...
Private Sub AlteraListview()
    ...
    Exit Sub
Err:
    MsgBox "Nenhum Departamento cadastrado ou selecionado", vbInformation, "SGCH"
    Exit Sub
End Sub
