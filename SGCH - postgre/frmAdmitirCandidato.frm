...
Begin VB.Form frmAdmitirCandidato 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "frmAdmitirCandidato.frx":0CCA
         Left            =   120
         List            =   "frmAdmitirCandidato.frx":0CD1
         TabIndex        =   27
         Top             =   240
         Width           =   4935
      End
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin AlphaImageControl.aicAlphaImage aicAlphaImage1 
            ...
            _ExtentX        =   2990
            _ExtentY        =   3836
            Image           =   "frmAdmitirCandidato.frx":0CF0
         End
      End
   End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin SGCH.chameleonButton cmdNovoCol 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmAdmitirCandidato.frx":0D08
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin SGCH.chameleonButton cmdNovoCol 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmAdmitirCandidato.frx":0D24
      PICN            =   "frmAdmitirCandidato.frx":0D40
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin SGCH.chameleonButton cmdNovoCol 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmAdmitirCandidato.frx":1A1A
      PICN            =   "frmAdmitirCandidato.frx":1A36
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
Private Sub cmdNovoCol_Click(Index As Integer)
    ...
    Case 0
        ...
        carregaADP txtNovoColaborador(0)
        Unload Me
...
Private Sub CarregaReq(campo As Integer)
    ...
    If rsReq.RecordCount <= 0 Then
        ...
        End If
        If campo = 2 Then
            MsgBox "Cargo não encontrado para essa requisição", vbInformation, "SGCH"
...
'On Error GoTo TrataErro
    ...
    If Label8.Visible = True Then
        MsgBox "A gravação não pode ser efetuada, devido a incompatibilidade das matrizes"
        Exit Sub
    End If
    ...
    'SALVAR CARGOS REQUISITADOS - LISTVIEW1
...
' **********************************
    cnBanco.CommitTrans
    MsgBox "Admissão realizada com sucesso", vbInformation, "SGCH"
    AtualizaListview
    Unload Me
    Exit Sub
TrataErro:
...
Private Function ValidaCampo()
    ...
    If Label9 = "DEMITIDO" Then
        MsgBox "Não deve-se ATIVAR colaboradores com status de DEMISSÃO", vbCritical, "Atenção"
        Exit Function
    End If
    If txtNovoCol(1).Text = "" Then
        MsgBox "Favor informar o campo " & Me.txtNovoCol(1).Tag, vbInformation, "Atenção"
        Me.txtNovoCol(1).SetFocus
        Exit Function
    End If
    If Combo1.Enabled = True Then
        If Combo1.Text = "" Then
            MsgBox "Favor informar o motivo da admissão no campo de observação"
            Exit Function
        End If
    End If
    ValidaCampo = True
...
'    End If
    ...
    While Not rsSelecionaTreiInt.EOF
        ...
        SqlDeletaDuplicado = "Select id from tbPendentesCur where codcoligada = '" & vCodcoligada & "' and cpf = '" & txtNovoColaborador(0) & "' and status = 'Pendente' and codtreinamento ='" & rsSelecionaTreiInt.Fields(0) & "'"
...
'    End If
    ...
    While Not rsSelecionaTreiObr.EOF
        ...
        SqlDeletaDuplicado = "Select id from tbPendentesCur where codcoligada = '" & vCodcoligada & "' and cpf = '" & txtNovoColaborador(0).Text & "' and status = 'Pendente' and codtreinamento ='" & rsSelecionaTreiObr.Fields(0) & "'"
        rsDeletaDuplicado.Open SqlDeletaDuplicado, cnBanco, adOpenKeyset, adLockReadOnly
        If rsDeletaDuplicado.RecordCount > 1 Then
            Dim vDeletaTrei As Integer
            vDeletaTrei = rsDeletaDuplicado.Fields(0)
