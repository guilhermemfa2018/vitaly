...
Begin VB.Form frmADPModelo 
   ...
   Begin SGCH.chameleonButton cmdNovoCol 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmADPModelo.frx":0CCA
      PICN            =   "frmADPModelo.frx":0CE6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin SGCH.chameleonButton cmdNovoCol 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmADPModelo.frx":19C0
      PICN            =   "frmADPModelo.frx":19DC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.ComboBox txtLvw 
      Appearance      =   0  'Flat
      Height          =   315
      ItemData        =   "frmADPModelo.frx":26B6
      Left            =   6960
      List            =   "frmADPModelo.frx":26C3
      TabIndex        =   16
      Text            =   "Institucional"
      Top             =   6960
      Visible         =   0   'False
   ...
   Begin VB.Frame Frame2 
      ...
      Begin SGCH.chameleonButton cmdModelo 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmADPModelo.frx":26ED
         PICN            =   "frmADPModelo.frx":2709
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdModelo 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmADPModelo.frx":33E3
         PICN            =   "frmADPModelo.frx":33FF
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdModelo 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmADPModelo.frx":40D9
         PICN            =   "frmADPModelo.frx":40F5
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdModelo 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmADPModelo.frx":4DCF
         PICN            =   "frmADPModelo.frx":4DEB
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin SGCH.chameleonButton cmdNovoCol 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmADPModelo.frx":5AC5
      PICN            =   "frmADPModelo.frx":5AE1
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
Private Sub CompoePontosAE()
    ...
    sqlHab = "Select * from tbModeloADPItens where codcoligada = '" & vCodcoligada & "' and codmodelo = '" & Val(txtModelo(2)) & "'"
...
Private Sub carregarModelo()
    ...
    For X = 1 To Y
        If ListView1.ListItems.Item(X).Checked = True Then
            ...
            If L > 0 Then
                Set ItemLst = chamaForm.ListView1.ListItems.Add(, , ListView1.ListItems.Item(X))
        ...
        End If
    Next
    MsgBox "Os dados foram inseridos na ADP com sucesso", vbInformation, "SGCH"
End Sub
...
On Error GoTo TrataErro
    ...
    cnBanco.BeginTrans
    '>>>>>> GRAVAR AVALIACAO <<<<<<<<<
    sqlDeletar = "Delete from tbModeloADP"
    ...
    sqlDeletar = "Delete from tbModeloADPItens where codcoligada = '" & vCodcoligada & "' and codmodelo = '" & Val(txtModelo(2)) & "'"
    rsDeletar.Open sqlDeletar, cnBanco
    
    SqlSalvar = "Select * from tbModeloADPItens where codcoligada = '" & vCodcoligada & "' and codmodelo = '" & Val(txtModelo(2)) & "'"
    rsSalvar.Open SqlSalvar, cnBanco, adOpenKeyset, adLockOptimistic
