...
Begin VB.Form frmMatrizCapacitacao 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         Tab(0).Control(1)=   "cboCadMatriz(3)"
         Tab(0).Control(2)=   "cboCadMatriz(2)"
         Tab(0).Control(3)=   "txtCadMatriz(8)"
         Tab(0).Control(4)=   "txtCadMatriz(9)"
         Tab(0).Control(5)=   "cmdCadastro(18)"
         Tab(0).Control(6)=   "cmdCadastro(3)"
         Tab(0).Control(7)=   "cmdCadastro(2)"
         Tab(0).Control(8)=   "cmdCadastro(1)"
         ...
         Tab(2).Control(2)=   "Label36"
         Tab(2).Control(3)=   "ListView3"
         Tab(2).Control(4)=   "cmdCadastro(8)"
         Tab(2).Control(5)=   "cmdCadastro(7)"
         Tab(2).Control(6)=   "cmdCadastro(5)"
         Tab(2).Control(7)=   "cmdCadastro(4)"
         ...
         Tab(3).Control(4)=   "cmdCadastro(17)"
         Tab(3).Control(5)=   "cmdCadastro(16)"
         Tab(3).Control(6)=   "cmdCadastro(13)"
         Tab(3).Control(7)=   "cmdCadastro(12)"
         Tab(3).Control(8)=   "cmdCadastro(6)"
         Tab(3).Control(9)=   "ListView4"
         Tab(3).Control(10)=   "txtCadMatriz(12)"
         Tab(3).Control(11)=   "txtCadMatriz(13)"
         Tab(3).Control(12)=   "txtCadMatriz(14)"
         ...
         Tab(4).Control(3)=   "cmdCadastro(22)"
         Tab(4).Control(3).Enabled=   0   'False
         Tab(4).Control(4)=   "cmdCadastro(21)"
         Tab(4).Control(4).Enabled=   0   'False
         Tab(4).Control(5)=   "cmdCadastro(20)"
         Tab(4).Control(5).Enabled=   0   'False
         Tab(4).Control(6)=   "cmdCadastro(19)"
         Tab(4).Control(6).Enabled=   0   'False
         Tab(4).Control(7)=   "ListView5"
         Tab(4).Control(7).Enabled=   0   'False
         Tab(4).Control(8)=   "DTPicker1"
         Tab(4).Control(8).Enabled=   0   'False
         Tab(4).Control(9)=   "txtCadMatriz(15)"
         Tab(4).Control(9).Enabled=   0   'False
         Tab(4).Control(10)=   "txtCadMatriz(16)"
         Tab(4).Control(10).Enabled=   0   'False
         Tab(4).Control(11)=   "Frame7"
         ...
         Begin VB.ComboBox cboCadMatriz 
            Height          =   315
            Index           =   3
            ItemData        =   "frmMatrizCapacitacao.frx":0D56
            Left            =   -66840
            List            =   "frmMatrizCapacitacao.frx":0D60
            TabIndex        =   16
         ...
         Begin VB.ComboBox cboCadMatriz 
            Height          =   315
            Index           =   2
            ItemData        =   "frmMatrizCapacitacao.frx":0D71
            Left            =   -67560
            List            =   "frmMatrizCapacitacao.frx":0D99
            TabIndex        =   15
            Tag             =   "Periodicidade do curso/treinamento"
            Text            =   "01"
            ToolTipText     =   "Periodicidade do curso/treinamento"
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":0DCD
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":0DE9
            PICN            =   "frmMatrizCapacitacao.frx":0E05
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":1ADF
            PICN            =   "frmMatrizCapacitacao.frx":1AFB
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":27D5
            PICN            =   "frmMatrizCapacitacao.frx":27F1
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":34CB
            PICN            =   "frmMatrizCapacitacao.frx":34E7
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":41C1
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":41DD
            PICN            =   "frmMatrizCapacitacao.frx":41F9
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            Left            =   -74280
            TabIndex        =   28
            Tag             =   "Novo curso/treinamento"
            ToolTipText     =   "Novo curso/treinamento"
            Top             =   1200
            Width           =   615
            _ExtentX        =   1085
            _ExtentY        =   1085
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":4ED3
            PICN            =   "frmMatrizCapacitacao.frx":4EEF
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":5BC9
            PICN            =   "frmMatrizCapacitacao.frx":5BE5
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":68BF
            PICN            =   "frmMatrizCapacitacao.frx":68DB
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":75B5
            PICN            =   "frmMatrizCapacitacao.frx":75D1
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            Left            =   -74280
            TabIndex        =   55
            Tag             =   "Novo Formação Escolar"
            ToolTipText     =   "Novo Formação Escolar"
            Top             =   1200
            Width           =   615
            _ExtentX        =   1085
            _ExtentY        =   1085
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":82AB
            PICN            =   "frmMatrizCapacitacao.frx":82C7
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":8FA1
            PICN            =   "frmMatrizCapacitacao.frx":8FBD
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":9C97
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":9CB3
            PICN            =   "frmMatrizCapacitacao.frx":9CCF
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":A9A9
            PICN            =   "frmMatrizCapacitacao.frx":A9C5
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":B69F
            PICN            =   "frmMatrizCapacitacao.frx":B6BB
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin SGCH.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmMatrizCapacitacao.frx":C395
            PICN            =   "frmMatrizCapacitacao.frx":C3B1
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin VB.Label Label16 
            Caption         =   "A pontuação deverá ser definida em percentual entre 0-100"
            Height          =   255
            Left            =   -72240
            TabIndex        =   64
            Top             =   1380
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox cboCadMatriz 
            Height          =   315
            Index           =   4
            ItemData        =   "frmMatrizCapacitacao.frx":D08B
            Left            =   1080
            List            =   "frmMatrizCapacitacao.frx":D095
            TabIndex        =   69
            Tag             =   "Periodicidade do curso/treinamento"
            Text            =   "Meses"
            ToolTipText     =   "Periodicidade do curso/treinamento"
         ...
         Begin VB.ComboBox cboCadMatriz 
            Height          =   315
            Index           =   1
            ItemData        =   "frmMatrizCapacitacao.frx":D0A6
            Left            =   240
            List            =   "frmMatrizCapacitacao.frx":D0CE
            TabIndex        =   68
            Tag             =   "Periodicidade do curso/treinamento"
            Text            =   "001"
            ToolTipText     =   "Periodicidade do curso/treinamento"
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.ComboBox cboCadMatriz 
            Height          =   315
            Index           =   0
            ItemData        =   "frmMatrizCapacitacao.frx":D10E
            Left            =   120
            List            =   "frmMatrizCapacitacao.frx":D142
            TabIndex        =   10
            Tag             =   "Nível do cargo"
            Text            =   "A"
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmMatrizCapacitacao.frx":D176
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmMatrizCapacitacao.frx":D192
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmMatrizCapacitacao.frx":D1AE
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin VB.TextBox txtCadMatriz 
         ...
         Left            =   120
         TabIndex        =   1
         Tag             =   "Códigp do departamento"
         ToolTipText     =   "Códigp do departamento"
         Top             =   480
         Width           =   1095
      End
   ...
   Begin SGCH.chameleonButton cmdCadastro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMatrizCapacitacao.frx":D1CA
      PICN            =   "frmMatrizCapacitacao.frx":D1E6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin SGCH.chameleonButton cmdCadastro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMatrizCapacitacao.frx":DEC0
      PICN            =   "frmMatrizCapacitacao.frx":DEDC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
Private Sub cmdCadastro_Click(Index As Integer)
    ...
    Case 2
        AlteraExperiencia
    Case 3
        If MsgBox("Deseja EXCLUIR essa experiência do cargo?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
    ...
    Case 5
        If MsgBox("Deseja EXCLUIR essa curso/treinamento do cargo?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
            ExcluirItemLV ListView3
            LimpaControlesTreinamento
        End If
    Case 6
        If MsgBox("Deseja EXCLUIR essa formação escolar do cargo?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
    ...
    Case 13
        LimpaControlesEscolaridade
    Case 14
        If MsgBox("Deseja salvar os dados da matriz de capacitação?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
            GravarDados
            '--- ROTINA EM TESTE ---
        ...
        End If
    Case 15
        If MsgBox("Deseja sair da tela de cadastro da matriz de capacitação?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
            Pesquisa = "0"
            Unload Me
        End If
    Case 16
    ...
    Case 18
        ...
        CarregaCargo 8
    Case 19
        If MsgBox("Deseja EXCLUIR essa revisão do treinamento?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
...
Private Function ValidaCampo()
    ...
    If txtCadMatriz(1).Text = "" Then
        MsgBox "Favor informar o campo " & Me.txtCadMatriz(1).Tag, vbInformation, "Atenção"
    ...
    If txtCadMatriz(41).Text = "" Then
        MsgBox "Favor informar o campo " & Me.txtCadMatriz(41).Tag, vbInformation, "Atenção"
...
Private Sub CarregaSetor()
    ...
    If rsSetores.EOF Then
        ...
        If Val(Pesquisa) <> 0 Then
            MsgBox "Setor não cadastrado para o departamento", vbInformation, "SGCH"
            txtCadMatriz(41) = ""
        End If
    Else
