...
Begin VB.Form frmDepartamentos 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmDepartamentos.frx":1FCD
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmDepartamentos.frx":1FE9
         PICN            =   "frmDepartamentos.frx":2005
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmDepartamentos.frx":2CDF
         PICN            =   "frmDepartamentos.frx":2CFB
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmDepartamentos.frx":39D5
         PICN            =   "frmDepartamentos.frx":39F1
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin SGCH.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmDepartamentos.frx":46CB
         PICN            =   "frmDepartamentos.frx":46E7
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
...
Private Sub cmdCadastro_Click(Index As Integer)
    ...
    Case 4
        ...
        CarregaColaborador
    Case 5
        If MsgBox("Deseja salvar os dados do departamento?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
            GravarDados
        ...
        End If
    Case 6
        If MsgBox("Deseja sair da tela de cadastro de Departamentos?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
            Pesquisa = 0
            Unload Me
        End If
    End Select
...
'On Error GoTo TrataErro
    ...
    MsgBox "Os dados do Departamento foram salvos com sucesso", vbInformation, "SGCH"
    AtualizaListview
    Exit Sub
TrataErro:
...
Private Function ValidaCampo()
    ...
    If txtCadDepartamento(0).Text = "" Then
        MsgBox "Favor informar o campo " & Me.txtCadDepartamento(0).Tag, vbInformation, "Atenção"
        Me.txtCadDepartamento(0).SetFocus
        Exit Function
    End If
    If txtCadDepartamento(1).Text = "" Then
        MsgBox "Favor informar o campo " & Me.txtCadDepartamento(1).Tag, vbInformation, "Atenção"
...
Private Sub ResultPesq()
    ...
    If rsDepartamentos.RecordCount > 0 Then
        ...
        FecharHistorico
    Else
        MsgBox "Departamento não encontrado"
    End If
    rsDepartamentos.Close
    Set rsDepartamentos = Nothing
End Sub
...
Private Function ValidaResponsavel()
    ...
    If txtCadDepartamento(3).Text = "" Then
        MsgBox "Favor informar o campo " & Me.txtCadDepartamento(3).Tag, vbInformation, "Atenção"
