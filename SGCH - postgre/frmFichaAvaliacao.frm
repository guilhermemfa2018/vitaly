...
Begin VB.Form frmFichaAvaliacao 
   ...
   Begin SGCH.chameleonButton cmdNovoCol 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmFichaAvaliacao.frx":0D1E
      PICN            =   "frmFichaAvaliacao.frx":0D3A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin SGCH.chameleonButton cmdNovoCol 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmFichaAvaliacao.frx":1A14
      PICN            =   "frmFichaAvaliacao.frx":1A30
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
Private Sub cmdNovoCol_Click(Index As Integer)
    ...
    Case 0
        ...
        Unload Me
    Case 1
        If MsgBox("Deseja sair da ficha de avaliação?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
            Pesquisa = 0
            Unload Me
...
If SSTab1.Tab = 0 Then
    ...
    If ListView(0).ListItems(m_RowIndex).SubItems(m_ColIndex - 2) = "-" And ListView(0).ListItems(m_RowIndex).SubItems(m_ColIndex - 2) < ListView(0).ListItems(m_RowIndex).SubItems(m_ColIndex - 1) Then
    ...
    If IsNumeric(txtLvw.Text) And Val(txtLvw.Text) > Val(ListView(0).ListItems(m_RowIndex).SubItems(m_ColIndex - 2)) Then
        ListView(0).ListItems(m_RowIndex).SubItems(m_ColIndex - 1) = "0"
        MsgBox "Valor acima do peso", vbCritical, "SGCH"
    End If
...
ElseIf SSTab1.Tab = 1 Then
    ...
    If ListView(1).ListItems(m_RowIndex).SubItems(m_ColIndex - 2) = "-" And ListView(1).ListItems(m_RowIndex).SubItems(m_ColIndex - 2) < ListView(1).ListItems(m_RowIndex).SubItems(m_ColIndex - 1) Then
