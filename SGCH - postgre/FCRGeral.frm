...
Private Sub Form_Load()
    ...
    ElseIf apontaLV = 0 Then
        ...
        SqlGeral = "select a.id AS campo1,substring(a.nomecolaborador,1,20) + ' - ' +CONVERT (VARCHAR, b.data, 103) as campo2,d.nomecargo as campo3,cast(cast(a.mediageral as decimal(7,2)) as varchar) + '% - ' + Max(f.nomeescolaridade)  as campo4," & _
                    "'ID' as campo5,'ADMISSÃO' as campo6,'CARGO' as campo7,'PONTUAÇÃO/ESCOLARIDADE' as campo8,'ESCOLARIDADE' as campo9,g.logo as campo10 from tbcolaboradores as a inner join tbcolaboradoreshist as b on a.codcoligada = 1 and " & _
                    ...
                    "left join tbescolaridade as f on e.codescolaridade = f.codescolaridade inner join tbDadosEmpresa as g on g.codcoligada = 1 group by a.id,a.nomecolaborador,b.data,d.nomecargo,a.mediageral,g.logo order by a.id"
