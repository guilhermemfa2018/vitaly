...
'Esta usando o usercontrol do Elucimar que veio junto na coleção IV "Caption"
'Para ficar com os icones com fundo transparente.
'Pesquise no vbmania por exemplo
...
Private Sub DrawProcent(TextToPrint As String, DspX As Single, DspY As Single)
    ...
    End If
    If UserControl.Enabled = False Then
        UserControl.ForeColor = m_CaptionINColor    'vbBlack '&HE0E0E0
    End If
