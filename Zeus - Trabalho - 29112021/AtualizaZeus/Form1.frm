...
On Error GoTo ErroCopiaARQ
    ...
    Dim strOrigem2 As String
    Dim strDestino As String
    Dim strDestino2 As String
    
    strOrigem = App.Path & "\ZEUS.exe"
    strOrigem2 = App.Path & "\*.xlsx"
    ...
    fso.CopyFile strOrigem2, strDestino2, True
    
    ' Abre Programa ZEUS
    Timer1.Enabled = False
    Timer2.Enabled = True
    'MsgBox "Executou o AtualizaZeus"
    Exit Sub
ErroCopiaARQ:
    ' Mostra ERRO
    Dim vCaminho As String
    vCaminho = ""
    vCaminho = vCaminho & Err.Description & " - " & Err.Number & vbCrLf
    vCaminho = vCaminho & "Orgem1: " & strOrigem & ", Destino1: " & strDestino & vbCrLf
    vCaminho = vCaminho & "Origem2: " & strOrigem2 & ", Destino2: " & strDestino2
    MsgBox vCaminho, vbCritical
    End
