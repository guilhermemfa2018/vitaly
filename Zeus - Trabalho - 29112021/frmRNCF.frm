...
Begin VB.Form frmRNCF 
   ...
   Begin VB.Frame Frame14 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel26 
         Height          =   255
         Left            =   6120
         OleObjectBlob   =   "frmRNCF.frx":1994
         TabIndex        =   86
         Top             =   240
         Width           =   375
      End
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel25 
         Height          =   255
         Left            =   5160
         OleObjectBlob   =   "frmRNCF.frx":19F2
         TabIndex        =   84
         Top             =   240
         Width           =   615
      End
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel24 
         Height          =   255
         Left            =   3960
         OleObjectBlob   =   "frmRNCF.frx":1A50
         TabIndex        =   82
         Top             =   240
         Width           =   735
      End
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel23 
         Height          =   255
         Left            =   2760
         OleObjectBlob   =   "frmRNCF.frx":1AB2
         TabIndex        =   79
         Top             =   240
         Width           =   615
      End
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel22 
         Height          =   255
         Left            =   1560
         OleObjectBlob   =   "frmRNCF.frx":1B12
         TabIndex        =   77
         Top             =   240
         Width           =   735
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel21 
         Height          =   255
         Left            =   480
         OleObjectBlob   =   "frmRNCF.frx":1B74
         TabIndex        =   76
         Top             =   240
         Width           =   495
      End
...
Private Sub Form_Load()
    ...
    If vListViewPrincipal.SelectedItem.ListSubItems.Item(7).ReportIcon = "CONCLUIDO1" Or vListViewPrincipal.SelectedItem.ListSubItems.Item(7).ReportIcon = "PRETO" Or vListViewPrincipal.SelectedItem.ListSubItems.Item(7).ReportIcon = "FABRICANDO" Then bloqueiaEdicao
    carregarIconBotao
...
On Error GoTo Err
    ...
    If vListViewPrincipal.SelectedItem.ListSubItems.Item(7).ReportIcon <> "FABRICANDO" Or vListViewPrincipal.SelectedItem.ListSubItems.Item(7).ReportIcon <> "PRETO" Then
...
Private Sub AtualizaListview()
    ...
    If vStatus = 7 Then
        ...
        vListViewPrincipal.SelectedItem.ListSubItems.Item(7).ReportIcon = "AVALIANDO1"
    ElseIf vStatus = 8 Then
        vListViewPrincipal.SelectedItem.ListSubItems.Item(7) = ""
        vListViewPrincipal.SelectedItem.ListSubItems.Item(7).ReportIcon = "CONCLUIDO1"
    ElseIf vStatus = 20 Then
        If vListViewPrincipal.SelectedItem.ListSubItems.Item(7).ReportIcon <> "FABRICANDO" Or vListViewPrincipal.SelectedItem.ListSubItems.Item(7).ReportIcon <> "PRETO" Then
            vListViewPrincipal.SelectedItem.ListSubItems.Item(7) = ""
            vListViewPrincipal.SelectedItem.ListSubItems.Item(7).ReportIcon = "FECHADO"
        End If
    End If
    If Check1.Value = 1 Then
        vListViewPrincipal.SelectedItem.ListSubItems.Item(10) = ""
        vListViewPrincipal.SelectedItem.ListSubItems.Item(10).ReportIcon = "OK"
    ElseIf Check1.Value = 0 Then
        vListViewPrincipal.SelectedItem.ListSubItems.Item(10) = ""
        vListViewPrincipal.SelectedItem.ListSubItems.Item(10).ReportIcon = "EXC"
    End If
    
    If txtRNC(7).Text <> "" Then
        vListViewPrincipal.SelectedItem.ListSubItems.Item(8) = txtRNC(7).Text
        'vListViewPrincipal.SelectedItem.ListSubItems.Item(8).ReportIcon = "EXC"
    End If
    Exit Sub
Err:
