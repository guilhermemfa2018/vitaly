...
On Error GoTo Err
    ...
    SkinLabel4.Caption = vListViewPrincipal.SelectedItem.ListSubItems.Item(11)
...
On Error GoTo Err
    ...
    For X = 1 To Y
        ...
        End If
    Next
    vListViewPrincipal.SelectedItem.ListSubItems.Item(12) = ""
    If Option1.Value = True Then 'ANDAMENTO
        vListViewPrincipal.SelectedItem.ListSubItems.Item(12).ReportIcon = "ANDAMENTO"
    ElseIf Option2.Value = True Then 'CONCLUIDA
        vListViewPrincipal.SelectedItem.ListSubItems.Item(12).ReportIcon = "CONCLUIDA"
    ElseIf Option3.Value = True Then 'PARALIZADA
        vListViewPrincipal.SelectedItem.ListSubItems.Item(12).ReportIcon = "PARALIZADA"
    ElseIf Option4.Value = True Then 'INCONSISTÊNCIA
        vListViewPrincipal.SelectedItem.ListSubItems.Item(12).ReportIcon = "DUVIDA"
    End If
    Exit Sub
Err:
    If Err.Number = -2147467259 Then
