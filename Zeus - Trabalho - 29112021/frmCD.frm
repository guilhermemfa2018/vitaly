...
Private Sub AtualizaListview()
    ...
    Next
    If Status = "novo" Then
        Set ItemLst = vListViewPrincipal.ListItems.Add(, , Format(txtContDes(0), "000000")) 'Identificador
    ...
    Else
        vListViewPrincipal.SelectedItem.ListSubItems.Item(1) = txtContDes(1).Text 'FCE
        vListViewPrincipal.SelectedItem.ListSubItems.Item(2) = txtContDes(2).Text 'Desenho
        vListViewPrincipal.SelectedItem.ListSubItems.Item(3) = txtContDes(3).Text 'Revisão
        vListViewPrincipal.SelectedItem.ListSubItems.Item(4) = txtContDes(4).Text 'Quantidade
        vListViewPrincipal.SelectedItem.ListSubItems.Item(5) = txtContDes(5).Text 'Peso Unit
        vListViewPrincipal.SelectedItem.ListSubItems.Item(6) = txtContDes(6).Text 'Peso Total
        If Not IsNull(DTPicker1.Value) Then
            vListViewPrincipal.SelectedItem.ListSubItems.Item(7) = DTPicker1.Value 'Recebido
        Else
            vListViewPrincipal.SelectedItem.ListSubItems.Item(7) = "-" 'Recebido
        End If
        vListViewPrincipal.SelectedItem.ListSubItems.Item(8) = txtContDes(7).Text & " " & cboContDes(1) 'Previsão detalhamento
        vListViewPrincipal.SelectedItem.ListSubItems.Item(9) = txtContDes(8).Text 'Usuário
        
        If Not IsNull(DTPicker2.Value) Then
            vListViewPrincipal.SelectedItem.ListSubItems.Item(10) = DTPicker2.Value 'Data inicio
        Else
            vListViewPrincipal.SelectedItem.ListSubItems.Item(10) = "-" 'Data inicio
        End If
        If Not IsNull(DTPicker2.Value) Then
            vListViewPrincipal.SelectedItem.ListSubItems.Item(11) = DTPicker3.Value 'Data fim
        Else
            vListViewPrincipal.SelectedItem.ListSubItems.Item(11) = "-" 'Data fim
        End If
        
        If txtContDes(9).Text <> "" Then vListViewPrincipal.SelectedItem.ListSubItems.Item(12) = txtContDes(9).Text  'Croqui
        If cboContDes(0).Text = "Aguardando" Then
            vListViewPrincipal.SelectedItem.ListSubItems.Item(13) = ""
            vListViewPrincipal.SelectedItem.ListSubItems.Item(13).ReportIcon = "AGUARDE-02"
        Else
            vListViewPrincipal.SelectedItem.ListSubItems.Item(13) = ""
            vListViewPrincipal.SelectedItem.ListSubItems.Item(13).ReportIcon = "OK"
        End If
        vListViewPrincipal.SelectedItem.ListSubItems.Item(14) = txtContDes(10).Text 'Observação
        If Check1.Value = 0 Then 'Ativo
            vListViewPrincipal.SelectedItem.ListSubItems.Item(15) = ""
            vListViewPrincipal.SelectedItem.ListSubItems.Item(15).ReportIcon = "EXC"
        Else
            vListViewPrincipal.SelectedItem.ListSubItems.Item(15) = ""
            vListViewPrincipal.SelectedItem.ListSubItems.Item(15).ReportIcon = "OK"
        End If
        If cboContDes(2).Text <> "" Then vListViewPrincipal.SelectedItem.ListSubItems.Item(16) = cboContDes(2).Text 'Detalhista
    End If
    Exit Sub
Err:
