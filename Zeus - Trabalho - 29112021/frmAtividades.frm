...
Private Sub AtualizaListview()
    ...
    If Status = "novo" Then
        ...
        End If
    Else
        vListViewPrincipal.SelectedItem.ListSubItems.Item(1) = cboCadEscolaridade.Text
        vListViewPrincipal.SelectedItem.ListSubItems.Item(2) = txtCadEscolaridade(2).Text
        vListViewPrincipal.SelectedItem.ListSubItems.Item(3) = txtCadEscolaridade(1).Text
        vListViewPrincipal.SelectedItem.ListSubItems.Item(4) = txtCadEscolaridade(3).Text
        If Check1.Value = 0 Then
            vListViewPrincipal.SelectedItem.ListSubItems.Item(5) = ""
            vListViewPrincipal.SelectedItem.ListSubItems.Item(5).ReportIcon = "EXC"
        Else
            vListViewPrincipal.SelectedItem.ListSubItems.Item(5) = ""
            vListViewPrincipal.SelectedItem.ListSubItems.Item(5).ReportIcon = "OK"
        End If
    End If
    Exit Sub
Err:
