...
Private Sub carregarIconBotao()
    ...
    carregaImagemBotao cmdCadastro(18), 18, 33 'Excluir
    ...
    carregaImagemBotao cmdCadastro(10), 10, 52 'Gerar OS - Engrenagem
    carregaImagemBotao cmdCadastro(16), 16, 53 'Gerar OS - Engrenagem
