...
Begin VB.Form frmEscolaridade 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   255
         Left            =   7560
         OleObjectBlob   =   "frmEscolaridade.frx":0CCA
         TabIndex        =   10
         Top             =   240
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   1320
         OleObjectBlob   =   "frmEscolaridade.frx":0D32
         TabIndex        =   9
         Top             =   240
         Width           =   1695
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmEscolaridade.frx":0DAA
         TabIndex        =   8
         Top             =   240
         Width           =   855
      End
   ...
   Begin MAESTRO.chameleonButton cmdCadastro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmEscolaridade.frx":0E16
      PICN            =   "frmEscolaridade.frx":0E32
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin MAESTRO.chameleonButton cmdCadastro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmEscolaridade.frx":1B0C
      PICN            =   "frmEscolaridade.frx":1B28
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
Private Sub cmdCadastro_Click(Index As Integer)
    Select Case Index
    Case 0
        mobjMsg.Abrir "Deseja salvar os dados da Escolaridade?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            GravarDados
            gravaLog "Código esc.: " & txtCadEscolaridade(0), "Nome esc: " & txtCadEscolaridade(1), "Peso: " & txtCadEscolaridade(2)
        End If
    Case 1
        mobjMsg.Abrir "Deseja sair da tela de cadastro de Escolaridade?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            Unload Me
...
On Error GoTo TrataErro
    ...
    AtualizaListview
    mobjMsg.Abrir "Os dados do Escolaridade foram salvos com sucesso", Ok, informacao, "SGC"
    Unload Me
    Exit Sub
TrataErro:
...
Private Function ValidaCampo()
    ...
    If txtCadEscolaridade(2).Text = "" Then
        mobjMsg.Abrir "Favor informar o campo " & Me.txtCadEscolaridade(2).Tag, Ok, critico, "Atenção"
...
Private Sub ResultPesq()
    ...
    If rsEscolaridade.RecordCount > 0 Then
        CompoeControles
    Else
        mobjMsg.Abrir "Escolaridade não encontrado", Ok, critico, "Atenção"
    End If
    rsEscolaridade.Close
    Set rsEscolaridade = Nothing
End Sub
