...
Private Sub Form_Load()
    ...
    sqlRelInsp = "select a.codprogramacao,a.dataprogramacao,a.datainicio,a.datafim,a.horainicio,a.horafim,a.local,a.entidade,a.dae,a.metodo,a.metodooutro,a.observacao,a.avalnome,a.avaldata,g.nomeinstrutor,c.codcolaborador,c.nomecolaborador,f.nomecargo,j.nomesetor,h.nometreinamento,h.objetivo,h.conteudo,h.cargahoraria,i.logo,h.origem,h.tipo,a.metodoA,a.metodoT,a.metodoS,a.metodoPT from " & _
                 "tbprogramacao as a inner join tbpendentescur as b on a.codprogramacao=b.codprogramacao inner join tbcolaboradores as c on b.cpf = c.cpf and c.ativo = 'S' inner join tbColaboradoresHist as d on c.cpf = d.cpf and d.ativo = 'S' inner join tbmatriz as e on e.codmatriz = d.codmatriz inner join tbcargos as f on f.codcargo = e.codcargo inner join tbsetores as j on j.codsetor = e.codsetor inner join tbprogramacaoinstrutores as g on g.codprogramacao = a.codprogramacao inner join tbtreinamentos as h on h.codtreinamento = b.codtreinamento inner join tbDadosEmpresa as i on i.codcoligada = '" & vCodColigada & "' order by c.nomecolaborador"
