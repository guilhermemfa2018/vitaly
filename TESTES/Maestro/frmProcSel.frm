...
Begin VB.Form frmProcSel 
   ...
   Begin ACTIVESKINLibCtl.SkinLabel Label7 
      Height          =   375
      Left            =   3000
      OleObjectBlob   =   "frmProcSel.frx":0CCA
      TabIndex        =   56
      Top             =   7560
      Visible         =   0   'False
      Width           =   6015
   ...
   Begin MAESTRO.chameleonButton cmdCadastro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmProcSel.frx":0D86
      PICN            =   "frmProcSel.frx":0DA2
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin MAESTRO.chameleonButton cmdCadastro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmProcSel.frx":1A7C
      PICN            =   "frmProcSel.frx":1A98
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmProcSel.frx":2772
      ...
      TabCaption(1)   =   "Filtro"
      TabPicture(1)   =   "frmProcSel.frx":278E
      ...
      TabPicture(2)   =   "frmProcSel.frx":27AA
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "ListView3"
      Tab(2).Control(1)=   "cmdCadastro(9)"
      Tab(2).Control(2)=   "cmdCadastro(3)"
      Tab(2).Control(3)=   "Check5"
      Tab(2).ControlCount=   4
      TabCaption(3)   =   "Admitidos"
      TabPicture(3)   =   "frmProcSel.frx":27C6
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "cmdCadastro(4)"
      Tab(3).Control(1)=   "cmdCadastro(5)"
      Tab(3).Control(2)=   "cmdCadastro(6)"
      Tab(3).Control(3)=   "ListView4"
      ...
      Begin MAESTRO.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmProcSel.frx":27E2
         PICN            =   "frmProcSel.frx":27FE
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmProcSel.frx":34D8
         PICN            =   "frmProcSel.frx":34F4
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmProcSel.frx":41CE
         PICN            =   "frmProcSel.frx":41EA
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmProcSel.frx":4EC4
         PICN            =   "frmProcSel.frx":4EE0
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmProcSel.frx":5BBA
         PICN            =   "frmProcSel.frx":5BD6
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmProcSel.frx":68B0
         PICN            =   "frmProcSel.frx":68CC
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmProcSel.frx":75A6
         PICN            =   "frmProcSel.frx":75C2
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VB.ComboBox Combo2 
            Height          =   315
            ItemData        =   "frmProcSel.frx":829C
            Left            =   120
            List            =   "frmProcSel.frx":829E
            TabIndex        =   14
            Top             =   240
            Width           =   2775
         End
   ...
   Begin VB.Frame Frame4 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel6 
         Height          =   255
         Left            =   6960
         OleObjectBlob   =   "frmProcSel.frx":82A0
         TabIndex        =   55
         Top             =   240
         Width           =   1455
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel5 
         Height          =   255
         Left            =   2280
         OleObjectBlob   =   "frmProcSel.frx":8324
         TabIndex        =   54
         Top             =   240
         Width           =   1335
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmProcSel.frx":839C
         TabIndex        =   53
         Top             =   240
         Width           =   975
      End
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "frmProcSel.frx":8408
         Left            =   600
         List            =   "frmProcSel.frx":8418
         TabIndex        =   5
         Text            =   "2"
         Top             =   360
         Width           =   615
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   255
         Left            =   3000
         OleObjectBlob   =   "frmProcSel.frx":842A
         TabIndex        =   52
         Top             =   240
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   1680
         OleObjectBlob   =   "frmProcSel.frx":84A2
         TabIndex        =   51
         Top             =   240
         Width           =   975
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmProcSel.frx":8518
         TabIndex        =   50
         Top             =   240
         Width           =   1095
      End
...
Private Sub cmdCadastro_Click(Index As Integer)
    ...
    Case 4
        ...
        mobjMsg.Abrir "Deseja iniciar a conclusão do Processo Seletivo?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            GravaPS
    ...
    Case 5
        ...
        If Sqlp = True Then
            ...
            End If
            mobjMsg.Abrir "Dados atualizados com sucesso!", Ok, informacao, "Atenção"
        End If
    Case 6
    ...
    Case 9
        ExcluirLV3
    Case 11
        mobjMsg.Abrir "Deseja salvar os dados do Processo Seletivo?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            GravaPS
        End If
    Case 12
        mobjMsg.Abrir "Deseja sair da tela de cadastro de Processo Seletivo?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            Pesquisa = "0"
            Unload Me
        End If
...
Private Function CarregaProc()
    ...
    ElseIf Not IsNull(rsProc.Fields(4)) Then
        mobjMsg.Abrir "Requisição esta reservada para outro processo seletivo", Ok, critico, "Atenção"
        LimpaControles
    Else
...
Private Sub selecionaCandidatos(filtra As Integer)
    ...
    If rsCandidatos.RecordCount <> 0 Then Principal.ProgressBar1.Max = rsCandidatos.RecordCount
    R = 0
    ...
    If Not rsCandidatos.EOF Then
        While Not rsCandidatos.EOF '.Move(Val(Combo1.Text))
            Principal.ProgressBar1.Value = R
...
On Error GoTo TrataErro
    ...
    rsSalvar.Close
    Set rsSalvar = Nothing
    mobjMsg.Abrir "Os dados do Processo Seletivo foram salvos com sucesso", Ok, informacao, "SGCH"
    'AtualizaListview
    Exit Sub
TrataErro:
...
Private Function ValidaCampo()
    ...
    If txtProcesso(1).Text = "" Then
        mobjMsg.Abrir "Favor informar o campo " & Me.txtProcesso(1).Tag, Ok, critico, "Atenção"
...
Private Sub ResultPesq()
    ...
    Else
        mobjMsg.Abrir "Processo Seletivo não encontrado", Ok, critico, "Atenção"
    End If
    rsProcesso.Close
    Set rsProcesso = Nothing
End Sub
    ...
    For X = 1 To ListView1.ListItems.Count
        ...
        For Y = 1 To ListView4.ListItems.Count
            ...
            If ListView4.SelectedItem.ListSubItems.Item(10) = "" Or ListView4.SelectedItem.ListSubItems.Item(10) = "-" Then
                mobjMsg.Abrir "O Processo Seletivo não pode ser concluido. Existem colaboradores sem registro.", Ok, critico, "Atenção"
                cnBanco.RollbackTrans
                Exit Function
            End If
            ...
            If vintegrar = "S" Then
                If ListView4.SelectedItem.ListSubItems.Item(11) = "" Or ListView4.SelectedItem.ListSubItems.Item(11) = "-" Then
                    mobjMsg.Abrir "O Processo Seletivo não pode ser concluido. Dados de integração Totvs não informado.", Ok, critico, "Atenção"
                    cnBanco.RollbackTrans
                    Exit Function
                End If
            End If
            ...
            If Val(ListView4.SelectedItem.ListSubItems.Item(6)) < MediaGlobal And ListView4.SelectedItem.ListSubItems.Item(8) = "" Then
                mobjMsg.Abrir "O Processo Seletivo não pode ser concluido. Existem colaboradores que necessitam de justificativa para admissão.", Ok, critico, "Atenção"
                cnBanco.RollbackTrans
                Exit Function
            End If
        ...
        If contaVagas < Val(ListView1.SelectedItem.ListSubItems.Item(4)) Then
            mobjMsg.Abrir "Dados salvos e NÃO concluidos. Faltam Preencher vagas para o cargo de: " & ListView1.SelectedItem.ListSubItems.Item(1), Ok, critico, "Atenção"
            cnBanco.RollbackTrans
            Exit Function
        ElseIf contaVagas > Val(ListView1.SelectedItem.ListSubItems.Item(4)) Then
            mobjMsg.Abrir "Dados salvos e NÃO concluidos. Ultrapassou o limite de vagas para o cargo de: " & ListView1.SelectedItem.ListSubItems.Item(1), Ok, critico, "Atenção"
            cnBanco.RollbackTrans
            Exit Function
        End If
