...
Begin VB.Form frmSplash 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox Combo1 
            ...
            Width           =   2175
         End
         Begin MAESTRO.chameleonButton chameleonButton3 
            Height          =   495
            Left            =   120
            TabIndex        =   14
            Top             =   1560
      ...
      Begin MAESTRO.chameleonButton chameleonButton4 
         ...
         VALUE           =   0   'False
      End
      Begin MAESTRO.chameleonButton chameleonButton2 
         Height          =   495
         Left            =   2040
         TabIndex        =   16
         Top             =   2520
   ...
   Begin VB.Timer Timer2 
      ...
      Top             =   6120
   End
   Begin MAESTRO.chameleonButton cmdSenha 
      Height          =   495
      Index           =   1
      Left            =   9720
      TabIndex        =   18
   ...
   Begin MAESTRO.chameleonButton cmdSenha 
      ...
      VALUE           =   0   'False
   End
   Begin MAESTRO.chameleonButton cmdRegistrarAgora 
      Height          =   495
      Left            =   9120
      TabIndex        =   26
      Top             =   2400
...
Private Sub chameleonButton4_Click()
    ...
    TiraTempoMouse
    Msgbox "dados gravados com sucesso", vbInformation, "SGC"
...
On Error GoTo TrataErro
    ...
    Select Case Index
        Case 0
            If Msgbox("Deseja encerrar a aplicação", vbQuestion + vbYesNo, "SGC") = vbYes Then
        ...
        Case 1
            ...
            Else
                Msgbox "Nome ou Senha do usuario inválido", vbInformation, "SGC"
                txtCadastro(1).Text = ""
                txtCadastro(0).Text = ""
...
'    oConn.Open "Provider=SQLOLEDB;Data Source=" & sServerName & ";User ID=sa;Password=;"
    ...
    Msgbox "Banco criado com sucesso", vbInformation, "SGC"
    Exit Function
Err1:
...
'    aLock.SoftwareName = "SGC" & Format(Now, "mm/yy")
...
On Error GoTo Err
    ...
    If Dir$(vCaminhoAtu) <> "" Then
        ...
        If Dir$(caminhoSGCHAtu) <> "" Then
            ...
            If fso.GetFileVersion(caminhoSGCHAtu) > fso.GetFileVersion(camSGCHso) Then
                mobjMsg.Abrir "Uma nova versão do sistema foi disponibilizada no REPOSITÓRIO. Deseja atualizar?", YesNo, pergunta, "SGC"
                If Tp = 1 Then
    ...
    Exit Sub
Err:
    If Err.Number = 76 Then Msgbox "Executável de atualização não encontrado no caminho informado", vbCritical, "SGC"
    Exit Sub
End Sub
