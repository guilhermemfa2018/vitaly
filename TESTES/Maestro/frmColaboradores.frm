...
Begin VB.Form frmColaboradores 
   ...
   Begin MAESTRO.chameleonButton cmdCadastro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmColaboradores.frx":19C0
      PICN            =   "frmColaboradores.frx":19DC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmColaboradores.frx":26B6
         ...
         TabPicture(1)   =   "frmColaboradores.frx":26D2
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "cmdCadastro(24)"
         Tab(1).Control(1)=   "cmdCadastro(18)"
         Tab(1).Control(2)=   "cmdCadastro(3)"
         Tab(1).Control(3)=   "cmdCadastro(2)"
         Tab(1).Control(4)=   "cmdCadastro(1)"
         Tab(1).Control(5)=   "cmdCadastro(0)"
         Tab(1).Control(6)=   "cboCadMatriz(3)"
         Tab(1).Control(7)=   "cboCadMatriz(2)"
         Tab(1).Control(8)=   "txtCadMatriz(8)"
         Tab(1).Control(9)=   "txtCadMatriz(9)"
         Tab(1).Control(10)=   "txtCadMatriz(1)"
         Tab(1).Control(11)=   "ListView1"
         ...
         TabPicture(2)   =   "frmColaboradores.frx":26EE
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "ListView2"
         Tab(2).ControlCount=   1
         TabCaption(3)   =   "Cursos"
         TabPicture(3)   =   "frmColaboradores.frx":270A
         ...
         Tab(3).Control(4)=   "txtCadMatriz(10)"
         Tab(3).Control(4).Enabled=   0   'False
         Tab(3).Control(5)=   "txtCadMatriz(11)"
         Tab(3).Control(5).Enabled=   0   'False
         Tab(3).Control(6)=   "cboCadMatriz(5)"
         Tab(3).Control(6).Enabled=   0   'False
         Tab(3).Control(7)=   "cmdCadastro(8)"
         Tab(3).Control(7).Enabled=   0   'False
         Tab(3).Control(8)=   "cmdCadastro(7)"
         Tab(3).Control(8).Enabled=   0   'False
         Tab(3).Control(9)=   "cmdCadastro(5)"
         Tab(3).Control(9).Enabled=   0   'False
         Tab(3).Control(10)=   "cmdCadastro(4)"
         Tab(3).Control(10).Enabled=   0   'False
         Tab(3).Control(11)=   "cmdCadastro(25)"
         Tab(3).Control(11).Enabled=   0   'False
         Tab(3).ControlCount=   12
         TabCaption(4)   =   "Graduação"
         TabPicture(4)   =   "frmColaboradores.frx":2726
         Tab(4).ControlEnabled=   0   'False
         Tab(4).Control(0)=   "Label13"
         Tab(4).Control(1)=   "Label14"
         Tab(4).Control(2)=   "ListView4"
         Tab(4).Control(3)=   "txtCadMatriz(12)"
         Tab(4).Control(4)=   "txtCadMatriz(13)"
         Tab(4).Control(5)=   "cmdCadastro(16)"
         Tab(4).Control(6)=   "cmdCadastro(10)"
         Tab(4).Control(7)=   "cmdCadastro(9)"
         Tab(4).Control(8)=   "cmdCadastro(6)"
         Tab(4).Control(9)=   "cmdCadastro(26)"
         Tab(4).Control(10)=   "cmdCadastro(17)"
         Tab(4).ControlCount=   11
         TabCaption(5)   =   "Histórico func."
         TabPicture(5)   =   "frmColaboradores.frx":2742
         ...
         Tab(5).Control(9)=   "DTPicker2"
         Tab(5).Control(10)=   "ListView5"
         Tab(5).Control(11)=   "txtCadMatriz(20)"
         Tab(5).Control(12)=   "txtCadMatriz(22)"
         Tab(5).Control(13)=   "txtCadMatriz(21)"
         Tab(5).Control(14)=   "txtCadMatriz(0)"
         Tab(5).Control(15)=   "txtCadMatriz(5)"
         Tab(5).Control(16)=   "txtCadMatriz(6)"
         Tab(5).Control(17)=   "DTPicker3"
         Tab(5).Control(18)=   "cmdCadastro(22)"
         Tab(5).Control(19)=   "cmdCadastro(21)"
         Tab(5).Control(20)=   "cmdCadastro(20)"
         Tab(5).Control(21)=   "cmdCadastro(19)"
         Tab(5).Control(22)=   "cmdCadastro(11)"
         Tab(5).ControlCount=   23
         TabCaption(6)   =   "Integração"
         TabPicture(6)   =   "frmColaboradores.frx":275E
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":4182
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":419E
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":41BA
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":41D6
            PICN            =   "frmColaboradores.frx":41F2
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":4ECC
            PICN            =   "frmColaboradores.frx":4EE8
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":5BC2
            PICN            =   "frmColaboradores.frx":5BDE
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":68B8
            PICN            =   "frmColaboradores.frx":68D4
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":75AE
            PICN            =   "frmColaboradores.frx":75CA
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":82A4
            PICN            =   "frmColaboradores.frx":82C0
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":8F9A
            PICN            =   "frmColaboradores.frx":8FB6
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":9C90
            PICN            =   "frmColaboradores.frx":9CAC
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":A986
            PICN            =   "frmColaboradores.frx":A9A2
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":B67C
            PICN            =   "frmColaboradores.frx":B698
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":C372
            PICN            =   "frmColaboradores.frx":C38E
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":D068
            PICN            =   "frmColaboradores.frx":D084
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":DD5E
            PICN            =   "frmColaboradores.frx":DD7A
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":EA54
            PICN            =   "frmColaboradores.frx":EA70
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":F74A
            PICN            =   "frmColaboradores.frx":F766
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin MAESTRO.chameleonButton cmdCadastro 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":10440
            PICN            =   "frmColaboradores.frx":1045C
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VB.ComboBox cboCadMatriz 
               Height          =   315
               Index           =   0
               ItemData        =   "frmColaboradores.frx":11136
               Left            =   1560
               List            =   "frmColaboradores.frx":11140
               TabIndex        =   8
               Tag             =   "Sexo"
               ToolTipText     =   "Sexo"
               Top             =   480
            ...
            Begin VB.ComboBox cboCadMatriz 
               Height          =   315
               Index           =   1
               ItemData        =   "frmColaboradores.frx":11159
               Left            =   120
               List            =   "frmColaboradores.frx":1116F
               TabIndex        =   9
               Tag             =   "Estado civil"
            ...
            Begin VB.ComboBox cboCadMatriz 
               Height          =   315
               Index           =   4
               ItemData        =   "frmColaboradores.frx":111BE
               Left            =   2880
               List            =   "frmColaboradores.frx":11213
               TabIndex        =   12
         ...
         Begin VB.ComboBox cboCadMatriz 
            Height          =   315
            Index           =   3
            ItemData        =   "frmColaboradores.frx":11283
            Left            =   -68880
            List            =   "frmColaboradores.frx":1128D
            TabIndex        =   24
         ...
         Begin VB.ComboBox cboCadMatriz 
            Height          =   315
            Index           =   2
            ItemData        =   "frmColaboradores.frx":1129E
            Left            =   -69720
            List            =   "frmColaboradores.frx":112C6
            TabIndex        =   23
            Tag             =   "Periodicidade do curso/treinamento"
            Text            =   "001"
            ToolTipText     =   "Periodicidade do curso/treinamento"
   ...
   Begin VB.Frame Frame11 
      ...
      Begin VB.Frame Frame8 
         ...
         Begin MAESTRO.chameleonButton chameleonButton1 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmColaboradores.frx":1137A
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin AlphaImageControl.aicAlphaImage aicAlphaImage2 
            ...
            _ExtentX        =   4366
            _ExtentY        =   2778
            Image           =   "frmColaboradores.frx":11396
            Opacity         =   30
            Props           =   5
         End
   ...
   Begin VB.Frame Frame6 
      ...
      Begin MAESTRO.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmColaboradores.frx":360AF
         PICN            =   "frmColaboradores.frx":360CB
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin AlphaImageControl.aicAlphaImage aicAlphaImage1 
            ...
            _ExtentX        =   4048
            _ExtentY        =   4895
            Image           =   "frmColaboradores.frx":36DA5
         End
      End
...
Private Sub cmdCadastro_Click(Index As Integer)
    ...
    Case 2
        AlteraExperiencia
    Case 3
        mobjMsg.Abrir "Deseja EXCLUIR essa experiência do colaborador?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
    ...
    Case 5
        ...
        mobjMsg.Abrir "Deseja EXCLUIR esse curso/treinamento do colaborador?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            ExcluirItemLV ListView3
            LimpaControlesTreinamento
        End If
    Case 6
        mobjMsg.Abrir "Deseja EXCLUIR essa formação escolar do colaborador?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
    ...
    Case 13
        ...
        Label53 = ""
    Case 14
        mobjMsg.Abrir "Deseja salvar os dados do colaborador?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            GravarDados
            Pesquisa = "0"
        ...
        End If
    Case 15
        mobjMsg.Abrir "Deseja sair da tela de cadastro do colaborador?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            Pesquisa = "0"
            Unload Me
    ...
    Case 23
        If txtCadMatriz(4) <> "" Then
            ChamaGridReq
        Else
            mobjMsg.Abrir "Cargo do colaborador não informado", Ok, critico, "Atenção"
        End If
    Case 24
        Campo4 = 1
        frmAvisos.Show 1
...
Private Function vigiaExclusao()
    ...
    If ListView3.SelectedItem.ListSubItems.Item(2) <> "C" Then
        mobjMsg.Abrir "Curso/treinamento gerenciado pelo sistema. Não pode ser excluido", Ok, critico, "Atenção"
        vigiaExclusao = False
    End If
End Function
...
Private Sub listview_cabecalho()
    ...
    ListView3.ColumnHeaders.Add , , "Nome do curso/treinamento", ListView3.Width / 1.5
...
Private Function ValidaHabilidade()
    ...
    For X = 1 To Y
        ...
        If ListView2.SelectedItem.ListSubItems.Item(3) = 0 Then
            mobjMsg.Abrir "As habilidades do cargo não foram avaliadas. Favor avaliar antes de incluir um novo cargo", Ok, critico, "Atenção"
            Exit Function
        End If
    Next
    ValidaHabilidade = True
...
Private Function ValidaTempo()
        ...
        If ListView5.SelectedItem.ListSubItems.Item(7) = "S" Then
            If Check1.Value = 1 Then
                If ListView5.SelectedItem.ListSubItems.Item(9) = "-" Then
                    mobjMsg.Abrir "Deve-se informar data de saida do cargo anterior", Ok, critico, "Atenção"
                    Exit Function
                End If
            End If
    ...
    If tempoNoCargo < tempoMin Then
        If vAdiRep = "N" Then
            mobjMsg.Abrir "O colaborador não está tempo suficiente no cargo. O usuário não tem privilégios para realizar essa movimentação", Ok, critico, "Atenção"
        Else
            If Check1.Value = 1 Then
...
Private Sub CarregaReq()
    ...
    If rsReq.RecordCount <= 0 Then
        If Val(txtCadMatriz(26)) <> novaRequisicao Then mobjMsg.Abrir "Requisição não disponível para este cargo", Ok, critico, "Atenção"
    ...
    If Pesquisa <> "" Then
        ...
        If Pesquisa <> 0 Then
            If Mid$(Pesquisa, 7, 6) <> Mid$(txtCadMatriz(4), 1, 6) Then
                mobjMsg.Abrir "O cargo selecionado é diferente do cargo do colaborador", Ok, critico, "Atenção"
                'txtCadMatriz(26).Text = ""
            Else
                ...
                If Val(RemoveMask(Label41)) < MediaGlobal And Val(RemoveMask(Label41)) >= vAprovadoRest Then
                    If vAdiRes = "N" Then
                        ...
                        If Tp = 1 Then
                            ...
                            mobjMsg.Abrir "Foi gerado o PDO nº: " & Format(vPDO, "000000") & ". Aguarde tomada de decisão", Ok, critico, "Atenção"
                        End If
    '                    configControles
    '                    HabBotoes
                        cnBanco.CommitTrans
...
'---------------------------------------------------
    ...
    Else
        ...
        Else
            mobjMsg.Abrir "Já existe cadastrado um COLABORADOR com os mesmos dados de CPF e Registro", Ok, critico, "Atenção"
    ...
    sqlDeletar = "Delete from tbColaboradoresCur where tbColaboradoresCur.codcoligada = '" & vCodcoligada & "' and tbColaboradoresCur.cpf = '" & mskCadMatriz.Text & "' and tipo = 'colaborador'"
    rsDeletar.Open sqlDeletar, cnBanco
    ...
    If Check3.Value = 0 And Check1.Value = 1 Then
        rsSalvarColaborador(27) = "S" ' nº da requisição
        excluiProgramacao
        GravaTreiPen
        ApagaExcesso
    ...
    mobjMsg.Abrir "Os dados do Colaborador foram salvos com sucesso", Ok, informacao, "Atenção"
    AtualizaListview
    Exit Sub
TrataErro:
...
Private Sub excluiProgramacao()
    ...
    Dim rsDeletar As New ADODB.Recordset
    Dim sqlDeletar As String
    sqlDeletar = "Delete from tbPendentesCur where tbPendentesCur.codcoligada = '" & vCodcoligada & "' and tbPendentesCur.cpf = '" & mskCadMatriz.Text & "' and status = 'Pendente' and codmatriz <> '" & Val(Mid$(txtCadMatriz(4), 1, 6)) & "' or tbPendentesCur.cpf = '" & mskCadMatriz.Text & "' and status = 'Agendado' and codmatriz <> '" & Val(Mid$(txtCadMatriz(4), 1, 6)) & "'"
    rsDeletar.Open sqlDeletar, cnBanco
End Sub
...
Private Sub ResultPesq(Status As String)
    ...
    ElseIf Status = "novo" Then
        SqlColaboradores = "Select * from tbColaboradores Where codcoligada = '" & vCodcoligada & "' and cpf = '" & mskCadMatriz & "' order by cpf"
        rsColaboradores.Open SqlColaboradores, cnBanco, adOpenKeyset, adLockReadOnly
    End If
...
Private Sub achaColab()
    ...
    If rsColaboradores.RecordCount > 0 Then
        ...
        If rsColaboradores.Fields(1) = "S" Then
            mobjMsg.Abrir "Esse colaborador se encontra ativo no sistema", Ok, critico, "Atenção"
            Me.mskCadMatriz.SetFocus
        End If
    End If
    rsColaboradores.Close
