...
Begin VB.Form frmADP 
   ...
   Begin MAESTRO.chameleonButton cmdINTD 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmADP.frx":19C0
      PICN            =   "frmADP.frx":19DC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin MAESTRO.chameleonButton cmdINTD 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmADP.frx":26B6
      PICN            =   "frmADP.frx":26D2
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(4)=   "txtADP(12)"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "txtADP(11)"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "Combo1"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "txtADP(15)"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "txtADP(16)"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "cmdINTD(8)"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "cmdINTD(7)"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "cmdINTD(5)"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "cmdCad(2)"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "cmdINTD(2)"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).ControlCount=   14
      TabCaption(1)   =   "Observações"
      TabPicture(1)   =   "frmADP.frx":3426
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "txtADP(13)"
      ...
      Begin MAESTRO.chameleonButton cmdINTD 
         ...
         Left            =   10920
         TabIndex        =   79
         Tag             =   "Redefinir MODELO de Avaliação de Desempenho Profissional"
         ToolTipText     =   "Redefinir MODELO de Avaliação de Desempenho Profissional"
         Top             =   1080
         Width           =   615
         _ExtentX        =   1085
         _ExtentY        =   1085
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmADP.frx":3442
         PICN            =   "frmADP.frx":345E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdINTD 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmADP.frx":4138
         PICN            =   "frmADP.frx":4154
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdINTD 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmADP.frx":4E2E
         PICN            =   "frmADP.frx":4E4A
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdINTD 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmADP.frx":5B24
         PICN            =   "frmADP.frx":5B40
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "frmADP.frx":681A
         Left            =   9240
         List            =   "frmADP.frx":6827
         TabIndex        =   20
         Text            =   "Institucional"
         Top             =   720
         Width           =   2415
...
Private Sub cmdINTD_Click(Index As Integer)
    ...
    Case 4
        ...
        CarregaAvaliacao
    Case 5
        mobjMsg.Abrir "Deseja EXCLUIR Avaliação da ADP?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
    ...
    Case 8
        ...
        LimpaControlesAvaliacao
    Case 11
        mobjMsg.Abrir "Deseja salvar os dados da ADP?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            calculaNotaADP
            gravaDadosADP
'            gravaLog "Código req: " & txtCadReq(0), "Requisitante" & txtCadReq(1) & "-" & txtCadReq(2), ""
    ...
    Case 9
        'CONCLUSÃO DA ADP
        mobjMsg.Abrir "Deseja iniciar a conclusão da ADP - Avaliação de Desempenho Profissional?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            calculaNotaADP
            gravaDadosADP
        ...
        Unload Me
    Case 12
        mobjMsg.Abrir "Deseja sair dessa Avaliação de Desempenho Profissional?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            Pesquisa = "0"
            Unload Me
            Set frmADP = Nothing
...
Private Function ValidaAvaliacao()
    ...
    If txtADP(11).Text = "" Then
        mobjMsg.Abrir "Favor informar o campo " & Me.txtADP(11).Tag, Ok, informacao, "Atenção"
...
On Error GoTo TrataErro1
    ...
    sqlADP = "select a.codcolaborador,a.nota,b.cpf,c.codmatriz,e.nomecargo,c.data,b.foto,a.codrespADP,a.nomerespADP,a.ausenciaano,a.atrasoano,a.codrespABS,a.nomerespABS,a.observacao,a.indicacaotipo,a.indicacaomod1,a.indicacaomod2,a.indicacaomod3,a.indicacaomod4," & _
             "a.indicacaomod5,a.indicacaomod6,a.indicacaooutros,a.statusimpressao,a.statusavaliacao,a.ativo,a.id from tblistaadp as a inner join tbcolaboradores as b on a.codcoligada = '" & vCodcoligada & "' and a.codcolaborador = b.id inner join tbcolaboradoreshist as c " & _
    ...
    txtADP(2) = Format(rsADP.Fields(3), "000000") & " - " & rsADP.Fields(4)
    If Not IsNull(rsADP.Fields(1)) Then Label17 = rsADP.Fields(1) Else Label17 = "-"
    Label53 = rsADP.Fields(6)
    'A linha abaixo faz a tela demorar para abrir
    ...
    'POR PADRAO - Carrega Itens de ADP - Avaliação de Desempenho Profissional
    'SE NÃO tiver nenhuma avaliação salva
    If ListView1.ListItems.Count = 0 Then
        sqlADP = "select b.codavaliacao,c.nomeavaliacao,c.peso,b.dimensao,c.descricao from tbavaliacaodesempenho as a inner join tbmodeloADPItens as b on a.idmodeloadp = b.codmodelo and a.codcoligada = '" & vCodcoligada & "' inner join tbavaliacao as c on b.codavaliacao = c.codavaliacao where a.dias = '" & Val(MeuLV.ListView1.SelectedItem.ListSubItems.Item(3)) & "'"
        rsADP.Open sqlADP, cnBanco, adOpenKeyset, adLockReadOnly
        While Not rsADP.EOF
            Set ItemLst = ListView1.ListItems.Add(, , Format(rsADP.Fields(0), "000000"))
            ItemLst.SubItems(1) = "" & rsADP.Fields(1)
            ItemLst.SubItems(2) = "" & rsADP.Fields(2)
            ItemLst.SubItems(3) = "0"
            ItemLst.SubItems(4) = "" & rsADP.Fields(3)
            ItemLst.SubItems(5) = "" & rsADP.Fields(4)
            ItemLst.ListSubItems(3).Bold = True
            rsADP.MoveNext
        Wend
    End If
...
Private Sub CarregaColaborador(indice As Integer)
    ...
    If rsColaborador.RecordCount <= 0 Then
        If indice = 1 Then
            If txtADP(3).Text <> "000000" And txtADP(3).Text <> "" Then mobjMsg.Abrir "Colaborador não cadastrado", Ok, critico, "Atenção"
            txtADP(4) = ""
            txtADP(5) = ""
        Else
            If txtADP(8).Text <> "000000" And txtADP(8).Text <> "" Then mobjMsg.Abrir "Colaborador não cadastrado", Ok, critico, "Atenção"
            txtADP(9) = ""
            txtADP(10) = ""
        End If
    Else
...
Private Sub CarregaAvaliacao()
    ...
    If rsTreiADP.EOF Then
        ...
        If Val(Pesquisa) <> 0 Then
            mobjMsg.Abrir "Avaliação não cadastrada", Ok, informacao, "SGC"
            txtADP(12) = ""
            txtADP(15) = ""
            txtADP(16) = ""
        End If
...
'On Error GoTo TrataErro
    ...
    cnBanco.CommitTrans
    mobjMsg.Abrir "Os dados da ADP foram salvos com sucesso", Ok, informacao, "SGC"
    AtualizaListview
    Exit Sub
TrataErro:
...
Private Sub calculaNotaADP()
    ...
    If vValor1 > 0 Then
        vMediaGeral = vValor1 - (vPontosAusencia + vPontosAtraso)
    Else
        vMediaGeral = 0
    End If
...
Private Function checkListADP()
    ...
    If Date < DTPicker3 - 10 Then
        mobjMsg.Abrir "Essa ADP não pode ser CONCLUIDA fora do período de vencimento", Ok, critico, "SGC"
        checkListADP = False
        Exit Function
    End If
    ...
    If ListView1.ListItems.Count > 0 Then
        ...
        For X = 1 To Y
            ListView1.ListItems.Item(X).Selected = True
            If Val(ListView1.SelectedItem.ListSubItems.Item(3)) = 0 Then
                mobjMsg.Abrir "Existem Itens da guia AVALIAÇÕES não avaliados", Ok, critico, "SGC"
                checkListADP = False
                Exit Function
            End If
        Next
    Else
        mobjMsg.Abrir "A guia AVALIAÇÕES não possui itens a serem avaliados", Ok, critico, "SGC"
        checkListADP = False
        Exit Function
    End If
    ...
    mobjMsg.Abrir "O processo de conclusão da ADP foi realizado com sucesso!", Ok, informacao, "Atenção"
End Function
