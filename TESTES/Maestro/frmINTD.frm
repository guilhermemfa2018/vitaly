...
Begin VB.Form frmINTD 
   ...
   Begin ACTIVESKINLibCtl.SkinLabel Label15 
      Height          =   255
      Left            =   1560
      OleObjectBlob   =   "frmINTD.frx":0CCA
      TabIndex        =   61
      Top             =   7680
      Visible         =   0   'False
      Width           =   6135
   ...
   Begin MAESTRO.chameleonButton cmdINTD 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmINTD.frx":0D6C
      PICN            =   "frmINTD.frx":0D88
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin MAESTRO.chameleonButton cmdINTD 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmINTD.frx":1A62
      PICN            =   "frmINTD.frx":1A7E
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin MAESTRO.chameleonButton cmdINTD 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmINTD.frx":2758
      PICN            =   "frmINTD.frx":2774
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin MAESTRO.chameleonButton cmdINTD 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmINTD.frx":344E
      PICN            =   "frmINTD.frx":346A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin MAESTRO.chameleonButton cmdINTD 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmINTD.frx":4144
      PICN            =   "frmINTD.frx":4160
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Frame Frame10 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel Label16 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmINTD.frx":4E3A
         TabIndex        =   75
         Top             =   240
         Width           =   1815
      End
   ...
   Begin VB.Frame Frame8 
      ...
      Top             =   2280
      Width           =   1815
      Begin ACTIVESKINLibCtl.SkinLabel Label13 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmINTD.frx":4E98
         TabIndex        =   76
         Top             =   240
         Width           =   1575
      End
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(4)=   "txtINTD(8)"
      Tab(1).Control(4).Enabled=   0   'False
      Tab(1).Control(5)=   "txtINTD(9)"
      Tab(1).Control(5).Enabled=   0   'False
      Tab(1).Control(6)=   "cboINTD(5)"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).Control(7)=   "cmdCad(3)"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).Control(8)=   "cmdINTD(8)"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).Control(9)=   "cmdINTD(7)"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "cmdINTD(5)"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "cmdINTD(6)"
      Tab(1).Control(11).Enabled=   0   'False
      Tab(1).ControlCount=   12
      TabCaption(2)   =   "Habilidades"
      TabPicture(2)   =   "frmINTD.frx":4F2E
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "ListView2"
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "Resultado "
      TabPicture(3)   =   "frmINTD.frx":4F4A
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "aicAlphaImage1"
      Tab(3).Control(1)=   "Frame7"
      Tab(3).Control(2)=   "Frame9"
      Tab(3).Control(3)=   "Frame11"
      Tab(3).Control(4)=   "Frame12"
      ...
      Begin MAESTRO.chameleonButton cmdINTD 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmINTD.frx":4F66
         PICN            =   "frmINTD.frx":4F82
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdINTD 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmINTD.frx":5C5C
         PICN            =   "frmINTD.frx":5C78
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdINTD 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmINTD.frx":6952
         PICN            =   "frmINTD.frx":696E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdINTD 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmINTD.frx":7648
         PICN            =   "frmINTD.frx":7664
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin VB.Frame Frame9 
         ...
         Begin VB.ComboBox cboINTD 
            Height          =   315
            Index           =   1
            ItemData        =   "frmINTD.frx":839F
            Left            =   120
            List            =   "frmINTD.frx":83A9
            TabIndex        =   30
            Top             =   240
            Width           =   2535
         End
      ...
      Begin MSComctlLib.ListView ListView2 
         ...
         Left            =   -74880
         TabIndex        =   29
         Tag             =   "habilidade a serem avaliadas no INTD"
         ToolTipText     =   "habilidade a serem avaliadas no INTD"
         Top             =   480
         Width           =   13335
         _ExtentX        =   23521
         _ExtentY        =   6588
   ...
   Begin VB.Frame Frame5 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel Label6 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmINTD.frx":235BC
         TabIndex        =   65
         Top             =   240
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel Matriz 
         Height          =   255
         Left            =   1680
         OleObjectBlob   =   "frmINTD.frx":2362C
         TabIndex        =   68
         Top             =   840
         Width           =   1215
      End
      Begin ACTIVESKINLibCtl.SkinLabel Label11 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmINTD.frx":236A2
         TabIndex        =   67
         Top             =   840
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel Label7 
         Height          =   255
         Left            =   1680
         OleObjectBlob   =   "frmINTD.frx":23708
         TabIndex        =   66
         Top             =   240
         Width           =   1335
      End
   ...
   Begin VB.Frame Frame4 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel Label5 
         Height          =   255
         Left            =   2640
         OleObjectBlob   =   "frmINTD.frx":23770
         TabIndex        =   74
         Top             =   240
         Width           =   1455
      End
      Begin ACTIVESKINLibCtl.SkinLabel Label25 
         Height          =   255
         Left            =   1680
         OleObjectBlob   =   "frmINTD.frx":237E6
         TabIndex        =   73
         Top             =   240
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel Label4 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmINTD.frx":2385A
         TabIndex        =   72
         Top             =   240
         Width           =   855
      End
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.ComboBox cboINTD 
         Height          =   315
         Index           =   0
         ItemData        =   "frmINTD.frx":238CC
         Left            =   120
         List            =   "frmINTD.frx":238DC
         TabIndex        =   5
         Text            =   "Colaborador"
         Top             =   480
         Width           =   1695
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel10 
         Height          =   255
         Left            =   3120
         OleObjectBlob   =   "frmINTD.frx":23916
         TabIndex        =   71
         Top             =   240
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel9 
         Height          =   255
         Left            =   1920
         OleObjectBlob   =   "frmINTD.frx":2397E
         TabIndex        =   70
         Top             =   240
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel8 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmINTD.frx":239EE
         TabIndex        =   69
         Top             =   240
         Width           =   975
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   255
         Left            =   3000
         OleObjectBlob   =   "frmINTD.frx":23A56
         TabIndex        =   64
         Top             =   240
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   1560
         OleObjectBlob   =   "frmINTD.frx":23ACE
         TabIndex        =   63
         Top             =   240
         Width           =   975
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmINTD.frx":23B44
         TabIndex        =   62
         Top             =   240
         Width           =   735
      End
...
Private Sub cmdINTD_Click(Index As Integer)
    ...
    Case 3
        If ListView1.ListItems.Count > 0 Then
            mobjMsg.Abrir "Todos os treinamento da guia Cursos/treinamentos serão apagados. Deseja continuar?", YesNo, pergunta, "ATENÇÃO"
            If Tp = 0 Then
                Exit Sub
            End If
        End If
        ...
        avaliaEscolar
    Case 5
        mobjMsg.Abrir "Deseja EXCLUIR curso/treinamento da INTD?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
    ...
    Case 9
        'CONCLUSÃO DA INTD
        mobjMsg.Abrir "Deseja iniciar a conclusão da INTD?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            calculaINTD
            gravaDadosINTD
    ...
    Case 10
        ...
        frmAvisos.Show 1
    Case 11
        mobjMsg.Abrir "Deseja salvar os dados da INTD?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            calculaINTD
            gravaDadosINTD
'            gravaLog "Código req: " & txtCadReq(0), "Requisitante" & txtCadReq(1) & "-" & txtCadReq(2), ""
        ...
        End If
    Case 12
        mobjMsg.Abrir "Deseja sair da tela de cadastro de INTD?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            Pesquisa = "0"
            Unload Me
            Set frmINTD = Nothing
...
'    SqlINTD = "select a.codINTD,a.datainicio,a.datafim,a.tipoINTD,a.tiposolicitante,a.codsolicitante,a.nomesolicitante,a.codcolaborador,a.codmatriz,a.status,a.ativo,a.objetivo,a.mediageral,a.resultado,a.observacao from tbINTD as a where a.codINTD = '" & Val(varGlobal) & "' and a.ativo='S'"
    SqlINTD = "select a.codINTD,a.datainicio,a.datafim,a.tipoINTD,a.tiposolicitante,a.codsolicitante,a.nomesolicitante,a.codcolaborador,a.codmatriz,a.status,a.ativo,a.objetivo,a.mediageral,a.resultado,a.observacao,a.mediaescolar from tbINTD as a where a.codcoligada = '" & vCodcoligada & "' and a.codINTD = '" & Val(varGlobal) & "'"
...
'--------------
        ...
        RestauraLVTrei
        calculaINTD
        If rsINTD.Fields(9) = "Fechado" Or rsINTD.Fields(9) = "Cancelada" Then BloqueiaControles Else lembrete
    Else
        mobjMsg.Abrir "INTD não encontrada", Ok, critico, "Atenção"
    End If
    avaliaEscolar
    rsINTD.Close
    Set rsINTD = Nothing
...
Private Sub CarregaColaborador(indice As Integer)
    ...
    "on c.coddepartamento=d.coddepartamento inner join tbsetores as e on c.codsetor = e.codsetor inner join tbcargos as f on c.codcargo = f.codcargo where a.ativo = 'S' and a.codcolaborador = '" & txtINTD(indice) & "'"
    rsColaborador.Open SqlColaborador, cnBanco, adOpenKeyset, adLockReadOnly
    If rsColaborador.RecordCount <= 0 Then
        If indice = 1 Then
            If txtINTD(1).Text <> "000000" And txtINTD(1).Text <> "" Then mobjMsg.Abrir "Colaborador não cadastrado", Ok, critico, "Atenção"
            txtINTD(2) = ""
        Else
            If txtINTD(3).Text <> "000000" And txtINTD(1).Text <> "" Then mobjMsg.Abrir "Colaborador não cadastrado", Ok, critico, "Atenção"
            txtINTD(4) = ""
        End If
    Else
        If indice = 1 Then
...
Private Function ValidaTreinamento()
    ...
    If txtINTD(9).Text = "" Then
        mobjMsg.Abrir "Favor informar o campo " & Me.txtINTD(9).Tag, Ok, critico, "Atenção"
...
'On Error GoTo TrataErro
    ...
    rsSalvarINTD.Fields(16) = RemoveMask(Label16) 'Media Escolar
    ...
    mobjMsg.Abrir "Os dados da INTD foram salvos com sucesso", Ok, informacao, "Atenção"
    AtualizaListview
    Exit Sub
TrataErro:
...
Private Sub calculaINTD()
    ...
    Else
        vValor2 = 100
    End If
    vValor3 = RemoveMask(Label16.Caption)
...
Private Function ValidaCampos()
    ...
    If txtINTD(1).Text = "" Then
        mobjMsg.Abrir "Favor informar o campo " & Me.txtINTD(1).Tag, Ok, critico, "Atenção"
    ...
    If optINTD(0).Value = True Then
        If txtINTD(3).Text = "" Then
            mobjMsg.Abrir "Favor informar o campo " & Me.txtINTD(3).Tag, Ok, critico, "Atenção"
            Me.txtINTD(3).SetFocus
            Exit Function
        End If
    Else
        If txtINTD(5).Text = "" Then
            mobjMsg.Abrir "Favor informar o campo " & Me.txtINTD(5).Tag, Ok, critico, "Atenção"
    ...
    'End If
    If ListView2.ListItems.Count = 0 Then
        mobjMsg.Abrir "Favor informar " & ListView2.Tag, Ok, critico, "Atenção"
        SSTab1.Tab = 2
        Exit Function
    End If
    ValidaCampos = True
...
Private Function checkListINTD()
    ...
    If Mid$(txtINTD(10), 1, 6) = txtINTD(5).Text Then
        ...
        Label14 = "Fechado"
        mobjMsg.Abrir "O processo de conclusão da INTD nº: " & txtINTD(0) & " foi realizado com sucesso!", Ok, informacao, "Atenção"
        AtualizaListview
        'rsINTD.Close
        'Set rsINTD = Nothing
        Exit Function
    ...
    If txtINTD(7).Text = "" Then
        mobjMsg.Abrir "Não foram apresentados objetivos para a INTD", Ok, critico, "Atenção"
        SSTab1.Tab = 0
        txtINTD(7).SetFocus
        checkListINTD = False
        Exit Function
    ...
    If ListView1.ListItems.Count > 0 Then
        ...
        For X = 1 To Y
            ...
            If ListView1.SelectedItem.ListSubItems.Item(3) <> "Concluido" And ListView1.SelectedItem.ListSubItems.Item(3) <> "Cancelado" Then
                mobjMsg.Abrir "Existem Cursos/treinamentos não concluidos", Ok, critico, "Atenção"
                checkListINTD = False
                Exit Function
            End If
        Next
        ...
        If ListView2.ListItems.Count > 0 Then
            ...
            For X = 1 To Y
                ...
                If ListView2.SelectedItem.ListSubItems.Item(3) = 0 Then
                    mobjMsg.Abrir "Existem Habilidades não avaliadas", Ok, critico, "Atenção"
                    checkListINTD = False
                    Exit Function
                End If
            Next
    ...
    If cboINTD(1).Text = "" Then
        mobjMsg.Abrir "Não foi avaliado o Resultado da INTD", Ok, critico, "Atenção"
        SSTab1.Tab = 3
        cboINTD(1).SetFocus
        checkListINTD = False
        Exit Function
    ...
    rsINTD.Open SqlINTD, cnBanco
    Label14 = "Fechado"
    mobjMsg.Abrir "O processo de conclusão da INTD nº: " & txtINTD(0) & " foi realizado com sucesso!", Ok, informacao, "SGC"
    AtualizaListview
End Function
...
Private Function pontosEscolar()
    ...
    If Not IsNull(rsPDOColab.Fields(3)) Then
        If rsPDOColab.RecordCount > 0 Then
            ...
            If rsPDOColab.Fields(4) = "N" Or IsNull(rsPDOColab.Fields(4)) Then
                mobjMsg.Abrir "O PDO nº: " & Format(vNumPDO, "000000") & " esta em aberto para este " & rsPDOColab.Fields(5) & ". Aguarde tomada de decisão", Ok, informacao, "SGC"
                rsPDOColab.Close
    ...
    If vStatusPDO <> "S" Then
        If Val(RemoveMask(Label16)) < MediaGlobal And Val(RemoveMask(Label16)) >= vAprovadoRest Then
            If vAdiRes = "N" Then
                mobjMsg.Abrir "Escolaridade abaixo da média. Usúario não privilégios para admitir o colaborador selecionado. Deseja gerar um PDO?", YesNo, pergunta, "SGC"
                If Tp = 1 Then
...
'On Error GoTo Err
    ...
    Exit Sub
Err:
    mobjMsg.Abrir "Ocorreu um erro ao tentar inserir o colaborador no novo cargo. Informe ao administrador do sistema", Ok, critico, "Atenção"
End Sub
