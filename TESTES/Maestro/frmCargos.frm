...
Begin VB.Form frmCargos 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmCargos.frx":26B6
         TabIndex        =   10
         Top             =   240
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   1320
         OleObjectBlob   =   "frmCargos.frx":2722
         TabIndex        =   11
         Top             =   240
         Width           =   2415
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   255
         Left            =   5880
         OleObjectBlob   =   "frmCargos.frx":279C
         TabIndex        =   12
         Top             =   240
         Width           =   1215
      End
...
Private Sub cmdCadastro_Click(Index As Integer)
    Select Case Index
    Case 0
        mobjMsg.Abrir "Deseja salvar os dados do cargo?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            GravarDados
        ...
        End If
    Case 1
        mobjMsg.Abrir "Deseja sair da tela de cadastro de cargos?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            Unload Me
        End If
    End Select
...
'    X = rsMaterial.AbsolutePosition
    ...
    mobjMsg.Abrir "Os dados do cargo foram salvos com sucesso", Ok, informacao, "Atenção"
    AtualizaListview
    Exit Sub
TrataErro:
...
Private Function ValidaCampo()
    ...
    If txtCadCargo(0).Text = "" Then
        mobjMsg.Abrir "Favor informar o campo " & Me.txtCadCargo(0).Tag, Ok, critico, "Atenção"
        Me.txtCadCargo(0).SetFocus
        Exit Function
    End If
    If txtCadCargo(1).Text = "" Then
        mobjMsg.Abrir "Favor informar o campo " & Me.txtCadCargo(1).Tag, Ok, critico, "Atenção"
...
Private Sub ResultPesq()
    ...
    If rsCargos.RecordCount > 0 Then
        CompoeControles
    Else
        mobjMsg.Abrir "Cargo não encontrado", Ok, critico, "Atenção"
    End If
    rsCargos.Close
    Set rsCargos = Nothing
End Sub
