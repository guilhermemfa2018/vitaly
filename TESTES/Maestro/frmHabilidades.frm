...
Begin VB.Form frmHabilidades 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   255
         Left            =   7560
         OleObjectBlob   =   "frmHabilidades.frx":26B6
         TabIndex        =   12
         Top             =   240
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   1320
         OleObjectBlob   =   "frmHabilidades.frx":271E
         TabIndex        =   11
         Top             =   240
         Width           =   1815
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmHabilidades.frx":2792
         TabIndex        =   10
         Top             =   240
         Width           =   975
      End
...
Private Sub cmdCadastro_Click(Index As Integer)
    Select Case Index
    Case 0
        mobjMsg.Abrir "Deseja salvar os dados da Habilidade?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            GravarDados
            gravaLog "Código hab: " & txtCadHabilidade(0), "Nome hab: " & txtCadHabilidade(1), "Peso: " & txtCadHabilidade(2)
        End If
    Case 1
        mobjMsg.Abrir "Deseja sair da tela de cadastro de Habilidades?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            Unload Me
...
On Error GoTo TrataErro
    ...
    AtualizaListview
    mobjMsg.Abrir "Os dados da Habilidade foram salvos com sucesso", Ok, informacao, "SGC"
    Unload Me
    Exit Sub
TrataErro:
...
Private Function ValidaCampo()
    ...
    If txtCadHabilidade(0).Text = "" Then
        mobjMsg.Abrir "Favor informar o campo " & Me.txtCadHabilidade(0).Tag, Ok, critico, "Atenção"
        Me.txtCadHabilidade(0).SetFocus
        Exit Function
    End If
    If txtCadHabilidade(1).Text = "" Then
        mobjMsg.Abrir "Favor informar o campo " & Me.txtCadHabilidade(1).Tag, Ok, critico, "Atenção"
        Me.txtCadHabilidade(1).SetFocus
        Exit Function
    End If
    If txtCadHabilidade(2).Text = "" Then
        mobjMsg.Abrir "Favor informar o campo " & Me.txtCadHabilidade(2).Tag, Ok, critico, "Atenção"
...
Private Sub ResultPesq()
    ...
    If rsHabilidades.RecordCount > 0 Then
        CompoeControles
    Else
        mobjMsg.Abrir "Habilidade não encontrado", Ok, critico, "Atenção"
    End If
    rsHabilidades.Close
    Set rsHabilidades = Nothing
End Sub
