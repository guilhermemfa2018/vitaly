...
Begin VB.Form frmRegistro 
   ...
   Begin MAESTRO.chameleonButton cmdregistraagora 
      Height          =   375
      Left            =   2280
      TabIndex        =   5
      Top             =   5640
   ...
   Begin VB.Label Label1 
      ...
      Width           =   1815
   End
   Begin MSForms.Label lbldiasquefaltampararegistrar 
      Height          =   255
      Left            =   120
      TabIndex        =   1
      Top             =   3840
...
Private Sub produtoAtivado()
    ...
    lbldiasquefaltampararegistrar = "Produto REGISTRADO!"
    Me.Caption = "Parabéns!"
