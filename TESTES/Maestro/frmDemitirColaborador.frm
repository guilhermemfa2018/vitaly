...
Private Sub GravarDados()
    ...
    If MsgBox("Confirma exclusão do " & LegendaExc & " selecionado?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
        sqlGravaDem = "UPDATE tbColaboradores set ativo = 'N',datarecisao = '" & Format(DTPicker1.Value, "YYYY-MM-DD") & "',homologacaonum = '" & txtDemColaborador(2) & "',homologacaoorgao = '" & txtDemColaborador(4) & "' Where codcoligada = '" & vCodcoligada & "' and cpf = '" & txtDemColaborador(0) & "' and codcolaborador = '" & txtDemCol(1) & "'"
