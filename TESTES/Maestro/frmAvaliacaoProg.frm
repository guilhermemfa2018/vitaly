...
Begin VB.Form frmAvaliacaoProg 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmAvaliacaoProg.frx":0CCA
         TabIndex        =   16
         Top             =   840
         Width           =   735
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   2160
         OleObjectBlob   =   "frmAvaliacaoProg.frx":0D32
         TabIndex        =   15
         Top             =   240
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmAvaliacaoProg.frx":0DAA
         TabIndex        =   14
         Top             =   240
         Width           =   855
      End
      ...
      Begin MAESTRO.chameleonButton cmdModelo 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmAvaliacaoProg.frx":0E16
         PICN            =   "frmAvaliacaoProg.frx":0E32
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdModelo 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmAvaliacaoProg.frx":1B0C
         PICN            =   "frmAvaliacaoProg.frx":1B28
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdModelo 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmAvaliacaoProg.frx":2802
         PICN            =   "frmAvaliacaoProg.frx":281E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdModelo 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmAvaliacaoProg.frx":34F8
         PICN            =   "frmAvaliacaoProg.frx":3514
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin MAESTRO.chameleonButton cmdNovoCol 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmAvaliacaoProg.frx":41EE
      PICN            =   "frmAvaliacaoProg.frx":420A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin MAESTRO.chameleonButton cmdNovoCol 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmAvaliacaoProg.frx":4EE4
      PICN            =   "frmAvaliacaoProg.frx":4F00
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin MAESTRO.chameleonButton cmdNovoCol 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmAvaliacaoProg.frx":5BDA
      PICN            =   "frmAvaliacaoProg.frx":5BF6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
'On Error GoTo TrataErro
    ...
    cnBanco.CommitTrans
    mobjMsg.Abrir "Os dados foram salvos com sucesso", Ok, informacao, "Atenção"
    Exit Sub
TrataErro:
...
Private Sub excluirControlesModelo()
    ...
    If rsVSePodeExcluir.RecordCount > 0 Then
        mobjMsg.Abrir "Existem programações para esse modelo. Não pode ser excluido", Ok, critico, "Atenção"
        Exit Sub
    End If
