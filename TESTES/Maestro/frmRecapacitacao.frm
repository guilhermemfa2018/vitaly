...
Begin VB.Form frmRecapacitacao 
   ...
   Begin MAESTRO.chameleonButton cmdNovoCol 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmRecapacitacao.frx":0CCA
      PICN            =   "frmRecapacitacao.frx":0CE6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin MAESTRO.chameleonButton cmdNovoCol 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmRecapacitacao.frx":19C0
      PICN            =   "frmRecapacitacao.frx":19DC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "frmRecapacitacao.frx":26B6
         Left            =   120
         List            =   "frmRecapacitacao.frx":26CC
         TabIndex        =   1
         Text            =   "Motivo-01"
         Top             =   240
         Width           =   7815
...
Private Sub cmdNovoCol_Click(Index As Integer)
    ...
    Case 0
        ...
        Unload Me
    Case 2
        mobjMsg.Abrir "Deseja sair da tela de cadastro de recapacitação?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            Pesquisa = "0"
            Unload Me
...
'APROVAR DIRETO
    ...
    End If
    mobjMsg.Abrir "Os dados da Recapacitação foram salvos com sucesso", Ok, informacao, "Atenção"
    cnBanco.CommitTrans
End Sub
    ...
    For V = 1 To MeuLV.ListView1.ListItems.Count
        ...
        If MeuLV.ListView1.ListItems.Item(V).Checked = True Then
            If MeuLV.ListView1.SelectedItem.ListSubItems.Item(10) <> "-" Then
                mobjMsg.Abrir "Existem colaboradores selecionados que ja foram recapacitados", Ok, critico, "Atenção"
                Exit Function
            End If
        End If
    Next
...
Private Sub Form_Activate()
    If Pesquisa = "novo" Then
        If VerificaStatus = False Then
            mobjMsg.Abrir "Colaboradores REPROVADOS devem ser recapacitados", Ok, critico, "Atenção"
            Unload Me
        End If
    End If
End Sub
