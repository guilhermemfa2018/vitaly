...
Private Sub Form_Load()
    'frmMenu2
    Frame1.Caption = "Matriz de capacitação"
...
Private Sub listview_cabecalho()
    ...
    ListView1.ColumnHeaders.Add , , "Cód. cargo", ListView1.Width / 14
...
Private Sub Compoe_Listview()
    ...
    If FiltroGeral = "Não ativos" Then sql = "select tbMatriz.*, tbcargos.nomecargo from tbMatriz,tbcargos where tbMatriz.codcargo = tbCargos.codcargo and tbMatriz.ativo = 'N' or tbMatriz.ativo is null order by tbMatriz.codmatriz"
    ...
    While Not rsListview.EOF
        ...
        ItemLst.SubItems(1) = "" & Format(rsListview.Fields(1), "000000") 'Código cargo
        ItemLst.SubItems(2) = "" & rsListview.Fields(7) 'Nome cargo
        ItemLst.SubItems(3) = "" & rsListview.Fields(4) 'Nível do cargo
        ...
        For X = 1 To Y
            ...
            If Combo1.Text = "ID Matriz" Then
                ...
                If UCase(ListView1.ListItems.Item(X)) Like UCase(Me.Text1.Text & "*") Then
                    ...
                    Exit Sub
                End If
            ElseIf Combo1.Text = "Código" Then
...
On Error GoTo TrataErro
    ...
    cnBanco.BeginTrans
    If MsgBox("Confirma exclusão do Matriz selecionado?", vbQuestion + vbYesNo, "SGCH") = vbYes Then
