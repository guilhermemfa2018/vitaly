...
Begin VB.Form frmSetores 
   ...
   Begin MAESTRO.chameleonButton cmdCadastro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmSetores.frx":19C0
      PICN            =   "frmSetores.frx":19DC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   1320
         OleObjectBlob   =   "frmSetores.frx":26B6
         TabIndex        =   24
         Top             =   240
         Width           =   1935
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmSetores.frx":2730
         TabIndex        =   23
         Top             =   240
         Width           =   1215
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
         Height          =   255
         Left            =   1320
         OleObjectBlob   =   "frmSetores.frx":27A6
         TabIndex        =   26
         Top             =   840
         Width           =   2655
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmSetores.frx":282E
         TabIndex        =   25
         Top             =   840
         Width           =   1215
      End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel8 
         Height          =   255
         Left            =   1560
         OleObjectBlob   =   "frmSetores.frx":28A4
         TabIndex        =   30
         Top             =   840
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel7 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmSetores.frx":2914
         TabIndex        =   29
         Top             =   840
         Width           =   975
      End
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel6 
         Height          =   255
         Left            =   1560
         OleObjectBlob   =   "frmSetores.frx":298A
         TabIndex        =   28
         Top             =   240
         Width           =   1335
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel5 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmSetores.frx":29F2
         TabIndex        =   27
         Top             =   240
         Width           =   855
      End
      ...
      Begin MAESTRO.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmSetores.frx":2A5E
         PICN            =   "frmSetores.frx":2A7A
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmSetores.frx":3754
         PICN            =   "frmSetores.frx":3770
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmSetores.frx":444A
         PICN            =   "frmSetores.frx":4466
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MAESTRO.chameleonButton cmdCadastro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmSetores.frx":5140
         PICN            =   "frmSetores.frx":515C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
...
Private Sub cmdCadastro_Click(Index As Integer)
    ...
    '    CarregaColaborador
    Case 6
        mobjMsg.Abrir "Deseja salvar os dados do Setor?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            GravarDados
        ...
        End If
    Case 7
        mobjMsg.Abrir "Deseja sair da tela de cadastro de Setores?", YesNo, pergunta, "SGC"
        If Tp = 1 Then
            Pesquisa = "0"
            Unload Me
            Set frmSetores = Nothing
...
'On Error GoTo TrataErro
    ...
    mobjMsg.Abrir "Os dados do Setor foram salvos com sucesso", Ok, informacao, "Atenção"
    AtualizaListview
    Exit Sub
TrataErro:
...
Private Function ValidaCampo()
    ...
    If txtCadSetor(0).Text = "" Then
        mobjMsg.Abrir "Favor informar o campo " & Me.txtCadSetor(0).Tag, Ok, critico, "Atenção"
        Me.txtCadSetor(0).SetFocus
        Exit Function
    End If
    If txtCadSetor(1).Text = "" Then
        mobjMsg.Abrir "Favor informar o campo " & Me.txtCadSetor(1).Tag, Ok, critico, "Atenção"
...
Private Sub ResultPesq()
    ...
    If rsSetores.RecordCount > 0 Then
        ...
        FecharHistorico
    Else
        mobjMsg.Abrir "Setor não encontrado", Ok, critico, "Atenção"
    End If
    rsSetores.Close
    Set rsSetores = Nothing
End Sub
...
Private Function ValidaResponsavel()
    ...
    If txtCadSetor(5).Text = "" Then
        mobjMsg.Abrir "Favor informar o campo " & Me.txtCadSetor(5).Tag, Ok, critico, "Atenção"
