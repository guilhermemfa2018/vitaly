...
Begin VB.UserControl VistaProgress 
   ...
   Begin VB.Image ImgCrystal 
      Height          =   195
      Left            =   600
      Picture         =   "VistaProgress.ctx":10F4A
      Stretch         =   -1  'True
      Top             =   1920
      Visible         =   0   'False
      Width           =   1110
...
If ProgValue <> 0 Then
    ...
    picTemp.Cls
    picTemp.PaintPicture ImgMid.Picture, 10, 10, ImgBack.Width + ImgBack.Left
    ...
    ImgCrystal.Move ImgCrystal.Left + 75
