...
Private Sub cmdCadastro_Click(Index As Integer)
    Select Case Index
    Case 0
        IncluirLV ListView1, txtCadastro(0), txtCadastro(1), txtCadastro(2), txtCadastro(0), txtCadastro(0), txtCadastro(0), txtCadastro(0), txtCadastro(0), txtCadastro(0), txtCadastro(0)
    ...
    Case 1
        ...
        txtCadastro(0) = Format(GeraCodigoLV(ListView1), "00")
    Case 2
        AlteraLV ListView1, txtCadastro(0), txtCadastro(1), txtCadastro(2), txtCadastro(0), txtCadastro(0), txtCadastro(0), txtCadastro(0), txtCadastro(0), txtCadastro(0), txtCadastro(0)
    Case 3
