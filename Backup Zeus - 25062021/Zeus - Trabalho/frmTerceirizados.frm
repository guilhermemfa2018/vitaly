...
Begin VB.Form frmTerceirizados 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel8 
         Height          =   255
         Left            =   2400
         OleObjectBlob   =   "frmTerceirizados.frx":26D8
         TabIndex        =   32
         Top             =   240
         Width           =   1455
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel7 
         Height          =   255
         Left            =   4200
         OleObjectBlob   =   "frmTerceirizados.frx":274C
         TabIndex        =   31
         Top             =   240
         Width           =   1695
      End
      Begin VB.ComboBox Combo1 
         Height          =   345
         ItemData        =   "frmTerceirizados.frx":27C6
         Left            =   120
         List            =   "frmTerceirizados.frx":27D3
         TabIndex        =   14
         Top             =   4080
         Width           =   6615
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel6 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmTerceirizados.frx":27F3
         TabIndex        =   30
         Top             =   3840
         Width           =   2535
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel5 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmTerceirizados.frx":2861
         TabIndex        =   29
         Top             =   3120
         Width           =   1335
      End
      Begin VB.Frame Frame6 
         ...
         Begin VB.CommandButton cmdCadastro 
            ...
            Index           =   1
            Left            =   720
            Picture         =   "frmTerceirizados.frx":28DF
            Style           =   1  'Graphical
            TabIndex        =   16
            Top             =   3000
            Width           =   615
         ...
         Begin VB.CommandButton cmdCadastro 
            ...
            Index           =   0
            Left            =   120
            Picture         =   "frmTerceirizados.frx":35A9
            Style           =   1  'Graphical
            TabIndex        =   15
            Top             =   3000
            Width           =   615
         ...
         Begin VB.PictureBox Picture2 
            ...
            Begin AlphaImageControl.aicAlphaImage aicAlphaImage1 
               ...
               _ExtentX        =   4048
               _ExtentY        =   4683
               Image           =   "frmTerceirizados.frx":4273
            End
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmTerceirizados.frx":428B
         TabIndex        =   25
         Top             =   2400
         Width           =   1455
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmTerceirizados.frx":42F1
         TabIndex        =   24
         Top             =   1680
         Width           =   735
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmTerceirizados.frx":4355
         TabIndex        =   23
         Top             =   240
         Width           =   1575
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmTerceirizados.frx":43B9
         TabIndex        =   22
         Top             =   960
         Width           =   1695
      End
...
Private Sub ResultPesq()
    On Error Resume Next
    SqlTerceirizados = "select a.chapa,a.nome,a.idsetor,a.setor,a.idfuncao,a.funcao,a.idcc,a.nmcc,a.empresa,a.datacadastro,a.datacontratoini,a.datacontratofim,a.ativo,a.foto from tbTerceirizados as a where a.chapa = '" & varGlobal & "'"
...
'On Error GoTo Err
    ...
    GravaDados "tbTerceirizados", "chapa", "S", txtCadTerc(0), 14, "", "", txtCadTerc(0)
