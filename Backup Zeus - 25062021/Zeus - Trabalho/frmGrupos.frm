...
'                "Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada) Values(" & Val(Me.mskCadastro(0)) & ",0,0,'CHK','CHKFIL','" & xFil & "'," & vCodcoligada & ");"
'    rsSalvar.Open SqlSalvar, cnBanco
...
'    SqlTreeview = "select a.*,b.incluir,b.editar,b.excluir,b.salvar,b.imprimir,b.filtrar from tbMenu as a left join tbConfGrupo as b on a.idmenu = b.idmenu and a.nome = b.nome where b.idgrupo = '" & mskCadastro(0) & "' and a.tipo <> 'CAT'"
...
Private Sub IncluiTreeview()
    ...
    Exit Sub
Err:
    mobjMsg.Abrir "Erro ao gravar registros", Ok, critico, "Atenção"
    cnBanco.RollbackTrans
    Exit Sub
End Sub
