...
Begin VB.Form frmSplash 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   4680
      OleObjectBlob   =   "frmSplash.frx":15251
      Top             =   4080
   End
   Begin VB.Frame Frame1 
      ...
      Begin ZEUS.chameleonButton chameleonButton4 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmSplash.frx":15485
         PICN            =   "frmSplash.frx":154A1
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ZEUS.chameleonButton chameleonButton2 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmSplash.frx":1617B
         PICN            =   "frmSplash.frx":16197
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ZEUS.chameleonButton chameleonButton1 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmSplash.frx":16E71
         PICN            =   "frmSplash.frx":16E8D
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin VB.Frame Frame2 
         ...
         Begin ZEUS.chameleonButton chameleonButton3 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frmSplash.frx":17B67
            PICN            =   "frmSplash.frx":17B83
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
...
Private Sub chameleonButton4_Click()
    ...
    Reg.RegWrite "HKEY_LOCAL_MACHINE\Software\ZEUS\" & "sServerName", Combo1.Text 'Chave com o nome do Servidor
    Reg.RegWrite "HKEY_LOCAL_MACHINE\Software\ZEUS\" & "sDatabaseName", Combo2.Text 'Chave com o nome do Banco
    Reg.RegWrite "HKEY_LOCAL_MACHINE\Software\ZEUS\" & "sUsuName", Text1.Text '
    Reg.RegWrite "HKEY_LOCAL_MACHINE\Software\ZEUS\" & "sSenhaDB", Text2.Text '
    Reg.RegWrite "HKEY_LOCAL_MACHINE\Software\ZEUS\" & "sSGBD", sSGBD '
    
    'Reg.RegWrite "HKEY_LOCAL_MACHINE\Software\ZEUS\" & "sLogoEmpresa", Combo2.Text 'Chave com o nome do Banco
    DesConfServer
    ...
    CarregaDadosEmpresa
    aicAlphaImage1.Tag = Reg.regread("HKEY_LOCAL_MACHINE\Software\ZEUS\sLogoEmpresa")
...
'    NewColorDBGrid Me
    ...
    If Reg.regread("HKEY_LOCAL_MACHINE\Software\ZEUS\sPathZEUS") = "" Then
        Reg.RegWrite "HKEY_LOCAL_MACHINE\Software\ZEUS\" & "sPathZEUS", App.Path & "\ZEUS.exe" 'Chave com o nome do Servidor
    End If
    
    If Reg.regread("HKEY_LOCAL_MACHINE\Software\ZEUS\sServerName") <> "" Then
        Combo1.Text = Reg.regread("HKEY_LOCAL_MACHINE\Software\ZEUS\sServerName")
        Combo2.Text = Reg.regread("HKEY_LOCAL_MACHINE\Software\ZEUS\sDatabaseName")
        Text1.Text = Reg.regread("HKEY_LOCAL_MACHINE\Software\ZEUS\sUsuName")
        Text2.Text = Reg.regread("HKEY_LOCAL_MACHINE\Software\ZEUS\sSenhaDB")
        
        If Combo1.Text = "" Then
            Combo1.Text = Reg.regread("HKEY_CURRENT_USER\Software\ZEUS\sServerName")
            Combo2.Text = Reg.regread("HKEY_CURRENT_USER\Software\ZEUS\sDatabaseName")
            Text1.Text = Reg.regread("HKEY_CURRENT_USER\Software\ZEUS\sUsuName")
            Text2.Text = Reg.regread("HKEY_CURRENT_USER\Software\ZEUS\sSenhaDB")
        End If
        'If Reg.RegRead("HKEY_LOCAL_MACHINE\Software\ZEUS\sSGBD") = 1 Then
        '    Option1.Value = True
        'Else
        '    Option2.Value = True
        'End If
...
Err1:
    HabConfServer
    Reg.RegWrite "HKEY_LOCAL_MACHINE\Software\ZEUS\" & "sPathZEUS", App.Path & "\ZEUS.exe" 'Chave com o nome do Servidor
    Reg.RegWrite "HKEY_LOCAL_MACHINE\Software\ZEUS\" & "sServerName", "" 'Chave com o nome do Servidor
    Reg.RegWrite "HKEY_LOCAL_MACHINE\Software\ZEUS\" & "sDatabaseName", "" 'Chave com o nome do Banco
    Reg.RegWrite "HKEY_LOCAL_MACHINE\Software\ZEUS\" & "sLogoEmpresa", "" 'Logo da empresa
    Reg.RegWrite "HKEY_LOCAL_MACHINE\Software\ZEUS\" & "sUsuName", "" 'Logo da empresa
    Reg.RegWrite "HKEY_LOCAL_MACHINE\Software\ZEUS\" & "sSenhaDB", "" 'Logo da empresa
    Reg.RegWrite "HKEY_LOCAL_MACHINE\Software\ZEUS\" & "sSGBD", "" 'Logo da empresa
...
On Error GoTo Err
    ...
    Dim Reg As Object
    Set Reg = CreateObject("wscript.shell")
    Reg.RegWrite "HKEY_LOCAL_MACHINE\Software\ZEUS\" & "sLogoEmpresa", vLogoEmp 'Logo da empresa
    Set Reg = Nothing
...
Err:
    ...
    If Combo1.Text = "" Then
        Reg.RegWrite "HKEY_CURRENT_USER\Software\ZEUS\" & "sPathZEUS", App.Path & "\ZEUS.exe" 'Chave com o nome do Servidor
        Reg.RegWrite "HKEY_CURRENT_USER\Software\ZEUS\" & "sServerName", "" 'Chave com o nome do Servidor
        Reg.RegWrite "HKEY_CURRENT_USER\Software\ZEUS\" & "sDatabaseName", "" 'Chave com o nome do Banco
        Reg.RegWrite "HKEY_CURRENT_USER\Software\ZEUS\" & "sLogoEmpresa", "" 'Logo da empresa
        Reg.RegWrite "HKEY_CURRENT_USER\Software\ZEUS\" & "sUsuName", "" 'Logo da empresa
        Reg.RegWrite "HKEY_CURRENT_USER\Software\ZEUS\" & "sSenhaDB", "" 'Logo da empresa
        Reg.RegWrite "HKEY_CURRENT_USER\Software\ZEUS\" & "sSGBD", "" 'Logo da empresa
    ...
    If Dir$(vCaminhoAtu) <> "" Then
        ...
        If Dir$(caminhoZEUSAtu) <> "" Then
            ...
            If fso.GetFileVersion(caminhoZEUSAtu) > fso.GetFileVersion(camZEUSso) Then
                If Msgbox("Uma nova versão do sistema foi disponibilizada no REPOSITÓRIO. Deseja atualizar?", vbQuestion + vbYesNo, "ZEUS") = vbYes Then
