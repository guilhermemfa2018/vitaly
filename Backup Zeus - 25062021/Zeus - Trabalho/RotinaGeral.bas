...
'============================
    ...
    "datprevistaini DATETIME NOT NULL," & _
    "datprevistafim DATETIME NOT NULL," & _
    "revisaoos VARCHAR(5) NULL," & _
    "status VARCHAR(10) NULL," & _
    "coddetalhista NUMERIC NULL," & _
    "esboco VARCHAR(300) NULL," & _
    "PRIMARY KEY (codigoos))"
...
'    "codigo NUMERIC NOT NULL," & _
'    "nomemenu VARCHAR(50) NOT NULL," & _
'    "tipo NUMERIC NOT NULL," & _
'    "selecionado NUMERIC NOT NULL)"
...
'                   "Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,1,'8181','BUT','Ramo de atividades','S','" & vCodcoligada & "',1);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,1,'8182','BUT','Clientes','S','" & vCodcoligada & "',2);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,1,'8184','BUT','Transportadoras','S','" & vCodcoligada & "',3);" & _
'                   "Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,1,'8185','BUT','Tipo material','S','" & vCodcoligada & "',4);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,1,'8286','BUT','Materiais','S','" & vCodcoligada & "',5);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,1,'8287','BUT','Itens Verificação','S','" & vCodcoligada & "',6);" & _
'                   "Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,1,'8288','BUT','Projetos','S','" & vCodcoligada & "',7);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,1,'8289','BUT','Processos','S','" & vCodcoligada & "',8);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,2,'02','TAB','Orçamentos','S','" & vCodcoligada & "',0);" & _
'                   "Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,2,'01','CAT','Vendas','S','" & vCodcoligada & "',0);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,2,'0101','BUT','Serviços','S','" & vCodcoligada & "',9);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,3,'03','TAB','Planejamento','S','" & vCodcoligada & "',0);" & _
'                   "Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,3,'11','CAT','Planejamento e Controle da Produção','S','" & vCodcoligada & "',0);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,3,'1111','BUT','FCE','S','" & vCodcoligada & "',10);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,3,'1112','BUT','LM','S','" & vCodcoligada & "',11);" & _
'                   "Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,3,'1113','BUT','LD','S','" & vCodcoligada & "',12);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,3,'1114','BUT','OS','S','" & vCodcoligada & "',13);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,3,'1115','BUT','Controle de Desenhos','S','" & vCodcoligada & "',28);" & _
'                   "Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,4,'04','TAB','Produção','S','" & vCodcoligada & "',0);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,4,'21','CAT','Acompanhamento de Produção','S','" & vCodcoligada & "',0);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,4,'2121','BUT','OS Acompanhamento','S','" & vCodcoligada & "',13);" & _
'                   "Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,4,'2122','BUT','Evolução','S','" & vCodcoligada & "',14);" & _
'                   "Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,5,'05','TAB','Inspeção/Expedição','S','" & vCodcoligada & "',0);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,5,'31','CAT','Emissão de Relatórios','S','" & vCodcoligada & "',0);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,5,'3131','BUT','Emitir Relatório','S','" & vCodcoligada & "',15);" & _
'                   "Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,5,'3132','BUT','Imprimir Relatório','S','" & vCodcoligada & "',16);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,6,'06','TAB','Configurações','S','" & vCodcoligada & "',0);Insert into tbConfGrupo(idgrupo,idmenu,idsub,tipo,nome,status,codcoligada,icon) Values(1,6,'51','CAT','Parametrizações','S','" & vCodcoligada & "',0);" & _
