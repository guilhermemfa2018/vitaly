...
Begin VB.Form frmLM 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(2).Control(8)=   "Frame17"
      Tab(2).Control(8).Enabled=   0   'False
      Tab(2).Control(9)=   "txtLvw"
      Tab(2).Control(9).Enabled=   0   'False
      Tab(2).Control(10)=   "Frame14"
      Tab(2).Control(10).Enabled=   0   'False
      Tab(2).Control(11)=   "Frame9(0)"
      Tab(2).Control(11).Enabled=   0   'False
      Tab(2).Control(12)=   "Frame13"
      Tab(2).Control(12).Enabled=   0   'False
      Tab(2).Control(13)=   "Frame19"
      Tab(2).Control(13).Enabled=   0   'False
      Tab(2).ControlCount=   14
      TabCaption(3)   =   "Resumo"
      TabPicture(3)   =   "frmLM.frx":2A2E
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "ListView3"
      Tab(3).Control(1)=   "Label44"
      Tab(3).Control(2)=   "Label45"
      Tab(3).Control(3)=   "lbltotpm"
      Tab(3).Control(4)=   "lbltotl"
...
Private Sub GravarDadosConjunto()
    ...
    SqlDesConjunto = "Delete from tbDesConjunto where tbDesConjunto.codlm = '" & Val(Label2) & "'"
...
Private Sub CarregaDados(Index)
    ...
    If Index <> 70 Then ' indice do codigo de material do resumo
        If Val(txtCadastro(19)) = 0 Then
            ...
            'txtCadastro(19) = Format(0, "000000")
            'txtCadastro(18).Enabled = True
            'txtCadastro(24).Enabled = False
            ...
            'If txtCadastro(18) = "" Then txtCadastro(18) = "DIGITE O NOME DO MATERIAL"
            'txtCadastro(24) = "-"
            Check1.Value = 0
            
            'txtCadastro(18).BackColor = &HC0C0FF
            'txtCadastro(17).BackColor = &HC0C0FF
            'txtCadastro(21).BackColor = &HC0C0FF
            'txtCadastro(19).BackColor = &HC0C0FF
            'txtCadastro(23).BackColor = &HC0C0FF
            'If txtCadastro(19) = "000000" Then optCadastro_Click (1)
            Exit Sub
        Else
...
'    rsTipoMat.Find "codigo=" & "'" & Val(Me.txtcadastro(22)) & "'"
'    If rsTipoMat.EOF Then
'        txtcadastro(22).Text = Format(txtcadastro(22), "000000") & ""
'        If Val(Pesquisa) <> 0 Then
'            Msgbox "Tipo de material não cadastrado", vbInformation, "Zeus"
'            txtcadastro(21) = ""
'        End If
'    Else
'        txtcadastro(22).Text = Format(rsTipoMat.Fields(0), "000000") & ""
'        txtcadastro(21).Text = rsTipoMat.Fields(1)
 '       txtcadastro(21).Enabled = False
'    End If
'    rsTipoMat.Close
...
Private Sub RestauraItens()
    ...
    sql = "select a.fce, a.codlm, a.codseq, c.desenho, c.revisao, b.CODIGOPRD + ' - ' + cast(a.codmat as varchar) as codmat, d.posicao, d.item, a.quantcj, a.quantunit, a.dimensoes, a.pesounit, a.area, b.CODTB2FAT, a.codfo, a.observação, d.descposicao, a.matncadast, b.NOMEFANTASIA, " & _
          "b.CODUNDCONTROLE, e.DESCRICAO, c.descricao, a.calcpor, a.idconjunto, c.iddesenho,d.pesoposicao from tbitemlm as a inner join " & vBancoTotvs & ".dbo.tprd as b on a.codmat = b.IDPRD inner join tbDesenhos as c on a.codigodes = c.iddesenho inner join tbPosicoes as d on a.codigopos = d.codigopos " & _
          "left join " & vBancoTotvs & ".dbo.TTB2 as e on b.CODTB2FAT = e.CODTB2FAT and e.codcoligada = 1" & _
