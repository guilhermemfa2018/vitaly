...
Private Sub cmdCadastro_Click(Index As Integer)
    ...
    Case 4
        limpaQualquerDado
        ordenaLVArray ListView2, "4", "0", "2", "5", "6", "", "", "", "", "", "", "", "", "", "", ""
...
Private Sub listview_cabecalho()
    ...
    ListView2.ColumnHeaders.Add , , "Operação", ListView2.Width / 5
    ListView2.ColumnHeaders.Add , , "Centro de Custo", ListView2.Width / 3
    ListView2.ColumnHeaders.Add , , "% baixado", ListView2.Width / 3
